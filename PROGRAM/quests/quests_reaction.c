...
//////////////////////////////////////////////////////////////////////////////////////////////////
	case "Sharlie_Start":
		...
		sld = GetCharacter(NPC_GenerateCharacter("Sh_startsailor", "citiz_4", "man", "man", 10, FRANCE, 0, false, "quest"));
	...
	case "Guide_nextCondition":
	pchar.quest.GuidenextCondition.win_condition.l1 = "location";
	pchar.quest.GuidenextCondition.win_condition.l1.location = "Fortfrance_town";
	pchar.quest.GuidenextCondition.win_condition = "Guide_next";
	break;
	...
	case "FolkeStay":
		LAi_SetPlayerType(pchar);
		sld = characterFromId("FrankDugari");
		LAi_SetActorType(sld);
...
//------------------------------------за Голландию-------------------------------------------
		case "SantiagoTripTalkToMC":   // Оглушили в Сантьяго
...
/////////////////////////////////////////////////////Мой квест///////////////////////////////////////////////
        ...
        sld = characterFromID("MyHero");
        Lai_SetActorType(sld);
        Lai_ActorRunToLocation (sld, "reload", "reload4_back", "Sentjons_tavern", "sit", "sit_front2", "MyQ1", -1);
        break;	
        ...
        sld = characterFromID("MyHero");
        Lai_SetSitType(sld);
		sld = characterFromID("Charles_tavernkeeper");
		sld.quest.MyQ = true;
		FreeSitLocator("Charles_Tavern", "sit_base4");
		sld = characterFromID("ProstoParen");
        ...
        case "MyQ2": 
		sld = characterFromID("ProstoParen");
		sld.dialog.currentnode = "dialog1";
        break;		
		
		
		
		case "MyQ3":
		AddQuestRecord("MyQuest", "2");	
		sld = characterFromID("DiegoEspinosa");
		ChangeCharacterAddressGroup(sld, "Charles_exittown", "goto", "goto8");
		break;
		...
		LAi_group_FightGroups("EnemyFight", LAI_GROUP_PLAYER, true);
		LAi_SetFightMode(pchar, true);
		LAi_group_SetCheck("EnemyFight", "MyQ5");
		break;
       ...
       case "MyQ5":
	   pchar.quest.MyQ5.win_condition.l1 = "NPC_Death";//прерывание на потопление 
	   pchar.quest.MyQ5.win_condition.l1.character = "DiegoEspinosa";
	   pchar.quest.MyQ5.win_condition.l2 = "item";
	   pchar.quest.MyQ5.win_condition.l2.item = "jewelry2";
	   pchar.quest.MyQ5.win_condition = "MyQ6";
	   break;
	   
	   
	   
	   case "MyQ6":
	   AddQuestRecord("MyQuest", "3");	
	   sld = characterFromID("ProstoParen");
	   ChangeCharacterAddressGroup(sld, "non", "", "");
	   sld = characterFromID("MyHero");
	   sld.dialog.currentnode = "complete";
	   break;
	   ...
	   case "Trustwothy_1":
	   AddQuestRecord("Trustwothy", "1");
	   sld = characterFromID("LoraLong");
	   ChangeCharacterAddressGroup(sld, "CommonDoubleflourHouse_1", "goto", "goto1");
	   sld.dialog.currentnode = "First Time";
	   DoQuestCheckDelay("Trustwothy_2", 1);
	   break;
	   
	   
	   
	   case "Trustwothy_2":
	   pchar.quest.Trustwothy_2.win_condition.l1 = "location";
	   pchar.quest.Trustwothy_2.win_condition.l1.location = "CommonDoubleflourHouse_1";
	   pchar.quest.Trustwothy_2.win_condition = "Trustwothy_3";
	   break;
	   ...
	   case "Trustwothy_4":
	   AddQuestRecord("Trustwothy", "2");
	   Group_FindOrCreateGroup("DjekGroup");
	   sld = GetCharacter(NPC_GenerateCharacter("DjekHigens", "chard2", "man", "man", 25, PIRATE, -1, true, "quest"));
	   FantomMakeSmallSailor(sld, SHIP_SCHOONER_W, "Хайрок", CANNON_TYPE_CANNON_LBS20, 50, 50, 50, 50, 50);
	   sld.name = "Джек";
	   sld.lastname = "Хигенс";
	   sld.dialog.Filename = "NewPapka/DjekHigens.c";
	   ...
	   Group_AddCharacter("DjekGroup", "DjekHigens");
	   Group_SetGroupCommander("DjekGroup", "DjekHigens");
	   Group_SetAddress("DjekGroup", "SentMartin", "quest_ships", "quest_ship_1");
	   Group_LockTask("DjekGroup");
	   dialogexit();
	   break;
	   ...
	   case "Trustwothy_5":
	   LocatorReloadEnterDisable("marigo_town", "HouseSP1", true);
	   LocatorReloadEnterDisable("marigo_town", "Reload1_back", true);
	   LocatorReloadEnterDisable("marigo_town", "gate_back", true);   // закрыть ворота
	   Group_DeleteGroup("DjekGroup");
	   AddQuestRecord("Trustwothy", "3");
	   DoQuestReloadToLocation("marigo_town", "Reload", "Reload1_back", "Trustwothy_6");
	   break;
	   
	   
	   
	   case "Trustwothy_6":
       pchar.quest.Trustwothy6.win_condition.l1 = "locator";
       pchar.quest.Trustwothy6.win_condition.l1.location = "Marigo_town";
       pchar.quest.Trustwothy6.win_condition.l1.locator_group = "reload";
       pchar.quest.Trustwothy6.win_condition.l1.locator = "houseSP1";
       pchar.quest.Trustwothy6.win_condition = "Trustwothy_7";
       break;


	   case "Trustwothy_7":
	   Lai_SetActorType(pchar);
	   pchar.Dialog.CurrentNode = "my_dream";
	   SelfDialog(pchar);
	   break;
	   ...
	   pchar.quest.Trustwothy8.win_condition.l1 = "location";
	   pchar.quest.Trustwothy8.win_condition.l1.location = "SentMartin";
	   pchar.quest.Trustwothy8.win_condition = "Trustwothy_9";
	   LocatorReloadEnterDisable("Marigo_town", "reload1_back", false);
	   LocatorReloadEnterDisable("Marigo_town", "gate_back", false);
	   DoQuestFunctionDelay("Trustwothy_function", 3.0);
	   break;



	   case "Trustwothy_9":
	   AddQuestRecord("Trustwothy", "4");
	   break;
		...
		bQuestDisableMapEnter = true;
		pchar.GenQuest.ShipSituation.Explosion = ShipSituation_4; //Ба-бах
		pchar.GenQuest.ShipSituation.Explosion.CapId = "DjekHigens";
		break;



		case "Trustwothy_10":
		sld = characterFromID("Thomas_Glong");
		ChangeCharacterAddressGroup(sld, "CommonDoubleflourHouse_1", "goto", "goto2");
		WaitDate("", 0, 0, 2, 0, 0); // Крутану два дня
		RecalculateJumpTable();
		SetLaunchFrameFormParam("Спустя несколько дней. Дом Глонгов....", "", 0, 6);
		LaunchFrameForm();
		DoQuestCheckDelay("Trustwothy_11", 1.0);
		break;


		case "Trustwothy_11":
		bQuestDisableMapEnter = false; //// возвращение выхода на карту
		LocatorReloadEnterDisable("marigo_town", "HouseSP1", false);  // в дом Глонгов снова можной зайти
		DoQuestReloadToLocation("CommonDoubleflourHouse_1", "reload", "reload1", "");
		sld = characterFromID("Thomas_Glong");
		sld.dialog.currentnode = "dialog4";
		Lai_SetActorType(sld);
		Lai_ActorDialogDelay(sld, pchar, "", 0.5);
		break;
        ...
        case "Trustwothy_12":
		SetLaunchFrameFormParam("Прошло два часа....", "", 0, 4);
		LaunchFrameForm();
		WaitDate("", 0, 0, 0, 2, 0); // Крутану два часа
		RecalculateJumpTable();
		AddCharacterExpToSkill(pchar, "Sailing", 4000); // 4К опыта в навигацию
		log_info("Вы стали лучше владеть навигацией");
		sld = characterFromID("Thomas_Glong");
		sld.dialog.currentnode = "dialog7";
		Lai_SetActorType(sld);
		Lai_ActorDialogDelay(sld, pchar, "", 4.5);
		break;


		case "Trustwothy_exit":
		DoReloadCharacterToLocation("marigo_town", "reload", "HouseSP1");
		AddQuestRecord("Trustwothy", "8");
		CloseQuestHeader("Trustwothy");
		sld = characterFromID("Thomas_Glong");
		sld.dialog.currentnode = "sectime";
		break;


		case "Trustwothy_13":
		setCharacterShipLocation(pchar, "shore41");
		setWDMPointXZ("shore41");   // Корабль в бухту
		WaitDate("", 0, 0, 0, 0, 0);    // Кручу до 12 ночи
		SetCurrentTime(00, 00);
		RecalculateJumpTable();
		SetLaunchFrameFormParam("Наступает ночь....", "", 0, 6);
		LaunchFrameForm();
		DoQuestCheckDelay("Trustwothy_14", 5.0);
		break;



		case "Trustwothy_14":
		pchar = GetMainCharacter(); //меняем ГГ
		SetMainCharacterIndex(GetCharacterIndex("Barny_Gamble"));
		Lai_SetPlayerType(pchar);
		DoQuestReloadToLocation("marigo_town", "reload", "houseSP1", "Trustwothy_15");
		break;


		
		case "Trustwothy_15":
		log_info("Нужно добраться до лодки у верфи любой ценой!");
		chrDisableReloadToLocation = true; // закрыть докацию
		bDisableCharacterMenu = true;   // запретить F2
		DoQuestCheckDelay("Trustwothy_16", 1.0);
		break;


		case "Trustwothy_16":
		pchar.quest.Trustwothy16.win_condition.l1 = "locator";
		pchar.quest.Trustwothy16.win_condition.l1.location = "marigo_town";
		pchar.quest.Trustwothy16.win_condition.l1.locator_group = "rld";
		pchar.quest.Trustwothy16.win_condition.l1.locator = "loc0";
		pchar.quest.Trustwothy16.win_condition = "Trustwothy_17";
		break;


		case "Trustwothy_17":
		DoReloadCharacterToLocation("shore41", "goto", "goto1");
		chrDisableReloadToLocation() = false;   // открыть локацию
		bDisableCharacterMenu() = false;  //Разрешить F2
		pchar = GetMainCharacter(); //меняем ГГ
		SetMainCharacterIndex(GetCharacterIndex("BLAZE"));
		Lai_SetPlayerType(pchar);
		sld = characterFromID("Barny_Gamble");
		ChangeCharacterAddressGroup(sld, "shore41", "goto", "goto8");
		sld.dialog.currentnode = "officer";
		Lai_SetActorType(sld);
		Lai_ActorDialog(sld, pchar, "", "10", 1.0);
		break;
		...
		sld = characterFromID("Barny_Gamble");
		Lai_SetActorType(sld);
		Lai_ActorRunToLocation(sld, "goto", "goto8", "none", "", "", "Trustwothy_19", -1);
		break;



		case "Trustwothy_19":
		AddQuestRecord("Trustwothy", 9);
		CloseQuestHeader("Trustwothy");
		sld = characterFromID("Thomas_Glong");
		ChangeCharacterAddress(sld, "none", "");
		sld = characterFromID("LoraLong");
		...
		sld.quest.OfficerPrice = sti(pchar.rank)*500;
		sld.OfficerWantToGo.DontGo = true;  // не пытается уйти
       ...
       //////////////////////////////////////////// Воспоминания о Лулу/////////////////////////////////
      case "Memories_1":
	  DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_1");
	  startvideo("LULUmem");
	  Lai_QuestDelay("Memories_1a", 1.0);
      break;



      case "Memories_1a":
	  DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_1a");
	  SetLaunchFrameFormParam("Месяц назад в поместье Ла Файет", "", 0, 8);
	  LaunchFrameForm();
	  WaitDate("", 0, 0, 0, 0, 0); // Крутану время
	  RecalculateJumpTable();
	  
	  DoQuestCheckDelay("Memories_2", 2.0);
	  break;

	  case "Memories_2":
	  DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_2");
	  //qDateY = sti(GetDataYear());
	  //qDateM = sti(GetDataMonth());
	  //qDateD = sti(GetDataDay());
	  Environment.date.year = 1654;
	  Environment.date.month = 8;
	  Environment.date.day = 26;
	  worldMap.date.year = 1654;
	  worldMap.date.month = 8;
	  worldMap.date.day = 26;
	  //LAi_SetImmortal(pchar, true);    // бессмертие Шарля
	  LAi_SetHP(pchar, 100, 100); 
	  DoQuestReloadToLocation("Location_reserve_48", "goto", "goto1", "Memories_3");
	  sld = GetCharacter(NPC_GenerateCharacter("LULU", "CitizenWom_1", "woman", "woman", 5, PIRATE, -1, true, "quest"));
	  sld.name = "Луиза";
	  sld.lastname = "де Ла Файет";
	  sld.dialog.filename = "NewPapka\Memories\LULU.c";
	  LAi_SetStayType(sld);
	  ChangeCharacterAddressGroup(sld, "Location_reserve_48", "goto", "goto9");
	  break;


	  case "Memories_3":
	  DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_3");
	  sld = characterFromID("LULU");
	  Lai_SetActorType(sld);
	  LAi_ActorRunToLocator(sld, "goto", "goto7", "Memories_4", -1);
	  Lai_SetActorType(pchar);
	  LAi_ActorRunToLocator(pchar, "goto", "goto7", "", -1);
	  break;


	  case "Memories_4":
	  DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_4");
	 
	  Lai_SetActorType(pchar);
	  LAi_ActorFollow(pchar, characterFromId("LULU"), "Memories_5", -1);
	  break;


	  case "Memories_5":
	  DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_5");
	  Lai_SetPlayerType(pchar);
	  sld = characterFromID("LULU");
	  Lai_SetActorType(sld);
	  sld.dialog.currentnode = "dialogSharlie_1";
	  LAi_ActorDialog(sld, pchar, "", -1, 0);
	  break;


	  case "Memories_5a":
	  DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_5a");
	  sld = characterFromID("LULU");
	  Lai_SetActorType(sld);
	  Lai_ActorRunToLocation(sld, "reload", "reload4", "none", "", "", "Memories_6", -1);
	  DoQuestCheckDelay("Memories_5b", 2.0);
	  break;


	  case "Memories_5b":
	  DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_5b");
	  Lai_SetActorType(pchar);
	  Lai_ActorRunToLocation(pchar, "reload", "reload4", "none", "", "", "", -1);
	  break;


	  case "Memories_6":
	  DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_6");
	  WaitDate("", 0, 0, 0, 23, 0);    // Кручу до 12 ночи
	  SetCurrentTime(00, 00);
	  RecalculateJumpTable();
	  SetLaunchFrameFormParam("Ночью, когда Лулу уснула....", "", 0, 6);
	  LaunchFrameForm();
	  //sld = characterFromID("LULU");
	  //Lai_SetActorType(sld);
	  //Lai_ActorRunToLocation(pchar, "reload", "reload3", "none", "", "", "", -1);
	  DoQuestCheckDelay("Memories_7", 5.0);
	  break;


	  case "Memories_7":
	  DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_7");
	  DoQuestReloadToLocation("Location_reserve_48", "reload", "reload4", "Memories_8");
	  
	  break;


	  case "Memories_8":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_8");
	   Lai_SetActorType(pchar);
	   pchar.Dialog.CurrentNode = "demor_Memories";
	   SelfDialog(pchar);
	   break;
	   ...
	   case "Memories_9":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_9");
	   Lai_SetPlayerType(pchar);
	   pchar.Dialog.CurrentNode = "First Time";
	   break;
	   ...
	   case "Memories_10":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_10");
	   AddCharacterExpToSkill(Pchar, "Sneak", 200);
	   Lai_SetActorType(pchar);
	   Lai_ActorRunToLocation(pchar, "reload", "reload3", "none", "", "", "Memories_11", -1);
	   break;


	   case "Memories_11":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_11");
	   DoQuestReloadToLocation("Location_reserve_49", "goto", "goto5", "Memories_12");
	   break;


	   case "Memories_12":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_12");
	   GiveItem2Character(pchar, "letter_Fayet");
	   Lai_SetActorType(pchar);
	   pchar.Dialog.CurrentNode = "demor_Memories_1";
	   SelfDialog(pchar);
	   break;
	   ...
	   case "Memories_13":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_13");
	   Lai_SetPlayerType(pchar);
	   pchar.Dialog.CurrentNode = "First Time";
	   break;
	   ...
	   case "Memories_14":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_14");
	   Lai_SetActorType(pchar);
	   Lai_ActorRunToLocation(pchar, "reload", "reload1", "none", "", "", "Memories_15", -1);
	   break;


	   case "Memories_15":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_15");
	   sld = characterFromID("LULU");
	   ChangeCharacterAddressGroup(sld, "Location_reserve_48", "reload", "reload4");
	   DoQuestReloadToLocation("Location_reserve_48", "reload", "reload3", "Memories_16");
	   Lai_SetPlayerType(pchar);
	   break;


	   case "Memories_16":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_16");
	   sld = characterFromID("LULU");
	   Lai_SetActorType(sld);
	   LAi_ActorFollow(sld, characterFromId("BLAZE"), "Memories_17", 1);
	   break;


	   case "Memories_17":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_17");

	   // маркиз Анри де Ла Файет
	  sld = GetCharacter(NPC_GenerateCharacter("LaFayet", "Resc_1", "man", "man", 2, PIRATE, -1, true, "quest"));
	  sld.name = "Анри";
	  sld.lastname = "де Ла Файет";
	  sld.dialog.filename = "NewPapka\Memories\LaFayet.c";
	  TakeNItems(sld, "potion2", 3);
	  ChangeCharacterAddressGroup(sld, "Location_reserve_48", "goto", "goto1");
	  
	  Lai_SetActorType(sld);
	  LAi_ActorRunToLocator(sld, "goto", "goto12", "Memories_19", -1);
	  // слуги маркиза
	  for (i=1; i<+11; i++)
	  {
		sld = GetCharacter(NPC_GenerateCharacter("LaFayetMen_"+i, "Citiz_58", "man", "man", 1, PIRATE, -1, true, "quest"));
		TakeNItems(sld, "potion2", 1);
		LAi_SetWarriorType(sld);
	    ChangeCharacterAddressGroup(sld, "Location_reserve_48", "goto", "goto1");
	    LAi_group_MoveCharacter(sld, "LaFayetFight");
		Lai_SetActorType(sld);
	    LAi_ActorRunToLocator(sld, "goto", "goto7", "", -1);
	  }

	   sld = characterFromID("LULU");
	   Lai_SetActorType(sld);
	   sld.dialog.currentnode = "dialogSharlie_5";
	   LAi_ActorDialog(sld, pchar, "", -1, 0);
	   break;


	   case "Memories_18":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_18");
	   Lai_SetActorType(pchar);
	   LAi_ActorFollow(pchar, characterFromId("LaFayet"), "", 1);
	   DoQuestCheckDelay("Memories_18a", 7.0);
	   break;


	   case "Memories_18a":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_18a");
	   sld = characterFromID("LULU");
	   Lai_SetActorType(sld);
	   LAi_ActorFollow(sld, characterFromId("LaFayet"), "Memories_19", 1);
	   break;


	   case "Memories_19":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_19");
	   sld = characterFromID("LaFayet");
       Lai_SetActorType(sld);
       LAi_ActorTurnToCharacter(sld, characterFromID("LULU"));
	   sld = characterFromID("LULU");
	   Lai_SetActorType(sld);
	   sld.dialog.currentnode = "dialogLaFayet_1";
	   LAi_ActorDialog(sld, pchar, "", -1, 0);
	   break;


	   case "Memories_20":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_20");
	   sld = characterFromID("LaFayet");
	   Lai_SetActorType(sld);
	   sld.dialog.currentnode = "dialogLULU_1";
	   LAi_ActorDialog(sld, pchar, "", 1, 0);
	   break;


	   case "Memories_21":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_21");
	   sld = characterFromID("LULU");
	   Lai_SetActorType(sld);
	   sld.dialog.currentnode = "dialogLaFayet_2";
	   LAi_ActorDialog(sld, pchar, "", 1, 0);
	   break;


	   case "Memories_22":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_22");
	   sld = characterFromID("LaFayet");
	   Lai_SetActorType(sld);
	   sld.dialog.currentnode = "dialogLULU_2";
	   LAi_ActorDialog(sld, pchar, "", 1, 0);
	   break;

	   case "Memories_23":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_23");
	   sld = characterFromID("LaFayet");
	   Lai_SetActorType(sld);
	   sld.dialog.currentnode = "dialogSharl_1";
	   LAi_ActorDialog(sld, pchar, "", 1, 0);
	   break;


	   case "Memories_24":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_24");
	   sld = characterFromID("LaFayet");
	   Lai_SetActorType(sld);
	   sld.dialog.currentnode = "dialogLULU_3";
	   LAi_ActorDialog(sld, pchar, "", 1, 0);
	   break;


	   case "Memories_25":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_25");
	   sld = characterFromID("LULU");
	   Lai_SetActorType(sld);
	   sld.dialog.currentnode = "dialogSharlie_6";
	   LAi_ActorDialog(sld, pchar, "", 1, 0);
	   break;


	   case "Memories_26":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_26");
	   sld = characterFromID("LaFayet");
	   Lai_SetActorType(sld);
	   sld.dialog.currentnode = "dialogSharl_5";
	   LAi_ActorDialog(sld, pchar, "", 1, 0);
	   break;


	   case "Memories_27":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_27");
	   sld = characterFromID("LULU");
	   Lai_SetActorType(sld);
	   sld.dialog.currentnode = "dialogSharlie_7";
	   LAi_ActorDialog(sld, pchar, "", 1, 0);
	   break;


	   case "Memories_28":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_28");
	   sld = characterFromID("LULU");
	   Lai_SetActorType(sld);
	   sld.dialog.currentnode = "dialogLaFayet_3";
	   LAi_ActorDialog(sld, pchar, "", 1, 0);
	   break;


	   case "Memories_29":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_29");
	   WaitDate("", 0, 0, 0, 0, 0);    
	   RecalculateJumpTable();
	   SetLaunchFrameFormParam("Шарль ловко прыгает вниз"+ NewStr() +"и обнажает клинок", "", 0, 6);
	   LaunchFrameForm();
	   DoQuestCheckDelay("Memories_30", 3.0);
	   break;


	   case "Memories_30":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_30");
	   DoQuestReloadToLocation("Location_reserve_48", "goto", "goto5", "Memories_33");
	   AddCharacterExpToSkill(pchar, "Fortune", 100);
	   sld = characterFromID("LaFayet");
	   Lai_SetActorType(sld);
	   LAi_ActorRunToLocator(sld, "goto", "goto6", "Memories_31", -1);
	   sld = characterFromID("LULU");
	   Lai_SetActorType(sld);
	   LAi_ActorRunToLocator(sld, "reload", "reload6", "Memories_32", -1);
	   break;

	   case "Memories_31":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_31");
	   sld = characterFromID("LaFayet");
	   Lai_SetActorType(sld);
	   ...
	   case "Memories_32":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_32");
	   sld = characterFromID("LULU");
	   Lai_SetActorType(sld);
	   LAi_ActorTurnToCharacter(sld, characterFromID("BLAZE"));
	   break;
	   ...
	   case "Memories_33":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_33");
	   for (i=1; i<+11; i++)
	  {
		sld = characterFromID("LaFayetMen_"+i);
		ChangeCharacterAddressGroup(sld, "Location_reserve_48", "goto", "goto1");
		LAi_SetWarriorType(sld);
	    LAi_group_MoveCharacter(sld, "LaFayetFight");
	  }
	   LAi_group_SetRelation("LaFayetFight", LAI_GROUP_PLAYER, LAI_GROUP_ENEMY);
	   LAi_group_FightGroups("LaFayetFight", LAI_GROUP_PLAYER, true);
	   LAi_SetFightMode(pchar, true);
	   LAi_group_SetCheck("LaFayetFight", "Memories_34");
	   break;


	   case "Memories_34":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_34");
	   AddComplexSelfExpToScill(100, 100, 100, 100);
	   AddCharacterExpToSkill(pchar, GetEquipedBladeType(pchar), 100);
	   // ещё слуги маркиза
	  for (i=11; i<+22; i++)
	  {
		...
		TakeNItems(sld, "potion2", 1);
		Lai_SetActorType(sld);
		LAi_group_MoveCharacter(sld, "LaFayetFight1");
	    ChangeCharacterAddressGroup(sld, "Location_reserve_48", "goto", "goto7");
	   
	  }
	   Lai_SetActorType(pchar);
	   LAi_ActorRunToLocator(pchar, "goto", "goto9", "Memories_35", -1);
	   break;


	   case "Memories_35":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_35");
	   Lai_SetPlayerType(pchar);
	   sld = characterFromID("LaFayet");
	   Lai_SetActorType(sld);
	   LAi_ActorFollow(sld, characterFromId("BLAZE"), "Memories_36", 1);
	   sld = characterFromID("LULU");
	   Lai_SetActorType(sld);
	   LAi_ActorTurnToCharacter(sld, characterFromID("BLAZE"));
	   break;
	   ...
	   case "Memories_36":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_36");
	   sld = characterFromID("LaFayet");
	   Lai_SetActorType(sld);
	   sld.dialog.currentnode = "dialogSharl_8";
	   LAi_ActorDialog(sld, pchar, "", 1, 0);
	   break;


	   case "Memories_37":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_37");
	   sld = characterFromID("LULU");
	   Lai_SetActorType(sld);
	   sld.dialog.currentnode = "dialogLaFayet_4";
	   LAi_ActorDialog(sld, pchar, "", 1, 0);
	   break;


	   case "Memories_38":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_38");
	   sld = GetCharacter(NPC_GenerateCharacter("LaFayetMan", "Citiz_58", "man", "man", 1, PIRATE, -1, true, "quest"));
	   ChangeCharacterAddressGroup(sld, "Location_reserve_48", "goto", "goto1");
	   Lai_SetActorType(sld);
	   LAi_ActorFollow(sld, characterFromId("LaFayet"), "Memories_39", -1);
	   break;


	   case "Memories_39":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_39");
	   sld = characterFromID("LaFayetMan");
	   Lai_SetActorType(sld);
	   LAi_ActorTurnToCharacter(sld, characterFromID("LaFayet"));
	   sld = characterFromID("LaFayet");
	   Lai_SetActorType(sld);
	   sld.dialog.currentnode = "dialogMan_1";
	   LAi_ActorDialog(sld, pchar, "", 1, 0);
	   break;


	   case "Memories_40":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_40");
	   sld = characterFromID("LaFayetMan");
	   Lai_SetActorType(sld);
	   LAi_ActorRunToLocator(sld, "goto", "goto1", "Memories_41", -1);
	   break;


	   case "Memories_41":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_41");
	   // капитан
	   sld = GetCharacter(NPC_GenerateCharacter("CaptainFra", "paladin_leitinat", "man", "man2", 1, PIRATE, -1, true, "quest"));
	   ChangeCharacterAddressGroup(sld, "Location_reserve_48", "goto", "goto1");
	   Lai_SetActorType(sld);
	   LAi_ActorFollow(sld, characterFromId("LaFayet"), "Memories_42", -1);
	   // солдаты с капитаном
	   for (i=1; i<+5; i++)
	  {
		sld = GetCharacter(NPC_GenerateCharacter("CaptainFraMen_"+i, "paladin_"+i, "man", "man2", 1, PIRATE, -1, true, "quest"));
		TakeNItems(sld, "potion2", 1);
		LAi_group_MoveCharacter(sld, LAI_GROUP_PLAYER); //относим в группу героя
		Lai_SetActorType(sld);
	    ChangeCharacterAddressGroup(sld, "Location_reserve_48", "goto", "goto1");
		LAi_ActorFollow(sld, characterFromId("CaptainFra"), "", -1);
	   ...
	   case "Memories_42":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_42");
	   sld = characterFromID("LaFayet");
	   Lai_SetActorType(sld);
	   sld.dialog.currentnode = "dialogOfficer_1";
	   LAi_ActorDialog(sld, pchar, "", 1, 0);
	   break;


	   case "Memories_43":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_43");
	   sld = characterFromID("CaptainFra");
	   LAi_SetHP(sld, 1.0, 1.0);
	   Lai_SetStayType(sld);
	   Lai_ActorAttack(characterFromID("LaFayet"), characterFromID("CaptainFra"), "");
	   pchar.quest.Memories43.win_condition.l1 = "NPC_Death";
	   pchar.quest.Memories43.win_condition.l1.character = "CaptainFra";
	   pchar.quest.Memories43.win_condition = "Memories_44";
	   break;


	   case "Memories_44":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_44");
	   sld = characterFromID("LaFayet");
	   Lai_SetActorType(sld);
	   sld.dialog.currentnode = "dialogSharl_10";
	   LAi_ActorDialog(sld, pchar, "", 1, 0);
	   break;


	   case "Memories_45":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_45");
	   sld = characterFromID("LULU");
	   Lai_SetActorType(sld);
	   LAi_ActorRunToLocator(sld, "reload", "reload6", "Memories_46", -1);
	   sld = characterFromID("LaFayet");
	   Lai_SetWarriorType(sld);
	   LAi_group_MoveCharacter(sld, "LaFayetFight1");
	   sld = characterFromID("LaFayetMan");
	  ...
	  for (i=1; i<+9; i++)
	  {
		sld = GetCharacter(NPC_GenerateCharacter("CaptainFraMen1_"+i, "paladin_"+i, "man", "man2", 1, PIRATE, -1, true, "quest"));
		TakeNItems(sld, "potion2", 1);
		Lai_SetWarriorType(sld);
	    ChangeCharacterAddressGroup(sld, "Location_reserve_48", "goto", "goto2");
		LAi_group_MoveCharacter(sld, LAI_GROUP_PLAYER); //относим в группу героя
	  ...
	  for (i=1; i<+9; i++)
	  {
		sld = GetCharacter(NPC_GenerateCharacter("CaptainFraMen2_"+i, "paladin_"+i, "man", "man2", 1, PIRATE, -1, true, "quest"));
		TakeNItems(sld, "potion2", 1);
		Lai_SetWarriorType(sld);
	    ChangeCharacterAddressGroup(sld, "Location_reserve_48", "goto", "goto3");
		LAi_group_MoveCharacter(sld, LAI_GROUP_PLAYER); //относим в группу героя
	  ...
	  for (i=1; i<+9; i++)
	  {
		sld = GetCharacter(NPC_GenerateCharacter("CaptainFraMen3_"+i, "paladin_"+i, "man", "man2", 1, PIRATE, -1, true, "quest"));
		TakeNItems(sld, "potion2", 1);
		Lai_SetWarriorType(sld);
	    ChangeCharacterAddressGroup(sld, "Location_reserve_48", "goto", "goto4");
		LAi_group_MoveCharacter(sld, LAI_GROUP_PLAYER); //относим в группу героя
	   
	  }
	  // четвёртый отряд солдат
	  for (i=1; i<+9; i++)
	  {
		sld = GetCharacter(NPC_GenerateCharacter("CaptainFraMen4_"+i, "paladin_"+i, "man", "man2", 1, PIRATE, -1, true, "quest"));
		TakeNItems(sld, "potion2", 1);
		Lai_SetWarriorType(sld);
	    ChangeCharacterAddressGroup(sld, "Location_reserve_48", "goto", "stay2");
		LAi_group_MoveCharacter(sld, LAI_GROUP_PLAYER); //относим в группу героя
	  ...
	  for (i=1; i<+9; i++)
	  {
		sld = GetCharacter(NPC_GenerateCharacter("CaptainFraMen5_"+i, "paladin_"+i, "man", "man", 1, PIRATE, -1, true, "quest"));
		TakeNItems(sld, "potion2", 1);
		Lai_SetWarriorType(sld);
	    ChangeCharacterAddressGroup(sld, "Location_reserve_48", "goto", "stay4");
		LAi_group_MoveCharacter(sld, LAI_GROUP_PLAYER); //относим в группу героя
	   
	  }
	  for (i=1; i<+5; i++)
	  {
		sld = characterFromID("CaptainFraMen_"+i);
		
		LAi_SetWarriorType(sld);
	    LAi_group_MoveCharacter(sld, LAI_GROUP_PLAYER); //относим в группу героя
	  }
	  LAi_group_SetRelation("LaFayetFight1", LAI_GROUP_PLAYER, LAI_GROUP_ENEMY);
	  LAi_group_FightGroups("LaFayetFight1", LAI_GROUP_PLAYER, true);
	  LAi_SetFightMode(pchar, true);
	  LAi_group_SetCheck("LaFayetFight1", "Memories_47");
	  break;

	  case "Memories_46":
	  DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_46");
	  sld = characterFromID("LULU");
	  Lai_SetStunnedTypeNoGroup(sld);
	  pchar.quest.Memories46.win_condition.l1 = "NPC_Death";
	  pchar.quest.Memories46.win_condition.l1.character = "LaFayet";
	  pchar.quest.Memories46.win_condition = "Memories_46a";
	  break;


	  case "Memories_46a":
	  DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_46a");
	  sld = characterFromID("LULU");
	  Lai_SetActorType(sld);
	  LAi_ActorRunToLocator(sld, "goto", "goto6", "Memories_46b", -1);
	  break;


	  case "Memories_46b":
	  DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_46b");
	  sld = characterFromID("LULU");
	  sld.DontClearDead = true;    // чтоб не пропадал труп
	  LAi_KillCharacter(sld);
	  break;


	  case "Memories_47":
	  DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_47");
	  AddComplexSelfExpToScill(50, 50, 50, 50);
	  AddCharacterExpToSkill(pchar, GetEquipedBladeType(pchar), 50);
	  log_info("Надо найти Лулу! Что с ней?!");
	  //sld = characterFromID("LULU");
	  //Lai_SetStayType(sld);
	  //Lai_SetActorType(pchar);
	  //LAi_ActorRunToLocator(pchar, "goto", "goto6", "Memories_49", -1);
	  //LAi_ActorFollow(pchar, characterFromId("LULU"), "Memories_48", -1);
	  pchar.quest.Memories47.win_condition.l1 = "locator";
	  pchar.quest.Memories47.win_condition.l1.location = "Location_reserve_48";
	  pchar.quest.Memories47.win_condition.l1.locator_group = "goto";
	  pchar.quest.Memories47.win_condition.l1.locator = "goto6";
	  pchar.quest.Memories47.win_condition = "Memories_47a";
	  break;


	  case "Memories_47a":
	  DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_47a");
	  startvideo("LULUdeath");
	  Lai_QuestDelay("Memories_47b", 1.0);
      break;


	  case "Memories_47b":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_47b");
	   Lai_SetActorType(pchar);
	   pchar.Dialog.CurrentNode = "demor_Memories_2";
	   SelfDialog(pchar);
	   break;
	   ...
	   case "Memories_47c":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_47c");
	   Lai_SetPlayerType(pchar);
	   //LAi_KillCharacter(pchar);
	   pchar.Dialog.CurrentNode = "First Time";
	   break;
	  ...
	  case "Memories_48":
	  DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_48");
	  Lai_SetPlayerType(pchar);
	  sld = characterFromID("LULU");
	  Lai_SetActorType(sld);
	  sld.dialog.currentnode = "dialogSharlie_8";
	  LAi_ActorDialog(sld, pchar, "", 1, 0);
	  break;

      case "Memories_49":
	  DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_49");
	  TakeItemFromCharacter(pchar, "letter_Fayet");
	  WaitDate("", 0, 0, 8, 0, 0);    // Кручу 8 дней
	  SetCurrentTime(12, 00);        // устанавливаем время
      RecalculateJumpTable();
	  SetLaunchFrameFormParam("Спустя несколько дней"+ NewStr() +"в Лувре", "", 0, 6);
	  LaunchFrameForm();
	  DoQuestCheckDelay("Memories_50", 5.0);
	  break;


	  case "Memories_50":
	  DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_50");
	  DoQuestReloadToLocation("Location_reserve_47", "goto", "goto1", "Memories_51");
	  SetNewDayHealthMax();
	  AddCharacterHealth(pchar, 36);
	  sld = GetCharacter(NPC_GenerateCharacter("Mazarini", "Abbat", "man", "man_B", 5, PIRATE, -1, true, ""));
	  sld.name = "Джулио";
	  sld.lastname = "Мазарини";
	  sld.dialog.filename = "NewPapka\Memories\Mazarini.c";
	  LAi_SetStayType(sld);
	  ChangeCharacterAddressGroup(sld, "Location_reserve_47", "goto", "goto8");
	  break;


	  case "Memories_51":
	  DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_51");
	  Lai_SetActorType(pchar);
	  LAi_ActorFollow(pchar, characterFromId("Mazarini"), "Memories_52", -1);
	  break;


	  case "Memories_52":
	  DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_52");
	  Lai_SetPlayerType(pchar);
	  sld = characterFromID("Mazarini");
	  Lai_SetActorType(sld);
	  sld.dialog.currentnode = "dialogSharlie_1";
	  LAi_ActorDialog(sld, pchar, "", 1, 0);
	  break;
	  ...
	  case "Memories_53":
	  DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_53");
	  AddCharacterExpToSkill(Pchar, "Leadership", 200);
	  Lai_SetActorType(pchar);
	  Lai_ActorRunToLocation(pchar, "reload", "reload1", "none", "", "", "Memories_54", -1);
	  break;


	  case "Memories_54":
	  DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_54");
	  WaitDate("", 0, 0, 0, 0, 30);    // 
      RecalculateJumpTable();
	  SetLaunchFrameFormParam("Спустя ещё полчаса", "", 0, 6);
	  LaunchFrameForm();
	  DoQuestCheckDelay("Memories_55", 5.0);
	  break;


      case "Memories_55":
	  DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_55");
	  pchar = GetMainCharacter(); //меняем ГГ
	  SetMainCharacterIndex(GetCharacterIndex("Valinie"));
	  DoQuestReloadToLocation("Location_reserve_47", "reload", "reload2", "Memories_56");
	  Lai_SetPlayerType(pchar);
	  break;


	  case "Memories_56":
	  DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_56");
	  Lai_SetActorType(pchar);
	  LAi_ActorFollow(pchar, characterFromId("Mazarini"), "Memories_57", -1);
	  break;


	  case "Memories_57":
	  DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_57");
	  Lai_SetPlayerType(pchar);
	  sld = characterFromID("Mazarini");
	  Lai_SetActorType(sld);
	  sld.dialog.currentnode = "dialogValinie_1";
	  LAi_ActorDialog(sld, pchar, "", 1, 0);
	  break;


	  case "Memories_58":
	  DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_58");
	  Lai_SetActorType(pchar);
	  Lai_ActorRunToLocation(pchar, "reload", "reload1", "none", "", "", "Memories_59", -1);
	  break;


	  case "Memories_59":
	  DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_59");
	  WaitDate("", 0, 0, 0, 0, 0);    // 
      RecalculateJumpTable();
	  SetLaunchFrameFormParam("Настоящее время", "", 0, 6);
	  LaunchFrameForm();
	  Environment.date.year = 1654;
	  Environment.date.month = 10;
	  Environment.date.day = 1;
	  worldMap.date.year = 1654;
	  worldMap.date.month = 10;
	  worldMap.date.day = 1;
	  SetCurrentTime(12, 00);
	  DoQuestCheckDelay("Memories_60", 5.0);
	  break;


      case "Memories_60":
	  DeleteAttribute(pchar,"PostEventQuest.questDelay.Memories_60");
	  pchar = GetMainCharacter(); //меняем ГГ
	  SetMainCharacterIndex(GetCharacterIndex("BLAZE"));
      ...
      case "DeMor_1":
	  DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_1");
	  sld = GetCharacter(NPC_GenerateCharacter("DiegoEnemy", "Citiz_58", "man", "man", 40, PIRATE, -1, true, "quest"));
	  sld.name 	= "Неизвестный";
	  sld.lastname = "";
	  sld.Dialog.Filename = "NewPapka/DiegoEnemy.c";
	  sld.dialog.currentnode = "First Time";
	  sld = GetCharacter(NPC_GenerateCharacter("Jak_Victime", "devlin", "man", "man", 40, PIRATE, -1, true, "quest"));
	  sld.name 	= "Жак";
	  sld.lastname = "Виктиме";
	  sld.Dialog.Filename = "NewPapka/JakVictime.c";
	  sld.dialog.currentnode = "First Time";
	  ...
	  sld = GetCharacter(NPC_GenerateCharacter("Rene_Voleur", "Citiz_23", "man", "man", 4, PIRATE, -1, true, "quest"));
	  sld.name 	= "Рене";
	  sld.lastname = "Волёр";
	  sld.Dialog.Filename = "NewPapka/ReneVoleur.c";
	  sld.dialog.currentnode = "First Time";
	  sld = GetCharacter(NPC_GenerateCharacter("Jerar_Emozi", "Citiz_21", "man", "man", 4, PIRATE, -1, true, "quest"));
	  sld.name 	= "Жерар";
	  sld.lastname = "Эмози";
	  sld.Dialog.Filename = "NewPapka/JerarEmozi.c";
	  sld.dialog.currentnode = "First Time";
	  sld = GetCharacter(NPC_GenerateCharacter("Valinie", "Guide_1", "man", "man", 40, PIRATE, -1, true, "quest"));
	  sld.name 	= "Грегуар";
	  sld.lastname = "Валинье";
	  sld.Dialog.Filename = "NewPapka/Valinie.c";
	  sld.dialog.currentnode = "First Time";
	  TakeNItems(sld, "potion2", 20);
	  GiveItem2Character(sld, "pistol5");
	  GiveItem2Character(sld, "blade_30");
	  ...
	  SetSPECIAL (sld, 10, 10, 10, 5, 5, 10, 5);
	  LAi_SetHP(sld, 500.0, 500.0);
	  sld = GetCharacter(NPC_GenerateCharacter("OlivieBlank", "off_fra_1", "man", "man", 4, PIRATE, -1, true, "quest"));
	  sld.name 	= "Оливье";
	  sld.lastname = "Блан";
	  sld.Dialog.Filename = "NewPapka/OlivieBlank.c";
	  sld.dialog.currentnode = "First Time";
      pchar.quest.DeMor1.win_condition.l1 = "location";
	  pchar.quest.DeMor1.win_condition.l1.location = "Fortfrance_town";
	  pchar.quest.DeMor1.win_condition = "DeMor_2";
       break;


	   case "DeMor_2":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_2");
	   Lai_SetActorType(pchar);
	   pchar.Dialog.CurrentNode = "demor_dream";
	   SelfDialog(pchar);
	   break;
	   ...
	   case "DeMor_3":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_3");
	   Lai_SetPlayerType(pchar);
	   pchar.Dialog.CurrentNode = "First Time";
	   break;
	   ...
	   case "DeMor_4":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_4");
	   SetLaunchFrameFormParam("За два часа до этого....", "", 0, 8);
	   LaunchFrameForm();
	   WaitDate("", 0, 0, 0, -2, 0); // Крутану два часа назад
	   RecalculateJumpTable();
	   DoQuestCheckDelay("DeMor_5b", 2.0);
	   break;


	    case "DeMor_5b":
		DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_5b");
		EndBattleLandInterface(); //отключаем интерфейс
		QuestMovieLockPlayer();   // вкл окаёмки
		pchar = GetMainCharacter(); //меняем ГГ
		SetMainCharacterIndex(GetCharacterIndex("DiegoEnemy"));
		Lai_SetstayType(pchar);
		DoReloadCharacterToLocation("shore38", "goto", "goto5");
		chrDisableReloadToLocation = true; // закрыть докацию
		bDisableCharacterMenu = true;   // запретить F2
		sld = characterFromID("Jak_Victime");
		ChangeCharacterAddressGroup(sld, "shore38", "goto", "goto2");
		Lai_SetActorType(sld);
		LAi_ActorFollow(sld, characterFromId("DiegoEnemy"), "DeMor_5a", 1);
		break;


		 case "DeMor_5a":
		 DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_5a");
		 sld = characterFromID("Jak_Victime");
		 sld.dialog.currentnode = "doclad";
		 LAi_ActorDialog(sld, pchar, "", -1, 0);
		 break;
		...
		case "DeMor_6":
		DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_6");
		sld = characterFromID("Jak_Victime");
		Lai_SetActorType(sld);
		Lai_ActorRunToLocation(sld, "reload", "reload1_back", "none", "", "", "", -1);
		DoQuestCheckDelay("DeMor_6a", 3.0);
		break;


		case "DeMor_6a":
		DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_6a");
		Lai_SetActorType(pchar);
		Lai_ActorRunToLocation(pchar, "reload", "reload1_back", "none", "", "", "DeMor_7", -1);
		break;



		case "DeMor_7":
		DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_7");
		 SetLaunchFrameFormParam("Настоящее время....", "", 0, 8);
	   LaunchFrameForm();
	   WaitDate("", 0, 0, 0, 2, 0); // Крутану два часа назад
	   RecalculateJumpTable();
	   DoQuestCheckDelay("DeMor_8", 2.0);
	   break;



		case "DeMor_8":
		DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_8");
		QuestMovieUnLockPlayer();  // выкл окаёмки
		DoReloadCharacterToLocation("fortFrance_town", "goto", "goto16");
		bDisableCharacterMenu() = false;  //Разрешить F2
		pchar = GetMainCharacter(); //меняем ГГ
		SetMainCharacterIndex(GetCharacterIndex("BLAZE"));
		Lai_SetPlayerType(pchar);
		sld = characterFromID("Jak_Victime");
		ChangeCharacterAddressGroup(sld, "fortFrance_town", "goto", "goto2");
		Lai_SetActorType(sld);
		LAi_ActorFollow(sld, characterFromId("BLAZE"), "DeMor_9", 1);
		break;



		case "DeMor_9":
		DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_9");
		sld = characterFromID("Jak_Victime");
		sld.dialog.currentnode = "dialog1";
		LAi_ActorDialog(sld, pchar, "", -1, 0);
		break;
        ...
        case "DeMor_10":
		DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_10");
		sld = characterFromID("Jak_Victime");
		Lai_SetActorType(sld);
		Lai_ActorRunToLocation(sld, "reload", "houseS1", "none", "", "", "DeMor_11", -1);
		break;



		case "DeMor_11":
		DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_11");
		DoReloadCharacterToLocation("commoncobhouse", "goto", "goto3");
		sld = characterFromID("Jak_Victime");
		ChangeCharacterAddressGroup(sld, "commoncobhouse", "goto", "goto2");
		Lai_SetActorType(sld);
		LAi_ActorFollow(sld, characterFromId("BLAZE"), "DeMor_12", 1);
		break;



		case "DeMor_12":
		DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_12");
		sld = characterFromID("Jak_Victime");
		sld.dialog.currentnode = "dialog2";
		LAi_ActorDialog(sld, pchar, "", -1, 0);
		break;


		case "DeMor_13":
		DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_13");
		sld = characterFromID("Rene_Voleur");
		ChangeCharacterAddressGroup(sld, "commoncobhouse", "goto", "goto1");
		sld.dialog.currentnode = "Sharlie_Trip";
		Lai_SetActorType(sld);
		LAi_ActorDialog(sld, pchar, "", -1, 0);
		break;
        ...
        case "DeMor_14":
		DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_14");
		pchar = GetMainCharacter(); //меняем ГГ
		SetMainCharacterIndex(GetCharacterIndex("Jak_Victime"));
		Lai_SetPlayerType(pchar);
		DoQuestReloadToLocation("fortFrance_town", "reload", "houseS1", "DeMor_15");
		...
		case "DeMor_15":
		DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_15");
		sld = characterFromID("OlivieBlank");
		ChangeCharacterAddressGroup(sld, "fortFrance_town", "goto", "goto6");
		sld.dialog.currentnode = "Check_1";
		Lai_SetActorType(sld);
	    LAi_ActorDialog(sld, pchar, "", -1, 0);
	    break;
	    ...
	    case "DeMor_16":
		DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_16");
	    sld = characterFromID("OlivieBlank");
	    sld.dialog.currentnode = "Check_1";
	    LAi_ActorDialog(sld, pchar, "", -1, 0);
	    break;
		...
		case "DeMor_17":
		DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_17");
		DoReloadCharacterToLocation("fortFrance_church", "goto", "goto1");
		AddQuestRecord("JAKVICTIME", "1");
		sld = characterFromID("Benua");
		sld.dialog.currentnode = "Benua_meeting";
		sld = characterFromID("OlivieBlank");
		LAi_SetWarriorType(sld);
		chrDisableReloadToLocation = false; // открыть докацию
		break;


        case "DeMor_170":
		DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_170");
		Lai_SetActorType(pchar);
		Lai_ActorRunToLocation(pchar, "goto", "goto1", "none", "", "", "DeMor_1700", -1);
		SetLaunchFrameFormParam("На следующий день....", "", 0, 8);
	    LaunchFrameForm();
	    WaitDate("", 0, 0, 1, 0, 0); // Крутим день чтобы не ходить в таверну
	    RecalculateJumpTable();
		...
		case "DeMor_1700":
		DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_1700");
		DoReloadCharacterToLocation("fortFrance_church", "goto", "goto1");
       ...
       case "DeMor_171":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_171");
	   sld = GetCharacter(NPC_GenerateCharacter("Sh_Maltie1", "off_Malt_2", "man", "man", 30, FRANCE, -1, true, "soldier"));  // генерим мальтийца
	   ...
	   case "DeMor_172":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_172");
	   DoReloadCharacterToLocation("fortFrance_dungeon", "goto", "goto5");
	   sld = characterFromID("Sh_Maltie1");
	   ChangeCharacterAddressGroup(sld, "fortFrance_dungeon", "goto", "goto5");
	   sld.dialog.currentnode = "Sharlie_maltie_3";
	   LAi_SetActorType(sld);
	   LAi_ActorDialog(sld, pchar, "", 1.0, -1);
	   break;
	   ...
	   case "DeMor_18":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_18");
	   sld = characterFromID("Sh_Maltie1");
	   LAi_SetImmortal(sld, false);
	   LAi_SetHP(sld, 1.0, 1.0);
	   Lai_SetStayType(sld);
	   Lai_SetActorType(pchar);
	   Lai_ActorAttack(characterFromID("Jak_Victime"), characterFromID("Sh_Maltie1"), "");
	   pchar.quest.DeMor18.win_condition.l1 = "NPC_Death";
	   pchar.quest.DeMor18.win_condition.l1.character = "Sh_Maltie1";
	   pchar.quest.DeMor18.win_condition = "DeMor_20";
	   break;



		case "DeMor_181":
		DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_181");
		sld = characterFromID("Sh_Maltie1");
		LAi_SetImmortal(sld, false);
		LAi_group_MoveCharacter(sld, "EnemyFight");
		LAi_group_SetRelation("EnemyFight", LAI_GROUP_PLAYER, LAI_GROUP_ENEMY);
		LAi_group_FightGroups("EnemyFight", LAI_GROUP_PLAYER, true);
		LAi_SetFightMode(pchar, true);
		LAi_group_SetCheck("EnemyFight", "DeMor_19");
		break;
       ...
       case "DeMor_19":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_19");
	   pchar.quest.DeMor19.win_condition.l1 = "NPC_Death";//прерывание на потопление 
	   pchar.quest.DeMor19.win_condition.l1.character = "Sh_Maltie1";
	   pchar.quest.DeMor19.win_condition = "DeMor_20";
	   break;



	   case "DeMor_20":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_20");
	   log_info("Нужно открыть вход штурмовой группе");
	   Lai_SetPlayerType(pchar);
	   AddQuestRecord("JAKVICTIME", "3");
	   pchar.quest.DeMor20.win_condition.l1 = "locator";
	   pchar.quest.DeMor20.win_condition.l1.location = "fortFrance_dungeon";
	   pchar.quest.DeMor20.win_condition.l1.locator_group = "reload";
	   pchar.quest.DeMor20.win_condition.l1.locator = "reload1";
	   pchar.quest.DeMor20.win_condition = "DeMor_21";
	   break;



	   case "DeMor_21":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_21");
	   SetLaunchFrameFormParam("В то же время....", "", 0, 8);
	   LaunchFrameForm();
	   WaitDate("", 0, 0, 0, -1, 0); // Крутану два часа назад
	   RecalculateJumpTable();
	   DoQuestCheckDelay("DeMor_22", 2.0);
	   break;
	   

	   case "DeMor_22":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_22");
	   DoReloadCharacterToLocation("commonPirateResidence", "reload", "reload1");
	   pchar = GetMainCharacter(); //меняем ГГ
	   SetMainCharacterIndex(GetCharacterIndex("BLAZE"));
	   Lai_SetLayType(pchar);
	   sld = characterFromID("Rene_Voleur");
	   ChangeCharacterAddressGroup(sld, "commonPirateResidence", "goto", "goto5");
	   LAi_SetGroundSitType(sld);
       pchar.quest.DeMor22.win_condition.l1 = "location";
	   pchar.quest.DeMor22.win_condition.l1.location = "commonPirateResidence";
	   pchar.quest.DeMor22.win_condition = "DeMor_222";
       break;


       case "DeMor_222":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_222");
	   pchar.Dialog.CurrentNode = "demor_dream_2";
	   SelfDialog(pchar);
	   break;
	   ...
	   case "DeMor_23":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_23");
	   pchar.Dialog.CurrentNode = "First Time";
	   SetLaunchFrameFormParam("Через некоторое время....", "", 0, 8);
	   LaunchFrameForm();
	   WaitDate("", 0, 0, 0, 1, 0); // Крутану время
	   RecalculateJumpTable();
	   DoQuestCheckDelay("DeMor_24", 2.0);
	   break;


	   case "DeMor_24":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_24");
	   pchar = GetMainCharacter(); //меняем ГГ
	   SetMainCharacterIndex(GetCharacterIndex("Rene_Voleur"));
       LAi_SetGroundSitType(sld);
	   DoReloadCharacterToLocation("commonPirateResidence", "goto", "goto5");
	   sld = characterFromID("Jerar_Emozi");
	   ChangeCharacterAddressGroup(sld, "commonPirateResidence", "reload", "reload1");
	   sld.dialog.currentnode = "First Time";
	   Lai_SetActorType(sld);
	   LAi_ActorDialog(sld, pchar, "", -1, 0);
	   break;
	   ...
	   case "DeMor_25":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_25");
	   pchar = GetMainCharacter(); //меняем ГГ
	   SetMainCharacterIndex(GetCharacterIndex("Valinie"));
	   DoReloadCharacterToLocation("commoncobhouse", "reload", "reload1");
	   Lai_SetPlayerType(pchar);
	   sld = characterFromID("Jerar_Emozi");
	   ChangeCharacterAddressGroup(sld, "commoncobhouse", "goto", "goto3");
	   sld = characterFromID("Rene_Voleur");
	   ChangeCharacterAddressGroup(sld, "commoncobhouse", "goto", "goto1");
	   sld.dialog.currentnode = "dialogValinie";
	   Lai_SetActorType(sld);
	   LAi_ActorDialog(sld, pchar, "", -1, 0);
	   break;
	   ...
	   case "DeMor_26":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_26");
	   sld = characterFromID("Rene_Voleur");
	   LAi_group_MoveCharacter(sld, "EnemyFight");
	   sld = characterFromID("Jerar_Emozi");
	   LAi_group_MoveCharacter(sld, "EnemyFight");
	   ...
	   LAi_group_FightGroups("EnemyFight", LAI_GROUP_PLAYER, true);
	   LAi_SetFightMode(pchar, true);
	   LAi_group_SetCheck("EnemyFight", "DeMor_27");
	   break;
	   ...
	   case "DeMor_27":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_27");
	   log_info("Нужно посмотреть наверху");
	   AddQuestRecord("ValinieAvantura", "1");
	   pchar.quest.DeMor27.win_condition.l1 = "locator";
	   pchar.quest.DeMor27.win_condition.l1.location = "commonPirateResidence";
	   pchar.quest.DeMor27.win_condition.l1.locator_group = "reload";
	   pchar.quest.DeMor27.win_condition.l1.locator = "reload1";
	   pchar.quest.DeMor27.win_condition = "DeMor_28";
	   break;
	   ...
	   case "DeMor_28":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_28");
	   log_info("Нужно найти у окна стакан с водой");
	   AddQuestRecord("ValinieAvantura", "2");
	   pchar.quest.DeMor28.win_condition.l1 = "locator";
	   pchar.quest.DeMor28.win_condition.l1.location = "commonPirateResidence";
	   pchar.quest.DeMor28.win_condition.l1.locator_group = "reload";
	   pchar.quest.DeMor28.win_condition.l1.locator = "reload2";
	   pchar.quest.DeMor28.win_condition = "DeMor_29";
	   break;



	   case "DeMor_29":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_29");
	   SetLaunchFrameFormParam("Через несколько минут....", "", 0, 8);
	   LaunchFrameForm();
	   WaitDate("", 0, 0, 0, 0, 20); // Крутану время
	   RecalculateJumpTable();
	   DoQuestCheckDelay("DeMor_29a", 2.0);
	   break;


       case "DeMor_29a":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_29a");
	   DoReloadCharacterToLocation("commonPirateResidence", "reload", "reload1");
	   pchar = GetMainCharacter(); //меняем ГГ
	   SetMainCharacterIndex(GetCharacterIndex("BLAZE"));
	   Lai_SetPlayerType(pchar);
	   sld = characterFromID("Valinie");
	   ChangeCharacterAddressGroup(sld, "commonPirateResidence", "goto", "goto1");
	   sld.dialog.currentnode = "dialogSharlie1";
	   Lai_SetActorType(sld);
	   LAi_ActorDialog(sld, pchar, "", -1, 0);
	   ...
	   case "DeMor_30":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_30");
	   DoQuestReloadToLocation("fortFrance_town", "reload", "houseS1", "DeMor_31");
	   AddCharacterExpToSkill(pchar, "Fortune", 100);
	   sld = characterFromID("Valinie");
	   ChangeCharacterAddressGroup(sld, "fortFrance_town", "reload", "houseS1");
	   Lai_SetActorType(sld);
	   LAi_ActorFollow(sld, characterFromId("BLAZE"), "", 1);
       //sld = characterFromID("AndreKoni");
	   //ChangeCharacterAddressGroup(sld, "fortFrance_town", "goto", "goto6");
	   //Lai_SetActorType(sld);
	   //LAi_ActorFollow(sld, characterFromId("BLAZE"), "", 1);
	   sld = characterFromID("OlivieBlank");
	   ChangeCharacterAddressGroup(sld, "fortFrance_town", "goto", "goto20");
	   Lai_SetActorType(sld);
	   LAi_ActorFollow(sld, characterFromId("BLAZE"), "DeMor_31", 1);
	   break;


       case "DeMor_31":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_31");
	   sld = characterFromID("OlivieBlank");
	   sld.dialog.currentnode = "Check_3";
	   LAi_ActorDialog(sld, pchar, "", -1, 0);
	   break;


	   case "DeMor_32":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_32");
	   sld = characterFromID("Valinie");
	   sld.dialog.currentnode = "dialogOlivieBlank1";
	   LAi_ActorDialog(sld, pchar, "", -1, 0);
	   break;


	   case "DeMor_33":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_33");
	   sld = characterFromID("OlivieBlank");
	   sld.dialog.currentnode = "Check_4";
	   LAi_ActorDialog(sld, pchar, "", -1, 0);
	   break;


	   case "DeMor_34":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_34");
	   //LAi_SetImmortal(pchar, true);    // бессмертие Шарля
	   for (i=1; i<+6; i++)
	  {
		sld = GetCharacter(NPC_GenerateCharacter("FortfranceEnemySold_"+i, "sold_fra_"+i, "man", "man", 2, PIRATE, -1, true, "quest"));
		TakeNItems(sld, "potion2", 1);
		LAi_SetWarriorType(sld);
	    ChangeCharacterAddressGroup(sld, "fortFrance_town", "goto", "goto20");
	    LAi_group_MoveCharacter(sld, "EnemyFight");
       ...
       sld = characterFromID("Valinie");
	   LAi_SetImmortal(sld, true);    // бессмертие Валинье
	   LAi_SetWarriorType(sld);
	   LAi_group_MoveCharacter(sld, LAI_GROUP_PLAYER); //относим в группу героя
	   //LAi_SetCheckMinHP(sld, 25, true, "DeMor_35");   // условие падения здоровья
	   //LAi_SetCheckMinHP(pchar, 25, true, "DeMor_35");
	   sld = characterFromID("OlivieBlank");
	   Lai_SetActorType(sld);
	   ...
	   LAi_SetFightMode(pchar, true);
	   LAi_group_SetCheck("EnemyFight", "DeMor_40");
	   break;


	   case "DeMor_35":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_35");
	   log_info("Валим в резиденцию, де Мор!");
	   sld = characterFromID("Valinie");
	   Lai_SetActorType(sld);
	   Lai_ActorRunToLocation(sld, "reload", "reload3_back", "none", "", "", "", -1);
	   Lai_SetActorType(pchar);
	   Lai_ActorRunToLocation(pchar, "reload", "reload3_back", "none", "", "", "DeMor_41", -1);
	   break;
		...
		case "DeMor_40":
		DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_40");
		//sld = characterFromID("AndreKoni");
	   //ChangeCharacterAddressGroup(sld, "", "", "");  // Убираем Кони
	   //sld = characterFromID("OlivieBlank");    
	   //ChangeCharacterAddressGroup(sld, "", "", "");   // Убираем Бланка
	   AddComplexSelfExpToScill(30, 30, 30, 30);
	   AddCharacterExpToSkill(pchar, GetEquipedBladeType(pchar), 50);
		sld = characterFromID("Valinie");
	    sld.dialog.currentnode = "dialogSharlie10";
	    Lai_SetActorType(sld);
	    LAi_ActorDialog(sld, pchar, "", -1, 0);
	    break;
	   ...
	   case "DeMor_41":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_41");
	   SetLaunchFrameFormParam("В то же время....", "", 0, 8);
	   LaunchFrameForm();
	   WaitDate("", 0, 0, 0, 0, 30); // Крутану время
	   RecalculateJumpTable();
	   DoQuestCheckDelay("DeMor_42", 2.0);
	   break;


	   case "DeMor_42":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_42");
	   sld = characterFromID("AndreKoni");
	   ChangeCharacterAddressGroup(sld, "", "", "");  // Убираем Кони
	   sld = characterFromID("OlivieBlank");    
	   ChangeCharacterAddressGroup(sld, "", "", "");   // Убираем Бланка
	   ...
	   SetMainCharacterIndex(GetCharacterIndex("Jak_Victime"));
	   Lai_SetPlayerType(pchar);
	   DoQuestReloadToLocation("Location_reserve_50", "goto", "goto5", "DeMor_43");
	   break;



	   case "DeMor_43":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_43");
	   sld = GetCharacter(NPC_GenerateCharacter("Mishelle1", "Migel_1", "man", "man", 60, FRANCE, -1, false, "quest"));  //ставим двойника Мишеля
	sld.name = "Мишель";
	...
	LAi_SetImmortal(sld, true);
	LAi_group_MoveCharacter(sld, "FRANCE_CITIZENS");
	ChangeCharacterAddressGroup(sld, "Location_reserve_50", "quest", "quest1");
	   // Штурмовик 1
	  sld = GetCharacter(NPC_GenerateCharacter("Shturm_First", "Citiz_58", "man", "man", 25, PIRATE, -1, true, "quest"));
	  sld.name = "Штурмовик";
	  sld.lastname = "Первый";
	  sld.dialog.filename = "NewPapka\BG1.c";
	  TakeNItems(sld, "potion2", 3);
	  LAi_SetStayType(sld);
	  ChangeCharacterAddressGroup(sld, "Location_reserve_50", "goto", "goto6");
	  LAi_group_MoveCharacter(sld, LAI_GROUP_PLAYER);
	  // Штурмовик 2
	  sld = GetCharacter(NPC_GenerateCharacter("Shturm_Second", "Citiz_58", "man", "man", 25, PIRATE, -1, true, "quest"));
	  sld.name = "Штурмовик";
	  sld.lastname = "Второй";
	  sld.dialog.filename = "NewPapka\BG2.c";
	  TakeNItems(sld, "potion2", 3);
	  LAi_SetStayType(sld);
	  ChangeCharacterAddressGroup(sld, "Location_reserve_50", "goto", "goto6");
	  LAi_group_MoveCharacter(sld, LAI_GROUP_PLAYER);
	  // Штурмовик 3
	  sld = GetCharacter(NPC_GenerateCharacter("Shturm_Third", "Citiz_58", "man", "man", 25, PIRATE, -1, true, "quest"));
	  sld.name = "Штурмовик";
	  sld.lastname = "Третий";
	  sld.dialog.filename = "NewPapka\BG3.c";
	  TakeNItems(sld, "potion2", 3);
	  LAi_SetStayType(sld);
	  ChangeCharacterAddressGroup(sld, "Location_reserve_50", "goto", "goto6");
	  LAi_group_MoveCharacter(sld, LAI_GROUP_PLAYER);
	  // Штурмовик 4
	  sld = GetCharacter(NPC_GenerateCharacter("Shturm_Thourth", "Citiz_58", "man", "man", 25, PIRATE, -1, true, "quest"));
	  sld.name = "Штурмовик";
	  sld.lastname = "Четвёртый";
	  sld.dialog.filename = "NewPapka\BG4.c";
	  TakeNItems(sld, "potion2", 3);
	  LAi_SetStayType(sld);
	  ChangeCharacterAddressGroup(sld, "Location_reserve_50", "goto", "goto6");
	  LAi_group_MoveCharacter(sld, LAI_GROUP_PLAYER);
	  // Штурмовик 5
	  sld = GetCharacter(NPC_GenerateCharacter("Shturm_Fifth", "Citiz_58", "man", "man", 25, PIRATE, -1, true, "quest"));
	  sld.name = "Штурмовик";
	  sld.lastname = "Пятый";
	  sld.dialog.filename = "NewPapka\BG5.c";
	  TakeNItems(sld, "potion2", 3);
	  LAi_SetStayType(sld);
	  ChangeCharacterAddressGroup(sld, "Location_reserve_50", "goto", "goto6");
	  LAi_group_MoveCharacter(sld, LAI_GROUP_PLAYER);
	  ...
	  for (i=1; i<+6; i++)
	  {
		sld = GetCharacter(NPC_GenerateCharacter("ShturmDungeon_"+i, "Citiz_58", "man", "man",25, PIRATE, -1, true, "quest"));
		TakeNItems(sld, "potion2", 3);
		LAi_SetWarriorType(sld);
	    ChangeCharacterAddressGroup(sld, "Location_reserve_50", "goto", "goto4");
	    LAi_group_MoveCharacter(sld, LAI_GROUP_PLAYER);
	  }
	   sld = characterFromID("MaltainsStay_5");
	   sld.nation = PIRATE;
	   LAi_group_MoveCharacter(sld, "PIRATE_CITIZENS");
	   LAi_group_MoveCharacter(sld, "DungeonEnemyFight");
	   sld = characterFromID("MaltainsStay_4");
	   sld.nation = PIRATE;
	   LAi_group_MoveCharacter(sld, "PIRATE_CITIZENS");
	   LAi_group_MoveCharacter(sld, "DungeonEnemyFight");
	   sld = characterFromID("MaltainsStay_3");
	   sld.nation = PIRATE;
	   LAi_group_MoveCharacter(sld, "PIRATE_CITIZENS");
	   LAi_group_MoveCharacter(sld, "DungeonEnemyFight");
	   sld = characterFromID("MaltainsStay_2");
	   sld.nation = PIRATE;
	   LAi_group_MoveCharacter(sld, "PIRATE_CITIZENS");
	   LAi_group_MoveCharacter(sld, "DungeonEnemyFight");
	   sld = characterFromID("MaltainsStay_1");
	   sld.nation = PIRATE;
	   LAi_group_MoveCharacter(sld, "PIRATE_CITIZENS");
	   LAi_group_MoveCharacter(sld, "DungeonEnemyFight");
	   sld = characterFromID("MaltainsGo_1");
	   sld.nation = PIRATE;
	   LAi_group_MoveCharacter(sld, "PIRATE_CITIZENS");
	   LAi_group_MoveCharacter(sld, "DungeonEnemyFight");
	   sld = characterFromID("MaltainsGo_2");
	   sld.nation = PIRATE;
	   LAi_group_MoveCharacter(sld, "PIRATE_CITIZENS");
	   LAi_group_MoveCharacter(sld, "DungeonEnemyFight");
	   sld = characterFromID("MaltainsGo_3");
	   sld.nation = PIRATE;
	   LAi_group_MoveCharacter(sld, "PIRATE_CITIZENS");
	   LAi_group_MoveCharacter(sld, "DungeonEnemyFight");
	   sld = characterFromID("MaltainsGo_4");
	   sld.nation = PIRATE;
	   LAi_group_MoveCharacter(sld, "PIRATE_CITIZENS");
	   LAi_group_MoveCharacter(sld, "DungeonEnemyFight");
	   sld = characterFromID("MaltainsGo_5");
	   sld.nation = PIRATE;
	   LAi_group_MoveCharacter(sld, "PIRATE_CITIZENS");
	   LAi_group_MoveCharacter(sld, "DungeonEnemyFight");
	   sld = characterFromID("MaltainsSit_1");
	   sld.nation = PIRATE;
	   LAi_group_MoveCharacter(sld, "PIRATE_CITIZENS");
	   LAi_SetWarriorType(sld);
	   ChangeCharacterAddressGroup(sld, "Location_reserve_50", "goto", "goto6");
	   LAi_group_MoveCharacter(sld, "DungeonEnemyFight");
	   sld = characterFromID("MaltainsSit_2");
	   sld.nation = PIRATE;
	   LAi_group_MoveCharacter(sld, "PIRATE_CITIZENS");
	   LAi_SetWarriorType(sld);
	   ChangeCharacterAddressGroup(sld, "Location_reserve_50", "goto", "goto6");
	   LAi_group_MoveCharacter(sld, "DungeonEnemyFight");
	   sld = characterFromID("MaltainsSit_3");
	   sld.nation = PIRATE;
	   LAi_group_MoveCharacter(sld, "PIRATE_CITIZENS");
	   LAi_SetWarriorType(sld);
	   ChangeCharacterAddressGroup(sld, "Location_reserve_50", "goto", "goto6");
	   LAi_group_MoveCharacter(sld, "DungeonEnemyFight");
	   sld = characterFromID("MaltainsSit_4");
	   sld.nation = PIRATE;
	   LAi_group_MoveCharacter(sld, "PIRATE_CITIZENS");
	   LAi_SetWarriorType(sld);
	   ChangeCharacterAddressGroup(sld, "Location_reserve_50", "goto", "goto6");
	   LAi_group_MoveCharacter(sld, "DungeonEnemyFight");
	   LAi_group_SetRelation("DungeonEnemyFight", LAI_GROUP_PLAYER, LAI_GROUP_ENEMY);
	   LAi_group_FightGroups("DungeonEnemyFight", LAI_GROUP_PLAYER, true);
	   
	   LAi_group_NotFightPlayerVSGroup("ShturmFight");
	   LAi_SetFightMode(pchar, true);
	   LAi_group_SetCheck("DungeonEnemyFight", "DeMor_44");
	   
	   break;


	   case "DeMor_44":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_44");
	   SetLaunchFrameFormParam("В то же время....", "", 0, 8);
	   LaunchFrameForm();
	   WaitDate("", 0, 0, 0, 0, 30); // Крутану время
	   RecalculateJumpTable();
	   ...
	   LAi_LockFightMode(pchar, false);
	   LAi_SetFightMode(pchar, false);
	   DoQuestCheckDelay("DeMor_45", 2.0);
	   break;

	   case "DeMor_45":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_45");
	   pchar = GetMainCharacter(); //меняем ГГ
	   SetMainCharacterIndex(GetCharacterIndex("BLAZE"));
	   Lai_SetPlayerType(pchar);
	   DoReloadCharacterToLocation("fortFrance_townhall", "goto", "goto3");
	   
		
	   sld = characterFromID("Valinie");
	   ChangeCharacterAddressGroup(sld, "fortFrance_townhall", "goto", "goto3");
	   break;


	   case "DeMor_46":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_46");
	   sld = characterFromID("Valinie");
	   Lai_SetActorType(sld);
	   LAi_ActorRunToLocator(sld, "goto", "goto6", "DeMor_47", -1);
	   //LAi_ActorFollow(sld, characterFromId("Fortfrance_Mayor"), "DeMor_47", 1);
	   break;

	   case "DeMor_47":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_47");
	   sld = characterFromID("Valinie");
	   sld.dialog.currentnode = "dialogGuber";
	   Lai_SetActorType(sld);
	   LAi_ActorDialog(sld, pchar, "", -1, 0);
	   break;
	   ...
	   case "DeMor_48":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_48");
	   SetLaunchFrameFormParam("Через несколько минут....", "", 0, 8);
	   LaunchFrameForm();
	   WaitDate("", 0, 0, 0, 0, 20); // Крутану время
	   RecalculateJumpTable();
	   DoQuestCheckDelay("DeMor_49", 2.0);
	   break;

       case "DeMor_49":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_49");
	   DoQuestReloadToLocation("Location_reserve_50", "goto", "goto5", "DeMor_50");
	   AddCharacterExpToSkill(pchar, "Fortune", 100);
	   AddCharacterExpToSkill(Pchar, "Leadership", 100);
	   break;
       ...
       case "DeMor_50":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_50");
	   for (i=1; i<+9; i++)
	  {
		sld = GetCharacter(NPC_GenerateCharacter("MaltainsNew"+i, "sold_fra_"+i, "man", "man", 3, PIRATE, -1, true, "quest"));
		TakeNItems(sld, "potion2", 3);
		LAi_SetWarriorType(sld);
	    ChangeCharacterAddressGroup(sld, "Location_reserve_50", "goto", "goto6");
	    LAi_group_MoveCharacter(sld, LAI_GROUP_PLAYER);
	  ...
	  for (i=9; i<+17; i++)
	  {
		sld = GetCharacter(NPC_GenerateCharacter("MaltainsNew1"+i, "sold_fra_"+i, "man", "man", 3, PIRATE, -1, true, "quest"));
		TakeNItems(sld, "potion2", 3);
		LAi_SetWarriorType(sld);
	    ChangeCharacterAddressGroup(sld, "Location_reserve_50", "goto", "goto1");
	    LAi_group_MoveCharacter(sld, LAI_GROUP_PLAYER);
	  }
	  sld = characterFromID("Valinie");
	  LAi_SetWarriorType(sld);
	  ChangeCharacterAddressGroup(sld, "Location_reserve_50", "goto", "goto5");
	  LAi_group_MoveCharacter(sld, LAI_GROUP_PLAYER);
	  sld = characterFromID("Jak_Victime");
	  LAi_SetWarriorType(sld);
	  ChangeCharacterAddressGroup(sld, "Location_reserve_50", "goto", "goto3");
	  LAi_group_MoveCharacter(sld, "DungeonEnemyFight1");
	  // Штурмовик 1
	  sld = GetCharacter(NPC_GenerateCharacter("Shturm_First", "Citiz_58", "man", "man", 5, PIRATE, -1, true, "quest"));
	  sld.name = "Штурмовик";
	  sld.lastname = "Первый";
	  sld.dialog.filename = "NewPapka\BG1.c";
	  TakeNItems(sld, "potion2", 3);
	  ...
	  LAi_group_MoveCharacter(sld, "DungeonEnemyFight1");
	  // Штурмовик 2
	  sld = GetCharacter(NPC_GenerateCharacter("Shturm_Second", "Citiz_58", "man", "man", 5, PIRATE, -1, true, "quest"));
	  sld.name = "Штурмовик";
	  sld.lastname = "Второй";
	  sld.dialog.filename = "NewPapka\BG2.c";
	  TakeNItems(sld, "potion2", 3);
	  ...
	  LAi_group_MoveCharacter(sld, "DungeonEnemyFight1");
	  // Штурмовик 3
	  sld = GetCharacter(NPC_GenerateCharacter("Shturm_Third", "Citiz_58", "man", "man", 5, PIRATE, -1, true, "quest"));
	  sld.name = "Штурмовик";
	  sld.lastname = "Третий";
	  sld.dialog.filename = "NewPapka\BG3.c";
	  TakeNItems(sld, "potion2", 3);
	  ...
	  LAi_group_MoveCharacter(sld, "DungeonEnemyFight1");
	  // Штурмовик 4
	  sld = GetCharacter(NPC_GenerateCharacter("Shturm_Thourth", "Citiz_58", "man", "man", 5, PIRATE, -1, true, "quest"));
	  sld.name = "Штурмовик";
	  sld.lastname = "Четвёртый";
	  sld.dialog.filename = "NewPapka\BG4.c";
	  TakeNItems(sld, "potion2", 3);
	  ...
	  LAi_group_MoveCharacter(sld, "DungeonEnemyFight1");
	  // Штурмовик 5
	  sld = GetCharacter(NPC_GenerateCharacter("Shturm_Fifth", "Citiz_58", "man", "man", 5, PIRATE, -1, true, "quest"));
	  sld.name = "Штурмовик";
	  sld.lastname = "Пятый";
	  sld.dialog.filename = "NewPapka\BG5.c";
	  TakeNItems(sld, "potion2", 3);
	  ...
	  for (i=1; i<+6; i++)
	  {
		sld = GetCharacter(NPC_GenerateCharacter("ShturmDungeon_"+i, "Citiz_58", "man", "man",5, PIRATE, -1, true, "quest"));
		TakeNItems(sld, "potion2", 3);
		LAi_SetWarriorType(sld);
	    ChangeCharacterAddressGroup(sld, "Location_reserve_50", "goto", "goto4");
	    LAi_group_MoveCharacter(sld, "DungeonEnemyFight1");
	  }
	  LAi_group_SetRelation("DungeonEnemyFight1", LAI_GROUP_PLAYER, LAI_GROUP_ENEMY);
	  LAi_group_FightGroups("DungeonEnemyFight1", LAI_GROUP_PLAYER, true);
	  LAi_SetFightMode(pchar, true);
	  LAi_group_SetCheck("DungeonEnemyFight1", "DeMor_51");
	  break;


	  case "DeMor_51":
	  DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_51");
	  AddComplexSelfExpToScill(50, 50, 50, 50);
	  AddCharacterExpToSkill(pchar, GetEquipedBladeType(pchar), 50);
	   sld = characterFromID("Valinie");
	   Lai_SetActorType(sld);
	   LAi_ActorFollow(sld, characterFromId("BLAZE"), "DeMor_52", 1);
	   break;

	   case "DeMor_52":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_52");
	   sld = characterFromID("Valinie");
	   sld.dialog.currentnode = "dialogAfterDungeon";
	   Lai_SetActorType(sld);
	   LAi_ActorDialog(sld, pchar, "", -1, 0);
	   sld = GetCharacter(NPC_GenerateCharacter("Vestovoy", "sold_fra_1", "man", "man", 3, PIRATE, -1, true, "quest"));
	   sld.name = "Себастьян";
	  sld.lastname = "Шароль";
	  sld.dialog.filename = "NewPapka\Vestovoy.c";
	  ChangeCharacterAddressGroup(sld, "Location_reserve_50", "goto", "goto4");
	  Lai_SetActorType(sld);
	  LAi_ActorFollow(sld, characterFromId("BLAZE"), "", 1);
	  break;
	  ...
	  case "DeMor_53":
	  DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_53");
	  sld = characterFromID("Vestovoy");
	  sld.dialog.currentnode = "Dungeondialog1";
	  ...
	  case "DeMor_54":
	  DeleteAttribute(pchar,"PostEventQuest.questDelay.DeMor_54");
	   sld = characterFromID("Valinie");
	   RemoveItems(sld, "pistol5", 1);
	   sld.dialog.currentnode = "dialogAfterDungeon_3";
	   Lai_SetActorType(sld);
	   LAi_ActorDialog(sld, pchar, "", -1, 0);
	   break;
...
////////////////////////////////////////////Девица из борделя////////////////////////////////////////////////////
	  ...
	  case "BordelGirl_1":
      DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_1");
	  WaitDate("", 0, 0, 0, 23, 0);    // Кручу до 12 дня
	  SetCurrentTime(12, 00);
	  RecalculateJumpTable();
	  SetLaunchFrameFormParam("На следующий день", "", 0, 6);
	  LaunchFrameForm();
	  DoQuestCheckDelay("BordelGirl_2", 5.0);
	  break;


	  case "BordelGirl_2":
      DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_2");
	  DoQuestReloadToLocation("FortFrance_Town", "goto", "goto21", "BordelGirl_3");
	  AddCharacterHealth(pchar, 36);
	  break;


	  case "BordelGirl_3":
      DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_3");
	  Lai_SetActorType(pchar);
	  LAi_ActorFollow(pchar, characterFromId("GigoloMan"), "BordelGirl_4", -1);
	  break;


	  case "BordelGirl_4":
      DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_4");
	  Lai_SetPlayerType(pchar);
	  ...
	  case "BordelGirl_5":
      DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_5");
	  AddQuestRecord("Sharlie", "5-5");
	  Lai_SetActorType(pchar);
	  Lai_ActorRunToLocation(pchar, "reload", "reload91", "none", "", "", "BordelGirl_6", -1);
	  break;

	  case "BordelGirl_6":
      DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_6");
	  Lai_SetPlayerType(pchar);
	  DoReloadCharacterToLocation("fortFrance_SecBrRoom", "goto", "goto4");
	  break;


	  case "BordelGirl_7":
      DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_7");
	  WaitDate("", 0, 0, 0, 0, 0);    // 
	  SetCurrentTime(23, 00);         //устанавливаем время на 11 вечера
	  RecalculateJumpTable();
	  SetLaunchFrameFormParam("Вечером в борделе", "", 0, 6);
	  LaunchFrameForm();
	  DoQuestCheckDelay("BordelGirl_8", 5.0);
	  break;


	  case "BordelGirl_8":
      DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_8");
	  Lai_SetPlayerType(pchar);
	  DoReloadCharacterToLocation("fortFrance_Brothel", "goto", "goto1");
	  break;


	  case "BordelGirl_9":
      DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_9");
	  Lai_SetActorType(pchar);
	  Lai_ActorRunToLocation(pchar, "reload", "houseSp1", "none", "", "", "BordelGirl_10", -1);
	  break;


	  case "BordelGirl_10":
      DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_10");
	  Lai_SetPlayerType(pchar);
	  DoQuestReloadToLocation("CommonResidence_BackHall", "goto", "goto1", "BordelGirl_11");
	  ...
	  LAi_SetImmortal(sld, true);
	  LAi_group_MoveCharacter(sld, "FRANCE_CITIZENS");
	  ChangeCharacterAddressGroup(sld, "CommonResidence_BackHall", "goto", "goto1");
	  break;


	  case "BordelGirl_11":
      DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_11");
	  sld = characterFromId("GigoloGirl");
	  sld.dialog.currentnode = "GigoloGirl_6";
	  LAi_SetActorType(sld);
	  LAi_ActorDialog(sld, pchar, "", -1, 0);
	  break;
	  ...
	  case "BordelGirl_12":
      DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_12");
	  AddCharacterExpToSkill(Pchar, "Sneak", 100);
	  AddCharacterExpToSkill(Pchar, "Leadership", 100);
	  Lai_SetActorType(pchar);
	  Lai_ActorRunToLocation(pchar, "reload", "reload2", "none", "", "", "BordelGirl_13", -1);
	  break;


	  case "BordelGirl_13":
      DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_13");
	  Lai_SetPlayerType(pchar);
	  DoQuestReloadToLocation("CommonBedroom", "reload", "reload1", "BordelGirl_14");
	  ...
	  for (i=1; i<+5; i++)
	  {
		sld = GetCharacter(NPC_GenerateCharacter("VengaenMen_"+i, "Citiz_58", "man", "man", 2, PIRATE, -1, true, "quest"));
		TakeNItems(sld, "potion1", 4);
		LAi_SetWarriorType(sld);
	  ...
	  case "BordelGirl_14":
      DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_14");
	  sld = characterFromId("GigoloMan");
	  sld.dialog.currentnode = "GigoloMan_6";
	  LAi_SetActorType(sld);
	  LAi_ActorDialog(sld, pchar, "", -1, 0);
	  break;
	  ...
	  case "BordelGirl_15":
      DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_15");
	  sld = characterFromId("Valinie");
	  sld.dialog.currentnode = "SharlieBordelGirl_1";
	  LAi_SetActorType(sld);
	  LAi_ActorDialog(sld, pchar, "", -1, 0);
	  break;
	  ...
	  case "BordelGirl_16":
      DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_16");
	  DoQuestReloadToLocation("CommonResidence_BackHall", "reload", "reload2", "BordelGirl_17");
	  //бандиты
	  for (i=1; i<+5; i++)
	  {
		sld = GetCharacter(NPC_GenerateCharacter("VtngeanPirates"+i, "pirate_"+i, "man", "man", 2, PIRATE, -1, true, "quest"));
		TakeNItems(sld, "potion1", 4);
		ChangeCharacterAddressGroup(sld, "CommonResidence_BackHall", "goto", "goto2");
		Lai_SetActorType(sld);
        LAi_ActorTurnToCharacter(sld, characterFromID("BLAZE"));
	    
	  }
	  //главарь бандитов
	  sld = GetCharacter(NPC_GenerateCharacter("VtngeanPirate", "pirate_8", "man", "man", 2, PIRATE, -1, true, "quest"));
	  TakeNItems(sld, "potion1", 4);
	  sld.Dialog.Filename = "Quest\Sharlie\StartMiniQuests.c";
	  ChangeCharacterAddressGroup(sld, "CommonResidence_BackHall", "goto", "goto2");
	  Lai_SetActorType(sld);
	  ...
	  case "BordelGirl_17":
	  DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_17");
	 
	  Lai_SetActorType(pchar);
	  LAi_ActorFollow(pchar, characterFromId("GigoloGirl"), "BordelGirl_18", -1);
	  break;


	  case "BordelGirl_18":
      DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_18");
	  Lai_SetPlayerType(pchar);
	  for (i=1; i<+5; i++)
	  {
		sld = characterFromId("VtngeanPirates"+i);
		Lai_SetActorType(sld);
        LAi_ActorTurnToCharacter(sld, characterFromID("BLAZE"));
	    
	  }
	  sld = characterFromId("GigoloGirl");
	  sld.dialog.currentnode = "GigoloGirl_8";
	  LAi_SetActorType(sld);
	  LAi_ActorDialog(sld, pchar, "", -1, 0);
	  break;
	  ...
	  case "BordelGirl_19":
      DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_19");
	  sld = characterFromId("VtngeanPirate");
	  sld.dialog.currentnode = "VtngeanPirate_1";
	  LAi_SetActorType(sld);
	  LAi_ActorDialog(sld, pchar, "", -1, 0);
	  break;
	  ...
	  case "BordelGirl_20":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_20");
	   // Валинье спускается
	   sld = characterFromId("Valinie");
	   ChangeCharacterAddressGroup(sld, "CommonResidence_BackHall", "goto", "goto6");
	   Lai_SetActorType(sld);
	   LAi_ActorFollow(sld, characterFromId("VtngeanPirate"), "BordelGirl_21", -1);
	   // слуги Венгаена
	   for (i=1; i<+5; i++)
	  {
		sld = GetCharacter(NPC_GenerateCharacter("VengaenMen_"+i, "Citiz_58", "man", "man", 2, PIRATE, -1, true, "quest"));
		Lai_SetActorType(sld);
	    ChangeCharacterAddressGroup(sld, "CommonResidence_BackHall", "reload", "reload2");
		LAi_ActorFollow(sld, characterFromId("Valinie"), "", -1);
	  ...
	  case "BordelGirl_21":
      DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_21");
	  sld = characterFromId("Valinie");
	  sld.dialog.currentnode = "BanditBordelGirl_1";
	  LAi_SetActorType(sld);
	  LAi_ActorDialog(sld, pchar, "", -1, 0);
	  break;
	  ...
	  case "BordelGirl_22":
      DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_22");
	  sld = characterFromId("GigoloMan");
	  sld.dialog.currentnode = "GigoloMan_8";
	  LAi_SetActorType(sld);
	  LAi_ActorDialog(sld, pchar, "", -1, 0);
	  break;

	  case "BordelGirl_23":
      DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_23");
	  sld = characterFromID("GigoloGirl");
	  Lai_SetActorType(sld);
	  LAi_ActorRunToLocator(sld, "goto", "goto7", "BordelGirl_24", -1);
	  // гвардейцы кардинала
	   for (i=1; i<+7; i++)
	  {
		sld = GetCharacter(NPC_GenerateCharacter("GuardMen_"+i, "paladin_"+i, "man", "man2", 2, PIRATE, -1, true, "quest"));
		TakeNItems(sld, "potion1", 4);
		LAi_group_MoveCharacter(sld, LAI_GROUP_PLAYER); //относим в группу героя
	    ChangeCharacterAddressGroup(sld, "CommonResidence_BackHall", "reload", "Reload1");
	  ...
	  sld = characterFromId("GigoloMan");
	  TakeNItems(sld, "potion1", 10);
	  LAi_group_MoveCharacter(sld, "GigoloFight1");
	  //бандиты
	  for (i=1; i<+5; i++)
	  {
		sld = characterFromId("VtngeanPirates"+i);
	  ...
	  for (i=1; i<+5; i++)
	  {
		sld = characterFromId("VengaenMen_"+i);
		LAi_group_MoveCharacter(sld, "GigoloFight1");
	    
	  }
	  sld = characterFromId("VtngeanPirate");
	  LAi_group_MoveCharacter(sld, "GigoloFight1");
	  LAi_group_SetRelation("GigoloFight1", LAI_GROUP_PLAYER, LAI_GROUP_ENEMY);
	  LAi_group_FightGroups("GigoloFight1", LAI_GROUP_PLAYER, true);
	  LAi_SetFightMode(pchar, true);
	  LAi_group_SetCheck("GigoloFight1", "BordelGirl_24a");
	  break;


	  case "BordelGirl_24":
	  DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_24");
	  sld = characterFromID("GigoloGirl");
	  Lai_SetStunnedTypeNoGroup(sld);
	  break;
	  ...
	  case "BordelGirl_24a":
	  DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_24a");
	  sld = characterFromID("GigoloGirl");
	  LAi_SetActorType(sld);
	  LAi_ActorFollow(sld, characterFromId("Valinie"), "BordelGirl_25", -1);
	  break;


	  case "BordelGirl_25":
	  DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_25");
	  sld = characterFromID("GigoloGirl");
	  sld.dialog.currentnode = "GigoloGirl_10";
	  LAi_SetActorType(sld);
	  LAi_ActorDialog(sld, pchar, "", -1, 0);
	  break;
	  ...
	  case "BordelGirl_26":
	  DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_26");
	  sld = characterFromID("Valinie");
	  sld.dialog.currentnode = "BanditBordelGirl_2";
	  LAi_SetActorType(sld);
	  LAi_ActorDialog(sld, pchar, "", -1, 0);
	  break;
	  ...
	  case "BordelGirl_27":
	  DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_27");
	  sld = characterFromID("GigoloGirl");
	  sld.dialog.currentnode = "GigoloGirl_12";
	  LAi_SetActorType(sld);
	  LAi_ActorDialog(sld, pchar, "", -1, 0);
	  break;
	  ...
	  case "BordelGirl_28":
	  DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_28");
	  DoQuestCheckDelay("BordelGirl_28a", 3.0);
	  break;


	  case "BordelGirl_28a":
	  DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_28a");
	  // лейтенант
	   sld = GetCharacter(NPC_GenerateCharacter("LeitenSenPier", "off_fra_1", "man", "man", 3, PIRATE, -1, true, "quest"));
	   TakeNItems(sld, "potion2", 2);
	   ChangeCharacterAddressGroup(sld, "CommonResidence_BackHall", "reload", "Reload1");
	   sld.Dialog.Filename = "Quest\Sharlie\StartMiniQuests.c";
	   sld.dialog.currentnode = "LeitenantRes_1";
	   Lai_SetActorType(sld);
	   LAi_ActorDialog(sld, pchar, "", -1, 0);
	   // солдаты с лейтенантом
	   for (i=1; i<+3; i++)
	  {
		sld = GetCharacter(NPC_GenerateCharacter("LeitenSenPierMen_"+i, "sold_fra_"+i, "man", "man", 2, PIRATE, -1, true, "quest"));
		TakeNItems(sld, "potion2", 1);
		LAi_group_MoveCharacter(sld, "GigoloFight2");
		
	    ChangeCharacterAddressGroup(sld, "CommonResidence_BackHall", "reload", "Reload1");
	   
	  }
	  // солдаты с лейтенантом вторая группа
	   for (i=1; i<+3; i++)
	  {
		sld = GetCharacter(NPC_GenerateCharacter("LeitenSenPierMen_"+(2+i), "sold_fra_"+(2+i), "man", "man", 2, PIRATE, -1, true, "quest"));
		TakeNItems(sld, "potion2", 1);
		LAi_group_MoveCharacter(sld, "GigoloFight2");
		
	    ChangeCharacterAddressGroup(sld, "CommonResidence_BackHall", "goto", "goto4");
	   
	  }
	  // солдаты с лейтенантом  третья группа
	   for (i=1; i<+3; i++)
	  {
		sld = GetCharacter(NPC_GenerateCharacter("LeitenSenPierMen_"+(4+i), "sold_fra_"+(4+i), "man", "man", 2, PIRATE, -1, true, "quest"));
		TakeNItems(sld, "potion2", 1);
		LAi_group_MoveCharacter(sld, "GigoloFight2");
	  ...
	  // солдаты с лейтенантом  четвёртая группа
	   for (i=1; i<+3; i++)
	  {
		sld = GetCharacter(NPC_GenerateCharacter("LeitenSenPierMen_"+(6+i), "sold_fra_"+(6+i), "man", "man", 2, PIRATE, -1, true, "quest"));
		TakeNItems(sld, "potion2", 1);
		LAi_group_MoveCharacter(sld, "GigoloFight2");
		
	    ChangeCharacterAddressGroup(sld, "CommonResidence_BackHall", "goto", "goto7");
	   
	  }
	   break;

	   case "BordelGirl_29":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_29");
	   sld = characterFromID("Valinie");
	   sld.dialog.currentnode = "LeitenantBordelGirl_1";
	   LAi_SetActorType(sld);
	   LAi_ActorDialog(sld, pchar, "", -1, 0);
	   break;
	   ...
	   case "BordelGirl_30":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_30");
	   sld = characterFromID("LeitenSenPier");
	   sld.dialog.currentnode = "LeitenantRes_3";
	   LAi_SetActorType(sld);
	   LAi_ActorDialog(sld, pchar, "", -1, 0);
	   break;

	   case "BordelGirl_31":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_31");
	   sld = characterFromID("GigoloGirl");
	   Lai_SetActorType(sld);
	   LAi_ActorRunToLocator(sld, "goto", "goto7", "BordelGirl_24", -1);
	   sld = characterFromID("LeitenSenPier");
	   ...
	   sld = characterFromID("Valinie");
	   LAi_group_MoveCharacter(sld, LAI_GROUP_PLAYER); //относим в группу героя
	   LAi_group_SetRelation("GigoloFight2", LAI_GROUP_PLAYER, LAI_GROUP_ENEMY);
	   LAi_group_FightGroups("GigoloFight2", LAI_GROUP_PLAYER, true);
	   LAi_SetFightMode(pchar, true);
	   LAi_group_SetCheck("GigoloFight2", "BordelGirl_32");
	   break;


	   case "BordelGirl_32":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_32");
	   AddComplexSelfExpToScill(50, 50, 50, 50);
	   AddCharacterExpToSkill(pchar, GetEquipedBladeType(pchar), 50);
	   DoQuestCheckDelay("BordelGirl_32a", 3.0);
	   break;


	   case "BordelGirl_32a":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_32a");
	   // губернатор
	   sld = GetCharacter(NPC_GenerateCharacter("DuParke", "huber_4", "man", "man", 3, PIRATE, -1, true, "quest"));
	   sld.name 	= "Жак Дил";
       sld.lastname = "ду Парке";
	   ChangeCharacterAddressGroup(sld, "CommonResidence_BackHall", "reload", "Reload1");
	   sld.Dialog.Filename = "Quest\Sharlie\StartMiniQuests.c";
	   sld.dialog.currentnode = "DuParke_1";
	   Lai_SetActorType(sld);
	   LAi_ActorDialog(sld, pchar, "", -1, 0);
	   // солдаты с губернатором
	   for (i=1; i<+5; i++)
	  {
		sld = GetCharacter(NPC_GenerateCharacter("DuParkeSenPierMen_"+i, "sold_fra_"+i, "man", "man", 2, PIRATE, -1, true, "quest"));
	    ChangeCharacterAddressGroup(sld, "CommonResidence_BackHall", "reload", "Reload1");
	    Lai_SetActorType(sld);
		LAi_ActorRunToLocator(sld, "goto", "goto1", "BordelGirl_32b", -1);
	  ...
	  case "BordelGirl_32b":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_32b");
	   for (i=1; i<+5; i++)
	  {
		sld = characterFromID("DuParkeSenPierMen_"+i);
		LAi_SetActorType(sld);
	  ...
	  case "BordelGirl_33":
	  DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_33");
	  sld = characterFromID("Valinie");
	  sld.dialog.currentnode = "DuParkeBordelGirl_1";
	  LAi_SetActorType(sld);
	  LAi_ActorDialog(sld, pchar, "", -1, 0);
	  break;
	   ...
	   case "BordelGirl_34":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_34");
	   sld = characterFromID("DuParke");
	   sld.dialog.currentnode = "DuParke_3";
	   LAi_SetActorType(sld);
	   LAi_ActorDialog(sld, pchar, "", -1, 0);
	   break;
	   ...
	   case "BordelGirl_35":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_35");
	   sld = characterFromID("Valinie");
	   LAi_SetActorType(sld);
	   Lai_ActorRunToLocation(sld, "reload", "reload1", "none", "", "", "", -1);
	   sld = characterFromID("DuParke");
	   LAi_SetActorType(sld);
	   LAi_ActorRunToLocator(sld, "goto", "goto3", "", -1);
	   for (i=1; i<+5; i++)
	  {
		sld = characterFromID("DuParkeSenPierMen_"+i);
		LAi_SetActorType(sld);
	   ...
	   Lai_ActorRunToLocation(pchar, "reload", "reload1", "none", "", "", "", -1);
	   sld = characterFromID("GigoloGirl");
	   LAi_SetActorType(sld);
	   Lai_ActorRunToLocation(sld, "reload", "reload1", "none", "", "", "", -1);
	   for (i=1; i<+7; i++)
	  {
		sld = characterFromID("GuardMen_"+i);
		TakeNItems(sld, "potion1", 4);
		LAi_SetActorType(sld);
	    Lai_ActorRunToLocation(sld, "reload", "reload1", "none", "", "", "", -1);
	   
	  }
	   DoQuestCheckDelay("BordelGirl_36", 3.0);
	   break;


	   case "BordelGirl_36":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_36");
	   DoQuestReloadToLocation("FortFrance_Town", "reload", "houseSp1", "BordelGirl_37");
	   AddQuestRecord("Sharlie", "5-7");
	   
	   sld = characterFromID("Valinie");
	   ChangeCharacterAddressGroup(sld, "FortFrance_Town", "reload", "houseSp1");
	   Lai_SetActorType(sld);
	   sld = GetCharacter(NPC_GenerateCharacter("GuardManTown", "paladin_7", "man", "man2", 2, PIRATE, -1, true, "quest"));
	   ChangeCharacterAddressGroup(sld, "FortFrance_Town", "goto", "goto4");
	   sld.Dialog.Filename = "Quest\Sharlie\StartMiniQuests.c";
	   sld.dialog.currentnode = "GuardManTown_1";
	   Lai_SetActorType(sld);
	   LAi_ActorFollow(sld, characterFromId("Valinie"), "BordelGirl_37", -1);
	   sld = characterFromID("GigoloGirl");
	   ChangeCharacterAddressGroup(sld, "FortFrance_Town", "reload", "houseSp1");
	   Lai_SetActorType(sld);
	   for (i=1; i<+7; i++)
	  {
		sld = characterFromID("GuardMen_"+i);
		TakeNItems(sld, "potion1", 4);
		ChangeCharacterAddressGroup(sld, "FortFrance_Town", "reload", "reloadPr1");
	    Lai_SetActorType(sld);
	  }
	   DoQuestCheckDelay("BordelGirl_36a", 1.0);
	   break;


	   case "BordelGirl_36a":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_36a");
	   sld = characterFromID("Valinie");
	   Lai_SetActorType(sld);
	   ...
	   for (i=1; i<+7; i++)
	  {
	   ...
	   case "BordelGirl_37":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_37");
	   ...
	   case "BordelGirl_38":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_38");
	   AddQuestRecord("Sharlie", "5-8");
	   sld = characterFromID("GuardManTown");
	   Lai_SetActorType(sld);
	   Lai_ActorRunToLocation(sld, "reload", "gate_back", "none", "", "", "", -1);
	   sld = characterFromID("Valinie");
	   ...
	   for (i=1; i<+7; i++)
	  {
	    ...
	    Lai_SetActorType(pchar);
	    Lai_ActorRunToLocation(pchar, "reload", "gate_back", "none", "", "", "", -1);
		DoQuestCheckDelay("BordelGirl_39", 6.0);
	   break;


	   case "BordelGirl_39":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_39");
	   DoQuestReloadToLocation("FortFrance_ExitTown", "reload", "reload3", "BordelGirl_39a");
	   Lai_SetPlayerType(pchar);
	   break;

	   case "BordelGirl_39a":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_39a");
	   sld = characterFromID("GigoloGirl");
	   ChangeCharacterAddressGroup(sld, "FortFrance_ExitTown", "officers", "reload3_1");
	   Lai_SetStunnedTypeNoGroup(sld);
	   sld = characterFromID("GuardManTown");
	   ChangeCharacterAddressGroup(sld, "FortFrance_ExitTown", "reload", "reload3");
	   Lai_SetWarriorType(sld);
	   LAi_group_MoveCharacter(sld, LAI_GROUP_PLAYER); //относим в группу героя
	   TakeNItems(sld, "potion1", 4);
	   sld = characterFromID("Valinie");
	   ChangeCharacterAddressGroup(sld, "FortFrance_ExitTown", "reload", "reload3");
	   TakeNItems(sld, "potion1", 24);
	   Lai_SetWarriorType(sld);
	   LAi_group_MoveCharacter(sld, LAI_GROUP_PLAYER); //относим в группу героя
	   for (i=1; i<+7; i++)
	  {
		sld = characterFromID("GuardMen_"+i);
	    ChangeCharacterAddressGroup(sld, "FortFrance_ExitTown", "officers", "reload3_3");
		Lai_SetWarriorType(sld);
		LAi_group_MoveCharacter(sld, LAI_GROUP_PLAYER); //относим в группу героя
	  }
	  //гвардейцы у ворот
	  for (i=1; i<+7; i++)
	  {
		sld = GetCharacter(NPC_GenerateCharacter("GuardMen_1"+i, "paladin_"+i, "man", "man2", 2, PIRATE, -1, true, "quest"));
		TakeNItems(sld, "potion1", 4);
		ChangeCharacterAddressGroup(sld, "FortFrance_ExitTown", "goto", "goto12");
		Lai_SetWarriorType(sld);
		LAi_group_MoveCharacter(sld, LAI_GROUP_PLAYER); //относим в группу героя
	  }
	  //охрана Кабаля первый отряд
	  for (i=1; i<+7; i++)
	  {
		sld = GetCharacter(NPC_GenerateCharacter("KabalGuard_"+i, "Citiz_58", "man", "man", 2, PIRATE, -1, true, "quest"));
		TakeNItems(sld, "potion1", 4);
		ChangeCharacterAddressGroup(sld, "FortFrance_ExitTown", "goto", "goto7");
		Lai_SetWarriorType(sld);
		LAi_group_MoveCharacter(sld, "KabalFight1");
	    
	  }
	  //охрана Кабаля второй отряд
	  for (i=1; i<+7; i++)
	  {
		sld = GetCharacter(NPC_GenerateCharacter("KabalGuard_1"+i, "Citiz_58", "man", "man", 2, PIRATE, -1, true, "quest"));
		TakeNItems(sld, "potion1", 4);
		ChangeCharacterAddressGroup(sld, "FortFrance_ExitTown", "goto", "goto5");
		Lai_SetWarriorType(sld);
		LAi_group_MoveCharacter(sld, "KabalFight1");
	    
	  }
	  //Кабаль
	  sld = GetCharacter(NPC_GenerateCharacter("Kabal", "usurer_4", "man", "man", 2, PIRATE, -1, true, "quest"));
	  
	  sld.Dialog.Filename = "Quest\Sharlie\StartMiniQuests.c";
	  ChangeCharacterAddressGroup(sld, "FortFrance_ExitTown", "goto", "goto20");
	  Lai_SetActorType(sld);
	  Lai_ActorRunToLocation(sld, "reload", "reload1", "none", "", "", "", -1);
	  LAi_group_SetRelation("KabalFight1", LAI_GROUP_PLAYER, LAI_GROUP_ENEMY);
	  LAi_group_FightGroups("KabalFight1", LAI_GROUP_PLAYER, true);
	  LAi_SetFightMode(pchar, true);
	  LAi_group_SetCheck("KabalFight1", "BordelGirl_40");
	  break;


	  case "BordelGirl_40":
	  DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_40");
	  sld = characterFromID("Valinie");
	  Lai_SetActorType(sld);
	  LAi_ActorFollow(sld, characterFromId("BLAZE"), "BordelGirl_41", -1);
	  sld = characterFromID("GigoloGirl");
	  Lai_SetActorType(sld);
	  LAi_ActorFollow(sld, characterFromId("BLAZE"), "", -1);
	  break;
	  ...
	  case "BordelGirl_41":
	  DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_41");
	  sld = characterFromID("Valinie");
	  sld.dialog.currentnode = "SharlieBordelGirl_2";
	  Lai_SetActorType(sld);
	  LAi_ActorDialog(sld, pchar, "", -1, 0);
	  break;
	  ...
	  case "BordelGirl_42":
	  DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_42");
	  AddQuestRecord("Sharlie", "5-9");
	  Lai_SetActorType(pchar);
	  Lai_ActorRunToLocation(pchar, "reload", "reload1", "none", "", "", "BordelGirl_43", -1);
	  sld = characterFromID("Valinie");
	  Lai_SetActorType(sld);
	  LAi_ActorFollow(sld, characterFromId("BLAZE"), "", -1);
	  sld = characterFromID("GigoloGirl");
	  ...
	  for (i=1; i<+7; i++)
	  {
		sld = characterFromID("GuardMen_1"+i);
	    Lai_SetActorType(sld);
	    LAi_ActorFollow(sld, characterFromId("BLAZE"), "", -1);
	  }
	  break;
	  ...
	  case "BordelGirl_43":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_43");
	   DoReloadCharacterToLocation("Martinique_jungle_01", "goto", "goto4");
	   Lai_SetPlayerType(pchar);
	   sld = characterFromID("Valinie");
	  ...
	  {
		sld = characterFromID("GuardMen_"+i);
		ChangeCharacterAddressGroup(sld, "Martinique_jungle_01", "officers", "reload2_2");
	    Lai_SetActorType(sld);
	    LAi_ActorFollow(sld, characterFromId("Valinie"), "", -1);
	  }
	   for (i=1; i<+7; i++)
	  {
		sld = characterFromID("GuardMen_1"+i);
		ChangeCharacterAddressGroup(sld, "Martinique_jungle_01", "officers", "reload2_3");
	    Lai_SetActorType(sld);
	    LAi_ActorFollow(sld, characterFromId("Valinie"), "", -1);
	  }
	   break;
	   ...
	   case "BordelGirl_44":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_44");
	   AddCharacterExpToSkill(pchar, "Fortune", 100);
	   sld = characterFromID("RD_Prosper");
	   Lai_SetActorType(sld);
	   LAi_ActorDialog(sld, pchar, "", -1, 0);
	   ...
	   case "BordelGirl_45":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_45");
	   sld = characterFromID("Valinie");
	   sld.dialog.currentnode = "ProsperBordelGirl_1";
	   Lai_SetActorType(sld);
	   LAi_ActorDialog(sld, pchar, "", -1, 0);
	   break;
	   ...
	   case "BordelGirl_46":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_46");
	   sld = characterFromID("RD_Prosper");
       ...
       case "BordelGirl_47":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_47");
	   Lai_SetActorType(pchar);
	   LAi_ActorRunToLocator(pchar, "goto", "goto5", "BordelGirl_48", -1);
	   sld = characterFromID("Valinie");
	   Lai_SetActorType(sld);
	   LAi_ActorFollow(sld, characterFromId("BLAZE"), "", -1);
	   break;
	   ...
	   case "BordelGirl_48":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_48");
	   Lai_SetPlayerType(pchar);
	   sld = characterFromID("Valinie");
	   sld.dialog.currentnode = "SharlieJungle_1";
	   Lai_SetActorType(sld);
	   LAi_ActorDialog(sld, pchar, "", -1, 0);
	   break;
	   ...
	   case "BordelGirl_49":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_49");
	   sld = characterFromID("RD_Prosper");
	   ...
	   case "BordelGirl_50":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_50");
	   AddQuestRecord("Sharlie", "5-11");
	   sld = characterFromID("RD_Prosper");
	   Lai_SetActorType(sld);
	   LAi_ActorRunToLocator(sld, "reload", "reload3_back", "", -1);
	   sld = characterFromID("Valinie");
	   Lai_SetActorType(sld);
	   LAi_ActorRunToLocator(sld, "reload", "reload3_back", "", -1);
	   Lai_SetActorType(pchar);
	   LAi_ActorRunToLocator(pchar, "reload", "reload3_back", "", -1);
	   DoQuestCheckDelay("BordelGirl_51", 6.0);
	   break;


	   case "BordelGirl_51":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_51");
	   SetLaunchFrameFormParam("через несколько минут у пещеры", "", 5, 8);
	   LaunchFrameForm();
	   WaitDate("", 0, 0, 0, 0, 30); // Крутану несколько минут
       RecalculateJumpTable();
	   DoQuestCheckDelay("BordelGirl_51a", 3.0);
	   break;


	   case "BordelGirl_51a":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_51a");
	   DoQuestReloadToLocation("Martinique_caveEntrance", "monsters", "monster1", "BordelGirl_52");
	   Lai_SetPlayerType(pchar);
	   break;


	   case "BordelGirl_52":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_52");
	   iRank = MOD_SKILL_ENEMY_RATE;
	   sld = characterFromID("GuardManTown");
	   ChangeCharacterAddressGroup(sld, "Martinique_caveEntrance", "officers", "reload2_2");
	   Lai_SetWarriorType(sld);
	   LAi_group_MoveCharacter(sld, LAI_GROUP_PLAYER); //относим в группу героя
	   TakeNItems(sld, "potion1", 4);
	   sld = characterFromID("Valinie");
	   ChangeCharacterAddressGroup(sld, "Martinique_caveEntrance", "monsters", "monster2");
	   TakeNItems(sld, "potion1", 24);
	   Lai_SetWarriorType(sld);
	   LAi_group_MoveCharacter(sld, LAI_GROUP_PLAYER); //относим в группу героя
	   sld = characterFromID("RD_Prosper");
	   ChangeCharacterAddressGroup(sld, "Martinique_caveEntrance", "monsters", "monster1");
	   LAi_SetImmortal(sld, true);
	   Lai_SetWarriorType(sld);
	   LAi_group_MoveCharacter(sld, LAI_GROUP_PLAYER); //относим в группу героя
	   TakeNItems(sld, "potion1", 4);
	  ...
	  {
		sld = characterFromID("GuardMen_"+i);
	    ChangeCharacterAddressGroup(sld, "Martinique_caveEntrance", "monsters", "monster3");
		Lai_SetWarriorType(sld);
		LAi_group_MoveCharacter(sld, LAI_GROUP_PLAYER); //относим в группу героя
	  }
	  //гвардейцы у ворот
	...
	for (i=1; i<=6; i++)
	{
		...
		DeleteAttribute(sld, "SaveItemsForDead");
		DeleteAttribute(sld, "DontClearDead");
		ChangeCharacterAddressGroup(sld, "Martinique_CaveEntrance", "officers", "reload1_2");
		LAi_SetWarriorType(sld);
		LAi_group_MoveCharacter(sld, "CanibEnemyFight");
	}
	  //вторая группа канибалов
	for (i=1; i<=6; i++)
	{
		sld = GetCharacter(NPC_GenerateCharacter("RD_Ind_1"+i, "canib_"+i, "man", "man", iRank, PIRATE, 0, true, "soldier"));
		SetFantomParamFromRank(sld, iRank, true);
		GiveItem2Character(sld, "slave_02");
		EquipCharacterbyItem(sld, "slave_02");
		RemoveCharacterEquip(sld, GUN_ITEM_TYPE);
		DeleteAttribute(sld, "SaveItemsForDead");
		DeleteAttribute(sld, "DontClearDead");
		ChangeCharacterAddressGroup(sld, "Martinique_CaveEntrance", "reload", "reload1_back");
		LAi_SetWarriorType(sld);
		LAi_group_MoveCharacter(sld, "CanibEnemyFight");
	}
	//третья группа канибалов
	for (i=1; i<=6; i++)
	{
		sld = GetCharacter(NPC_GenerateCharacter("RD_Ind_2"+i, "canib_"+i, "man", "man", iRank, PIRATE, 0, true, "soldier"));
		SetFantomParamFromRank(sld, iRank, true);
		GiveItem2Character(sld, "slave_02");
		EquipCharacterbyItem(sld, "slave_02");
		RemoveCharacterEquip(sld, GUN_ITEM_TYPE);
	...
	LAi_group_SetRelation("CanibEnemyFight", LAI_GROUP_PLAYER, LAI_GROUP_ENEMY);
	LAi_group_FightGroups("CanibEnemyFight", LAI_GROUP_PLAYER, true);
	LAi_group_SetCheck("CanibEnemyFight", "BordelGirl_53");
	LAi_SetFightMode(pchar, true);
	break;

	case "BordelGirl_53":
	DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_53");
	sld = characterFromID("RD_Prosper");
	Lai_SetActorType(sld);
	LAi_ActorFollow(sld, characterFromId("BLAZE"), "BordelGirl_54", -1);
	sld = characterFromID("Valinie");
	Lai_SetActorType(sld);
	LAi_ActorFollow(sld, characterFromId("BLAZE"), "", -1);
	break;
	...
	case "BordelGirl_54":
	DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_54");
	sld = characterFromID("RD_Prosper");
	sld.dialog.currentnode = "Prosper_8";
	Lai_SetActorType(sld);
	LAi_ActorDialog(sld, pchar, "", -1, 0);
	break;
	...
	case "BordelGirl_54a":
	DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_54a");
	sld = characterFromID("Valinie");
	sld.dialog.currentnode = "SharlieJungle_4";
	Lai_SetActorType(sld);
	LAi_ActorDialog(sld, pchar, "", -1, 0);
	break;
	...
	case "BordelGirl_55":
	DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_55");
	AddQuestRecord("Sharlie", "5-12");
	sld = characterFromID("RD_Prosper");
	Lai_SetActorType(sld);
	LAi_ActorRunToLocator(sld, "reload", "reload1_back", "", -1);
	Lai_SetActorType(pchar);
	LAi_ActorRunToLocator(pchar, "reload", "reload1_back", "", -1);
	DoQuestCheckDelay("BordelGirl_56", 1.0);
	break;


	case "BordelGirl_56":
	DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_56");
	chrDisableReloadToLocation = true;//закрыть локацию
	DoQuestReloadToLocation("Martinique_Grot", "reload", "reload1_back", "BordelGirl_57");
	Lai_SetPlayerType(pchar);
	break;


	case "BordelGirl_57":
	DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_57");
	iRank = MOD_SKILL_ENEMY_RATE;
	sld = characterFromId("RD_Prosper");
	LAi_SetWarriorType(sld);
	//sld.MusketerDistance = 0;
	...
	for (i=1; i<=2; i++)
	{
		sld = GetCharacter(NPC_GenerateCharacter("RD_IndGrot_1"+i, "canib_"+i, "man", "man", iRank, PIRATE, -1, true, "soldier"));
		SetFantomParamFromRank(sld, iRank, true);
		GiveItem2Character(sld, "slave_02");
		EquipCharacterbyItem(sld, "slave_02");
		RemoveCharacterEquip(sld, GUN_ITEM_TYPE);
		//DeleteAttribute(sld, "SaveItemsForDead");
		//DeleteAttribute(sld, "DontClearDead");
		ChangeCharacterAddressGroup(sld, "Martinique_Grot", "goto", "goto1");
		LAi_SetWarriorType(sld);
		LAi_group_MoveCharacter(sld, "CanibEnemyFight1");
	}
	//индеи второй отряд
	for (i=1; i<=2; i++)
	{
		sld = GetCharacter(NPC_GenerateCharacter("RD_IndGrot_2"+i, "canib_"+i, "man", "man", iRank, PIRATE, -1, true, "soldier"));
		SetFantomParamFromRank(sld, iRank, true);
		GiveItem2Character(sld, "slave_02");
		EquipCharacterbyItem(sld, "slave_02");
		RemoveCharacterEquip(sld, GUN_ITEM_TYPE);
		//DeleteAttribute(sld, "SaveItemsForDead");
		//DeleteAttribute(sld, "DontClearDead");
		ChangeCharacterAddressGroup(sld, "Martinique_Grot", "goto", "ass3");
		LAi_SetWarriorType(sld);
		LAi_group_MoveCharacter(sld, "CanibEnemyFight1");
	}
	//индеи третий отряд
	for (i=1; i<=2; i++)
	{
		sld = GetCharacter(NPC_GenerateCharacter("RD_IndGrot_3"+i, "canib_"+i, "man", "man", iRank, PIRATE, -1, true, "soldier"));
		SetFantomParamFromRank(sld, iRank, true);
		GiveItem2Character(sld, "slave_02");
		EquipCharacterbyItem(sld, "slave_02");
		RemoveCharacterEquip(sld, GUN_ITEM_TYPE);
		//DeleteAttribute(sld, "SaveItemsForDead");
		//DeleteAttribute(sld, "DontClearDead");
		ChangeCharacterAddressGroup(sld, "Martinique_Grot", "goto", "ass1");
		LAi_SetWarriorType(sld);
		LAi_group_MoveCharacter(sld, "CanibEnemyFight1");
	}
	LAi_group_SetRelation("CanibEnemyFight1", LAI_GROUP_PLAYER, LAI_GROUP_ENEMY);
	LAi_group_FightGroups("CanibEnemyFight1", LAI_GROUP_PLAYER, true);
	LAi_group_SetCheck("CanibEnemyFight1", "BordelGirl_58");
	LAi_SetFightMode(pchar, true);
	break;


	case "BordelGirl_58":
	DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_58");
	AddComplexSelfExpToScill(50, 50, 50, 50);
	AddCharacterExpToSkill(pchar, GetEquipedBladeType(pchar), 50);
	sld = characterFromID("RD_Prosper");
	Lai_SetActorType(sld);
	LAi_ActorFollow(sld, characterFromId("RD_Selina"), "", -1);
	sld = characterFromID("RD_Selina");
	Lai_SetActorType(sld);
	LAi_ActorFollow(sld, characterFromId("BLAZE"), "BordelGirl_59", -1);
	break;


	case "BordelGirl_59":
	DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_59");
	sld = characterFromID("RD_Selina");
	sld.dialog.currentnode = "Selina";
	Lai_SetActorType(sld);
	LAi_ActorDialog(sld, pchar, "", -1, 0);
	...
	case "BordelGirl_60":
	DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_60");
	sld = characterFromID("RD_Prosper");
	sld.dialog.currentnode = "Prosper_9";
	Lai_SetActorType(sld);
	LAi_ActorDialog(sld, pchar, "", -1, 0);
	break;
	...
	case "BordelGirl_61":
	DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_61");
	sld = characterFromID("RD_Prosper");
	...
	case "BordelGirl_62":
	DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_62");
	AddQuestRecord("Sharlie", "5-13");
	AddCharacterExpToSkill(Pchar, "Leadership", 100);
	sld = characterFromID("RD_Prosper");
	Lai_SetActorType(sld);
	LAi_ActorRunToLocator(sld, "reload", "reload1_back", "", -1);
	...
	Lai_SetActorType(pchar);
	LAi_ActorRunToLocator(pchar, "reload", "reload1_back", "", -1);
	DoQuestCheckDelay("BordelGirl_63", 1.0);
	break;


	case "BordelGirl_63":
	DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_63");
	chrDisableReloadToLocation = true;//закрыть локацию
	DoQuestReloadToLocation("Martinique_CaveEntrance", "officers", "reload1_2", "BordelGirl_64");
	Lai_SetPlayerType(pchar);
	break;


	case "BordelGirl_64":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_64");
	   iRank = MOD_SKILL_ENEMY_RATE;
	   sld = characterFromID("RD_Selina");
	   ChangeCharacterAddressGroup(sld, "Martinique_caveEntrance", "reload", "reload1_back");
	   Lai_SetStunnedTypeNoGroup(sld);
	   ...
	   LAi_group_MoveCharacter(sld, LAI_GROUP_PLAYER); //относим в группу героя
	   sld = characterFromID("RD_Prosper");
	   ChangeCharacterAddressGroup(sld, "Martinique_caveEntrance", "officers", "reload1_1");
	   LAi_SetImmortal(sld, false);
	   Lai_SetWarriorType(sld);
	   LAi_group_MoveCharacter(sld, LAI_GROUP_PLAYER); //относим в группу героя
	   TakeNItems(sld, "potion1", 4);
	...
	for (i=1; i<=6; i++)
	{
		sld = GetCharacter(NPC_GenerateCharacter("RD_Ind1_"+i, "canib_"+i, "man", "man", iRank, PIRATE, 0, true, "soldier"));
		SetFantomParamFromRank(sld, iRank, true);
		GiveItem2Character(sld, "slave_02");
		EquipCharacterbyItem(sld, "slave_02");
		RemoveCharacterEquip(sld, GUN_ITEM_TYPE);
		DeleteAttribute(sld, "SaveItemsForDead");
		DeleteAttribute(sld, "DontClearDead");
		ChangeCharacterAddressGroup(sld, "Martinique_CaveEntrance", "goto", "ass1");
		LAi_SetWarriorType(sld);
		LAi_group_MoveCharacter(sld, "CanibEnemyFight2");
	}
	  //вторая группа канибалов
	for (i=1; i<=6; i++)
	{
		sld = GetCharacter(NPC_GenerateCharacter("RD_Ind1_1"+i, "canib_"+i, "man", "man", iRank, PIRATE, 0, true, "soldier"));
		SetFantomParamFromRank(sld, iRank, true);
		GiveItem2Character(sld, "slave_02");
		EquipCharacterbyItem(sld, "slave_02");
		RemoveCharacterEquip(sld, GUN_ITEM_TYPE);
		DeleteAttribute(sld, "SaveItemsForDead");
		DeleteAttribute(sld, "DontClearDead");
		ChangeCharacterAddressGroup(sld, "Martinique_CaveEntrance", "reload", "reload2_back");
		LAi_SetWarriorType(sld);
		LAi_group_MoveCharacter(sld, "CanibEnemyFight2");
	}
	
	LAi_group_SetRelation("CanibEnemyFight2", LAI_GROUP_PLAYER, LAI_GROUP_ENEMY);
	LAi_group_FightGroups("CanibEnemyFight2", LAI_GROUP_PLAYER, true);
	LAi_group_SetCheck("CanibEnemyFight2", "BordelGirl_65");
	LAi_SetFightMode(pchar, true);
	break;


	case "BordelGirl_65":
	DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_65");
	sld = characterFromID("RD_Prosper");
	Lai_SetActorType(sld);
	LAi_ActorFollow(sld, characterFromId("BLAZE"), "", -1);
	sld = characterFromID("RD_Selina");
	Lai_SetActorType(sld);
	LAi_ActorFollow(sld, characterFromId("RD_Prosper"), "", -1);
	sld = characterFromID("Valinie");
	Lai_SetActorType(sld);
	LAi_ActorFollow(sld, characterFromId("BLAZE"), "BordelGirl_66", -1);
	break;


	case "BordelGirl_66":
	DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_66");
	sld = characterFromID("Valinie");
	sld.dialog.currentnode = "SharlieJungle_5";
	Lai_SetActorType(sld);
	LAi_ActorDialog(sld, pchar, "", -1, 0);
	break;
	...
	case "BordelGirl_67":
	DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_67");
	AddQuestRecord("Sharlie", "5-14");
	sld = characterFromID("RD_Prosper");
	Lai_SetActorType(sld);
	LAi_ActorRunToLocator(sld, "reload", "reload2_back", "", -1);
	sld = characterFromID("Valinie");
	Lai_SetActorType(sld);
	LAi_ActorRunToLocator(sld, "reload", "reload2_back", "", -1);
	Lai_SetActorType(pchar);
	LAi_ActorRunToLocator(pchar, "reload", "reload2_back", "", -1);
	sld = GetCharacter(NPC_GenerateCharacter("Sharlie_Second", "Citiz_58", "man", "man", 15, PIRATE, -1, true, "quest"));
	sld.name = "Шарль";
	sld.lastname = "де Мор";
	LAi_SetStayType(sld);
	...
	Group_AddCharacter("SS_Group", "Sharlie_Second");
	Group_SetGroupCommander("SS_Group", "Sharlie_Second");
	
	Group_SetAddress("SS_Group", "Martinique", "quest_ships", "quest_ship_1");
	Group_LockTask("SS_Group")
	DoQuestCheckDelay("BordelGirl_67a", 2.0);
	break;


	case "BordelGirl_67a":
	DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_67a");
	SetLaunchFrameFormParam("через некоторое время", "", 5, 8);
	LaunchFrameForm();
	WaitDate("", 0, 0, 0, 1, 0); // Крутану несколько минут
    RecalculateJumpTable();
	DoQuestCheckDelay("BordelGirl_68", 3.0);
	break;


	case "BordelGirl_68":
	DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_68");
	chrDisableReloadToLocation = true;//закрыть локацию
	DoQuestReloadToLocation("FortFrance_town", "goto", "goto7", "BordelGirl_69");
	Lai_SetPlayerType(pchar);
	break;


	case "BordelGirl_69":
	   DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_69");
	   sld = characterFromID("RD_Selina");
	   ChangeCharacterAddressGroup(sld, "FortFrance_town", "officers", "HouseF2_2");
	   Lai_SetActorType(sld);
	   LAi_ActorFollow(sld, characterFromId("RD_Prosper"), "", -1);
	   sld = characterFromID("GuardManTown");
	   ChangeCharacterAddressGroup(sld, "Martinique_caveEntrance", "goto", "goto7");
	   sld = characterFromID("Valinie");
	   ...
	   sld = characterFromID("RD_Prosper");
	   ChangeCharacterAddressGroup(sld, "FortFrance_town", "officers", "HouseF2_2");
	   sld.dialog.currentnode = "Prosper_13";
	   Lai_SetActorType(sld);
	   LAi_ActorDialog(sld, pchar, "", -1, 0);
	   for (i=1; i<+7; i++)
	  {
		sld = characterFromID("GuardMen_"+i);
	    ChangeCharacterAddressGroup(sld, "FortFrance_town", "officers", "HouseH2_1");
		Lai_SetActorType(sld);
		LAi_ActorTurnToCharacter(sld, characterFromID("Valinie"));
	  }
	  //гвардейцы у ворот
	  ...
	  {
		sld = characterFromID("GuardMen_1"+i);
		ChangeCharacterAddressGroup(sld, "FortFrance_town", "officers", "HouseH2_2");
		Lai_SetActorType(sld);
		LAi_ActorTurnToCharacter(sld, characterFromID("Valinie"));
	  }
	   break;
	...
	case "BordelGirl_70":
	DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_70");
	sld = characterFromID("RD_Selina");
	sld.dialog.currentnode = "Selina_1";
	Lai_SetActorType(sld);
	LAi_ActorDialog(sld, pchar, "", -1, 0);
	break;
	...
	case "BordelGirl_71":
	DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_71");
	sld = characterFromID("RD_Prosper");
	sld.dialog.currentnode = "Prosper_14";
	Lai_SetActorType(sld);
	LAi_ActorDialog(sld, pchar, "", -1, 0);
	break;
	...
	case "BordelGirl_72":
	DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_72");
	sld = characterFromID("RD_Prosper");
	Lai_SetActorType(sld);
	Lai_ActorRunToLocation(sld, "reload", "houseF2", "none", "", "", "", -1);
	sld = characterFromID("RD_Selina");
	Lai_SetActorType(sld);
	Lai_ActorRunToLocation(sld, "reload", "houseF2", "none", "", "", "", -1);
	DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_70");
	sld = characterFromID("Valinie");
	sld.dialog.currentnode = "SharlieBordelGirl_3";
	Lai_SetActorType(sld);
	LAi_ActorDialog(sld, pchar, "", -1, 0);
	break;
	...
	case "BordelGirl_72a":
	DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_72a");
	AddQuestRecord("Sharlie", "5-15");
	AddCharacterExpToSkill(Pchar, "Sneak", 200);
	Lai_SetActorType(pchar);
	Lai_ActorRunToLocation(pchar, "reload", "reload4_back", "none", "", "", "BordelGirl_73", -1);
	sld = characterFromID("Valinie");
	Lai_ActorRunToLocation(sld, "reload", "houseF2", "none", "", "", "", -1);
	for (i=1; i<+7; i++)
	  {
	...
	case "BordelGirl_73":
	DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_73");
	
	SetCurrentTime(19, 00);
	SetLaunchFrameFormParam("Тем же вечером", "", 5, 8);
	LaunchFrameForm();
	WaitDate("", 0, 0, 0, 0, 0); // Крутану несколько минут
    RecalculateJumpTable();
	DoQuestCheckDelay("BordelGirl_74", 3.0);
	break;



	case "BordelGirl_74":
	DeleteAttribute(pchar,"PostEventQuest.questDelay.BordelGirl_74");
	pchar = GetMainCharacter(); //меняем ГГ
	SetMainCharacterIndex(GetCharacterIndex("Sharlie_Second"));
	Lai_SetstayType(pchar);
	log_info("Баркас поставлен к пирсу");
	//AddQuestRecord("Sharlie", "5-16");
	chrDisableReloadToLocation = false; // открыть докацию
	bDisableCharacterMenu = true;   // запретить F2
	DoQuestReloadToLocation("FortFrance_town", "goto", "goto11", "");
	Lai_SetPlayerType(pchar);
	bQuestDisableMapEnter = false;//открыть карту
	//DoQuestFunctionDelay("Rum_CreateBarkas", 1.0);
	setCharacterShipLocation(pchar, "fortfrance_town");
	setWDMPointXZ("FortFrance_town");   // корабль в порт
	Group_FindOrCreateGroup("Rum_CapGroup");
	Group_SetType("Rum_CapGroup", "pirate");//тип группы
	sld = GetCharacter(NPC_GenerateCharacter("Rum_Cap", "mercen_5", "man", "man", 20, PIRATE, 5, true, "quest"));
	...
	sld.Dialog.Filename = "Quest\Sharlie\StartMiniQuests.c";
	sld.dialog.currentnode = "Rum_Capitan";
	sld.DeckDialogNode = "Rum_Capitan";
...
////////////////////////////////////////////Спасение жены губернатора////////////////////////////////////////////////////
    


    case "GuberWife_1":
    DeleteAttribute(pchar,"PostEventQuest.questDelay.GuberWife_1");
	sld = GetCharacter(NPC_GenerateCharacter("ContraSailor", "citiz_38", "man", "man", 3, FRANCE, -1, true, ""));
	sld.dialog.filename = "Quest\Sharlie\StartMiniQuests.c";
	ChangeCharacterAddressGroup(sld, "shore38", "reload", "sea");
	sld.dialog.currentnode = "ContraSailor_1";
	Lai_SetActorType(sld);
	LAi_ActorDialog(sld, pchar, "", -1, 0);
	break;
	...
	case "GuberWife_2":
    DeleteAttribute(pchar,"PostEventQuest.questDelay.GuberWife_2");
	bDisableCharacterMenu() = false;  //Разрешить F2
    pchar = GetMainCharacter(); //меняем ГГ
	SetMainCharacterIndex(GetCharacterIndex("BLAZE"));
	AddCharacterHealth(pchar, 36);
	Lai_SetActorType(pchar);
	//Lai_SetPlayerType(pchar);
	DoQuestReloadToLocation("shore38", "rld", "loc3", "GuberWife_3");
	sld = characterFromID("Valinie");
	ChangeCharacterAddressGroup(sld, "shore38", "rld", "loc4");
	Lai_SetActorType(sld);
	//DoQuestCheckDelay("GuberWife_3", 7.0);
	sld = characterFromID("Sharlie_Second");
	Lai_SetActorType(sld);
	LAi_ActorRunToLocator(sld, "goto", "goto7", "GuberWife_3a", -1);
	for (i=1; i<=4; i++)
    {
		...
		ChangeCharacterAddressGroup(sld, "shore38", "goto", "goto5");
		LAi_ActorFollow(sld, characterFromId("Sharlie_Second"), "", -1);
	}
	break;


	case "GuberWife_3a":
    DeleteAttribute(pchar,"PostEventQuest.questDelay.GuberWife_3a");
	sld = characterFromID("Sharlie_Second");
	Lai_SetActorType(sld);
	LAi_ActorTurnToCharacter(sld, characterFromID("Rum_Carrier2_1"));
	DoQuestCheckDelay("GuberWife_4", 10.0);
	break;


	case "GuberWife_3":
    DeleteAttribute(pchar,"PostEventQuest.questDelay.GuberWife_3");
	Lai_SetActorType(pchar);
	LAi_ActorTurnToCharacter(pchar, characterFromID("Sharlie_Second"));
	sld = characterFromID("Valinie");
	Lai_SetActorType(sld);
	LAi_ActorTurnToCharacter(sld, characterFromID("Sharlie_Second"));
	sld = characterFromID("ContraSailor");
	Lai_SetActorType(sld);
	LAi_ActorTurnToCharacter(sld, characterFromID("Sharlie_Second"));
	...
	case "GuberWife_4":
    DeleteAttribute(pchar,"PostEventQuest.questDelay.GuberWife_4");
	sld = characterFromID("ContraSailor");
	Lai_SetActorType(sld);
	LAi_ActorFollow(sld, characterFromId("Sharlie_Second"), "GuberWife_4a", -1);
	break;


	case "GuberWife_4a":
    DeleteAttribute(pchar,"PostEventQuest.questDelay.GuberWife_4a");
	sld = characterFromID("Sharlie_Second");
	Lai_SetActorType(sld);
	LAi_ActorTurnToCharacter(sld, characterFromID("ContraSailor"));
	DoQuestCheckDelay("GuberWife_5", 5.0);
	break;


	case "GuberWife_5":
    DeleteAttribute(pchar,"PostEventQuest.questDelay.GuberWife_5");
	sld = characterFromID("Sharlie_Second");
	Lai_SetActorType(sld);
	LAi_KillCharacter(sld);
	DoQuestCheckDelay("GuberWife_6", 5.0);
	break;


	case "GuberWife_6":
    DeleteAttribute(pchar,"PostEventQuest.questDelay.GuberWife_6");
	Lai_SetPlayerType(pchar);
	sld = characterFromID("Valinie");
	sld.dialog.currentnode = "SharlieGuberWife_1";
	Lai_SetActorType(sld);
	LAi_ActorDialog(sld, pchar, "", -1, 0);
	break;
	...
	case "GuberWife_7":
    DeleteAttribute(pchar,"PostEventQuest.questDelay.GuberWife_7");
	sld = characterFromID("Valinie");
	Lai_SetActorType(sld);
	Lai_ActorRunToLocation(sld, "reload", "reload1_back", "none", "", "", "", -1);
	for (i=1; i<=4; i++)
    {
		...
		LAi_SetActorType(sld);
		Lai_ActorRunToLocation(sld, "goto", "goto8", "none", "", "", "", -1);
	}
	sld = characterFromID("ContraSailor");
	Lai_SetActorType(sld);
	Lai_ActorRunToLocation(sld, "reload", "sea", "none", "", "", "", -1);
	DoQuestCheckDelay("GuberWife_8", 3.0);
	break;


	case "GuberWife_8":
    DeleteAttribute(pchar,"PostEventQuest.questDelay.GuberWife_8");
	AddQuestRecord("Sharlie", "5-18");
	AddCharacterExpToSkill(pchar, "Fortune", 200);
	Lai_SetActorType(pchar);
	Lai_ActorRunToLocation(pchar, "reload", "reload1_back", "none", "", "", "GuberWife_9", -1);
	break;


	case "GuberWife_9":
    DeleteAttribute(pchar,"PostEventQuest.questDelay.GuberWife_9");
	//DoReloadCharacterToLocation("Martinique_jungle_04", "monsters", "monster3");
	DoQuestReloadToLocation("Martinique_jungle_04", "monsters", "monster3", "GuberWife_10");
	Lai_SetPlayerType(pchar);
	sld = characterFromID("Valinie");
	ChangeCharacterAddressGroup(sld, "Martinique_jungle_04", "monsters", "monster1");
	sld = GetCharacter(NPC_GenerateCharacter("Sharlie_Second1", "Citiz_58", "man", "man", 15, PIRATE, -1, true, ""));
	ChangeCharacterAddressGroup(sld, "Martinique_jungle_04", "goto", "goto9");
	Lai_SetActorType(sld);
	Lai_ActorRunToLocation(sld, "reload", "reload3_back", "none", "", "", "", -1);
	for (i=1; i<=4; i++)
    {
		...
		LAi_SetActorType(sld);
		ChangeCharacterAddressGroup(sld, "Martinique_jungle_04", "goto", "goto9");
		Lai_ActorRunToLocation(sld, "reload", "reload3_back", "none", "", "", "GuberWife_11", -1);
	}
	break;


	case "GuberWife_10":
    DeleteAttribute(pchar,"PostEventQuest.questDelay.GuberWife_10");
	sld = characterFromID("Valinie");
	Lai_SetActorType(sld);
	LAi_ActorTurnToCharacter(sld, characterFromID("Sharlie_Second1"));
	//гвардейцы первая группа
	  for (i=1; i<+7; i++)
	  {
		sld = GetCharacter(NPC_GenerateCharacter("GuardMen1_"+i, "paladin_"+i, "man", "man2", 2, PIRATE, -1, true, "quest"));
		TakeNItems(sld, "potion1", 4);
		ChangeCharacterAddressGroup(sld, "Martinique_jungle_04", "monsters", "monster2");
		Lai_SetActorType(sld);
		LAi_ActorTurnToCharacter(sld, characterFromID("Valinie"));
		LAi_group_MoveCharacter(sld, LAI_GROUP_PLAYER); //относим в группу героя
	  }
	  //гвардейцы вторая группа
	  for (i=1; i<+7; i++)
	  {
		sld = GetCharacter(NPC_GenerateCharacter("GuardMen1_1"+i, "paladin_"+i, "man", "man2", 2, PIRATE, -1, true, "quest"));
		TakeNItems(sld, "potion1", 4);
		ChangeCharacterAddressGroup(sld, "Martinique_jungle_04", "goto", "goto3");
		Lai_SetActorType(sld);
		LAi_ActorTurnToCharacter(sld, characterFromID("Valinie"));
		LAi_group_MoveCharacter(sld, LAI_GROUP_PLAYER); //относим в группу героя
	  }
	...
	case "GuberWife_11":
    DeleteAttribute(pchar,"PostEventQuest.questDelay.GuberWife_11");
	sld = characterFromID("Valinie");
	sld.dialog.currentnode = "SharlieGuberWife_3";
	Lai_SetActorType(sld);
	LAi_ActorDialog(sld, pchar, "", -1, 0);
	break;
	...
	case "GuberWife_12":
    DeleteAttribute(pchar,"PostEventQuest.questDelay.GuberWife_12");
	sld = characterFromID("Valinie");
	Lai_SetActorType(sld);
	Lai_ActorRunToLocation(sld, "reload", "reload3_back", "none", "", "", "", -1);
	//гвардейцы первая группа
	  for (i=1; i<+7; i++)
	  {
		sld = characterFromID("GuardMen1_"+i);
		Lai_SetActorType(sld);
		Lai_ActorRunToLocation(sld, "reload", "reload3_back", "none", "", "", "", -1);
	  }
	  //гвардейцы вторая группа
	  for (i=1; i<+7; i++)
	  {
		sld = characterFromID("GuardMen1_1"+i);
		Lai_SetActorType(sld);
		Lai_ActorRunToLocation(sld, "reload", "reload3_back", "none", "", "", "", -1);
	  }
	DoQuestCheckDelay("GuberWife_13", 5.0);
	break;


	case "GuberWife_13":
    DeleteAttribute(pchar,"PostEventQuest.questDelay.GuberWife_13");
	Lai_SetActorType(pchar);
	Lai_ActorRunToLocation(pchar, "reload", "reload3_back", "none", "", "", "", -1);
	DoQuestCheckDelay("GuberWife_14", 5.0);
	break;



	case "GuberWife_14":
    DeleteAttribute(pchar,"PostEventQuest.questDelay.GuberWife_14");
	DoQuestReloadToLocation("Bandit_Camp", "goto", "goto4", "GuberWife_15");
	Lai_SetPlayerType(pchar);
	break;


	case "GuberWife_15":
    DeleteAttribute(pchar,"PostEventQuest.questDelay.GuberWife_15");
	sld = characterFromID("Valinie");
	ChangeCharacterAddressGroup(sld, "Bandit_Camp", "goto", "goto3");
	Lai_SetWarriorType(sld);
	LAi_group_MoveCharacter(sld, LAI_GROUP_PLAYER); //относим в группу героя
	//гвардейцы первая группа
	for (i=1; i<+7; i++)
	  {
		sld = characterFromID("GuardMen1_"+i);
		ChangeCharacterAddressGroup(sld, "Bandit_Camp", "goto", "goto5");
		Lai_SetWarriorType(sld);
		LAi_group_MoveCharacter(sld, LAI_GROUP_PLAYER); //относим в группу героя
	  }
	//гвардейцы вторая группа
	for (i=1; i<+7; i++)
	  {
		sld = characterFromID("GuardMen1_1"+i);
		ChangeCharacterAddressGroup(sld, "Bandit_Camp", "goto", "goto8");
		Lai_SetWarriorType(sld);
		LAi_group_MoveCharacter(sld, LAI_GROUP_PLAYER); //относим в группу героя
	  }
	//бандиты с берега
    ...
    {
		sld = characterFromID("Rum_Carrier2_"+i);
		SetFantomParamFromRank(sld, 2, true);
		
		LAi_SetImmortal(sld, false);  //снимаем бессмертие
		ChangeCharacterAddressGroup(sld, "Bandit_Camp", "goto", "goto1");
		Lai_SetWarriorType(sld);
		LAi_group_MoveCharacter(sld, "BanditCampFight1");
	}
	//бандиты первая группа
	for (i=1; i<+7; i++)
	  {
		sld = GetCharacter(NPC_GenerateCharacter("GuberWifeBandit"+i, "pirate_"+i, "man", "man", 1, PIRATE, -1, true, "quest"));
		ChangeCharacterAddressGroup(sld, "Bandit_Camp", "reload", "reload4");
		Lai_SetWarriorType(sld);
		LAi_group_MoveCharacter(sld, "BanditCampFight1");
	  }
	//бандиты вторая группа
	for (i=1; i<+7; i++)
	  {
		sld = GetCharacter(NPC_GenerateCharacter("GuberWifeBandit1"+i, "sold_fra_"+i, "man", "man", 1, PIRATE, -1, true, "quest"));
		ChangeCharacterAddressGroup(sld, "Bandit_Camp", "reload", "reload5");
		Lai_SetWarriorType(sld);
		LAi_group_MoveCharacter(sld, "BanditCampFight1");
	  }
	//бандиты третья группа
	for (i=1; i<+7; i++)
	  {
		sld = GetCharacter(NPC_GenerateCharacter("GuberWifeBandit2"+i, "Citiz_58", "man", "man", 1, PIRATE, -1, true, "quest"));
		ChangeCharacterAddressGroup(sld, "Bandit_Camp", "goto", "goto11");
		Lai_SetActorType(sld);
		Lai_ActorRunToLocation(sld, "reload", "reload1_back", "none", "", "", "", -1);
	  }
	LAi_group_SetRelation("BanditCampFight1", LAI_GROUP_PLAYER, LAI_GROUP_ENEMY);
	LAi_group_FightGroups("BanditCampFight1", LAI_GROUP_PLAYER, true);
	LAi_group_SetCheck("BanditCampFight1", "GuberWife_16");
	LAi_SetFightMode(pchar, true);
	break;


	case "GuberWife_16":
    DeleteAttribute(pchar,"PostEventQuest.questDelay.GuberWife_16");
	AddQuestRecord("Sharlie", "5-19");
	Lai_SetActorType(pchar);
	Lai_ActorRunToLocation(pchar, "reload", "reload4", "none", "", "", "GuberWife_17", -1);
	break;


	case "GuberWife_17":
    DeleteAttribute(pchar,"PostEventQuest.questDelay.GuberWife_17");
	DoQuestReloadToLocation("BanditHut", "reload", "reload2", "GuberWife_18");
	InterfaceStates.Buttons.Save.enable = false;//запретить сохраняться
	Lai_SetPlayerType(pchar);
	break;
	...
	case "GuberWife_18":
    DeleteAttribute(pchar,"PostEventQuest.questDelay.GuberWife_18");
	sld = GetCharacter(NPC_GenerateCharacter("KatrinduParke", "Lady_1", "woman", "woman", 5, PIRATE, -1, true, ""));
	sld.name = "Катрин";
	sld.lastname = "ду Парке";
	sld.dialog.filename = "NewPapka\Memories\KatrinduParke.c";
	Lai_SetStunnedTypeNoGroup(sld);
	ChangeCharacterAddressGroup(sld, "BanditHut", "goto", "goto1");
	sld = GetCharacter(NPC_GenerateCharacter("AnnettduParke", "Lady_2", "woman", "woman", 5, PIRATE, -1, true, ""));
	sld.name = "Аннетт";
	sld.lastname = "ду Парке";
	sld.dialog.filename = "NewPapka\Memories\AnnettduParke.c";
	Lai_SetStunnedTypeNoGroup(sld);
	ChangeCharacterAddressGroup(sld, "BanditHut", "goto", "goto1");
	sld = characterFromID("Sharlie_Second1");
	ChangeCharacterAddressGroup(sld, "BanditHut", "goto", "goto2");
	sld = characterFromID("OlivieBlank");
	ChangeCharacterAddressGroup(sld, "BanditHut", "goto", "goto2");
	sld.dialog.currentnode = "BanditHut_1";
	Lai_SetActorType(sld);
	LAi_ActorDialog(sld, pchar, "", -1, 0);
	break;
	...
	case "GuberWife_19":
	DeleteAttribute(pchar,"PostEventQuest.questDelay.GuberWife_19");
	sld = characterFromID("Sharlie_Second1");
	LAi_SetHP(sld, 1.0, 1.0);
	Lai_SetStayType(sld);
	Lai_ActorAttack(characterFromID("OlivieBlank"), characterFromID("Sharlie_Second1"), "");
	pchar.quest.GuberWife19.win_condition.l1 = "NPC_Death";
	pchar.quest.GuberWife19.win_condition.l1.character = "Sharlie_Second1";
	pchar.quest.GuberWife19.win_condition = "GuberWife_20";
	break;


	case "GuberWife_20":
    DeleteAttribute(pchar,"PostEventQuest.questDelay.GuberWife_20");
	sld = characterFromID("OlivieBlank");
	sld.dialog.currentnode = "BanditHut_2";
	Lai_SetActorType(sld);
	LAi_ActorDialog(sld, pchar, "", -1, 0);
	break;
	...
	case "GuberWife_21":
    DeleteAttribute(pchar,"PostEventQuest.questDelay.GuberWife_21");
	sld = characterFromID("OlivieBlank");
	Lai_SetWarriorType(sld);
	LAi_group_MoveCharacter(sld, "BanditHutFight1");
	LAi_group_SetRelation("BanditHutFight1", LAI_GROUP_PLAYER, LAI_GROUP_ENEMY);
	LAi_group_FightGroups("BanditHutFight1", LAI_GROUP_PLAYER, true);
	LAi_group_SetCheck("BanditHutFight1", "GuberWife_22");
	LAi_SetFightMode(pchar, true);
	break;


	case "GuberWife_22":
    DeleteAttribute(pchar,"PostEventQuest.questDelay.GuberWife_22");
	sld = characterFromID("AnnettduParke");
	sld.dialog.currentnode = "AnnettBanditHut_1";
	Lai_SetActorType(sld);
	LAi_ActorDialog(sld, pchar, "", -1, 0);
	sld = characterFromID("KatrinduParke");
	Lai_SetActorType(sld);
	LAi_ActorTurnToCharacter(sld, characterFromID("BLAZE"));
	break;
	...
	case "GuberWife_23":
    DeleteAttribute(pchar,"PostEventQuest.questDelay.GuberWife_23");
	sld = characterFromID("Valinie");
	ChangeCharacterAddressGroup(sld, "BanditHut", "reload", "reload2");
	sld.dialog.currentnode = "SharlieGuberWife_4";
	Lai_SetActorType(sld);
	LAi_ActorDialog(sld, pchar, "", -1, 0);
	break;
	...
	case "GuberWife_24":
    DeleteAttribute(pchar,"PostEventQuest.questDelay.GuberWife_24");
	sld = characterFromID("AnnettduParke");
	sld.dialog.currentnode = "AnnettBanditHut_4";
	Lai_SetActorType(sld);
	LAi_ActorDialog(sld, pchar, "", -1, 0);
	break;
	...
	case "GuberWife_25":
    DeleteAttribute(pchar,"PostEventQuest.questDelay.GuberWife_25");
	sld = characterFromID("AnnettduParke");
	Lai_SetActorType(sld);
	Lai_ActorRunToLocation(sld, "reload", "reload1", "none", "", "", "", -1);
	sld = characterFromID("KatrinduParke");
	...
	Lai_ActorRunToLocation(sld, "reload", "reload1", "none", "", "", "", -1);
	sld = characterFromID("Valinie");
	sld.dialog.currentnode = "SharlieGuberWife_7";
	Lai_SetActorType(sld);
	LAi_ActorDialog(sld, pchar, "", -1, 0);
	break;
	...
	case "GuberWife_26":
    DeleteAttribute(pchar,"PostEventQuest.questDelay.GuberWife_26");
	AddQuestRecord("Sharlie", "5-20");
	AddCharacterExpToSkill(Pchar, "Leadership", 200);
	Lai_SetActorType(pchar);
	Lai_ActorRunToLocation(pchar, "reload", "reload2", "none", "", "", "", -1);
	sld = characterFromID("Valinie");
	Lai_SetActorType(sld);
	Lai_ActorRunToLocation(sld, "reload", "reload2", "none", "", "", "", -1);
	DoQuestCheckDelay("GuberWife_27", 2.0);
	break;


	case "GuberWife_27":
	DeleteAttribute(pchar,"PostEventQuest.questDelay.GuberWife_27");
	SetLaunchFrameFormParam("По пути в Сен-Пьер", "", 5, 8);
	LaunchFrameForm();
	WaitDate("", 0, 0, 0, 2, 30); // Крутану несколько минут
    RecalculateJumpTable();
	DoQuestCheckDelay("GuberWife_28", 3.0);
	break;



	case "GuberWife_28":
    DeleteAttribute(pchar,"PostEventQuest.questDelay.GuberWife_28");
	InterfaceStates.Buttons.Save.enable = true;//разрешаем сохраняться
	DoQuestReloadToLocation("Martinique_jungle_02", "goto", "goto3", "GuberWife_28a");
	Lai_SetPlayerType(pchar);
	sld = characterFromID("Valinie");
	ChangeCharacterAddressGroup(sld, "Martinique_jungle_02", "goto", "goto4");
	
	break;


	case "GuberWife_28a":
    DeleteAttribute(pchar,"PostEventQuest.questDelay.GuberWife_28a");
	sld = characterFromID("Valinie");
	sld.dialog.currentnode = "SharlieGuberWife_9";
	Lai_SetActorType(sld);
	LAi_ActorDialog(sld, pchar, "", -1, 0);
	sld = characterFromID("AnnettduParke");
	ChangeCharacterAddressGroup(sld, "Martinique_jungle_02", "goto", "goto3");
	Lai_SetActorType(sld);
	LAi_ActorTurnToCharacter(sld, characterFromID("Valinie"));
	sld = characterFromID("KatrinduParke");
	ChangeCharacterAddressGroup(sld, "Martinique_jungle_02", "goto", "goto3");
	...
	for (i=1; i<+7; i++)
	  {
		sld = characterFromID("GuardMen1_"+i);
		ChangeCharacterAddressGroup(sld, "Martinique_jungle_02", "goto", "goto7");
		Lai_SetActorType(sld);
		LAi_ActorTurnToCharacter(sld, characterFromID("Valinie"));
	  }
	//гвардейцы вторая группа
	for (i=1; i<+7; i++)
	  {
		sld = characterFromID("GuardMen1_1"+i);
		ChangeCharacterAddressGroup(sld, "Martinique_jungle_02", "goto", "goto8");
		Lai_SetActorType(sld);
		LAi_ActorTurnToCharacter(sld, characterFromID("Valinie"));
	  }
	break;
	...
	case "GuberWife_29":
    DeleteAttribute(pchar,"PostEventQuest.questDelay.GuberWife_29");
	iRank = MOD_SKILL_ENEMY_RATE;
	sld = characterFromID("AnnettduParke");
	Lai_SetStunnedTypeNoGroup(sld);
	sld = characterFromID("KatrinduParke");
	...
	for (i=1; i<=6; i++)
	{
		sld = GetCharacter(NPC_GenerateCharacter("RD_Ind2_"+i, "canib_"+i, "man", "man", iRank, PIRATE, 0, true, "soldier"));
		SetFantomParamFromRank(sld, iRank, true);
		GiveItem2Character(sld, "slave_02");
		EquipCharacterbyItem(sld, "slave_02");
		RemoveCharacterEquip(sld, GUN_ITEM_TYPE);
		...
		LAi_SetWarriorType(sld);
		LAi_group_MoveCharacter(sld, "CanibEnemyFight3");
	}
	  //вторая группа канибалов
	for (i=1; i<=6; i++)
	{
		sld = GetCharacter(NPC_GenerateCharacter("RD_Ind2_1"+i, "canib_"+i, "man", "man", iRank, PIRATE, 0, true, "soldier"));
		SetFantomParamFromRank(sld, iRank, true);
		GiveItem2Character(sld, "slave_02");
		EquipCharacterbyItem(sld, "slave_02");
		RemoveCharacterEquip(sld, GUN_ITEM_TYPE);
		DeleteAttribute(sld, "SaveItemsForDead");
		DeleteAttribute(sld, "DontClearDead");
		ChangeCharacterAddressGroup(sld, "Martinique_jungle_02", "goto", "goto2");
		LAi_SetWarriorType(sld);
		LAi_group_MoveCharacter(sld, "CanibEnemyFight3");
	}
	//третья группа канибалов
	for (i=1; i<=6; i++)
	{
		sld = GetCharacter(NPC_GenerateCharacter("RD_Ind2_2"+i, "canib_"+i, "man", "man", iRank, PIRATE, 0, true, "soldier"));
		SetFantomParamFromRank(sld, iRank, true);
		GiveItem2Character(sld, "slave_02");
		EquipCharacterbyItem(sld, "slave_02");
		RemoveCharacterEquip(sld, GUN_ITEM_TYPE);
	...
	//четвёртая группа канибалов
	for (i=1; i<=6; i++)
	{
		sld = GetCharacter(NPC_GenerateCharacter("RD_Ind2_3"+i, "canib_"+i, "man", "man", iRank, PIRATE, 0, true, "soldier"));
		SetFantomParamFromRank(sld, iRank, true);
		GiveItem2Character(sld, "slave_02");
		EquipCharacterbyItem(sld, "slave_02");
		RemoveCharacterEquip(sld, GUN_ITEM_TYPE);
	...
	//пятая группа канибалов
	for (i=1; i<=6; i++)
	{
		sld = GetCharacter(NPC_GenerateCharacter("RD_Ind2_4"+i, "canib_"+i, "man", "man", iRank, PIRATE, 0, true, "soldier"));
		SetFantomParamFromRank(sld, iRank, true);
		GiveItem2Character(sld, "slave_02");
		EquipCharacterbyItem(sld, "slave_02");
		RemoveCharacterEquip(sld, GUN_ITEM_TYPE);
	...
	LAi_group_SetRelation("CanibEnemyFight3", LAI_GROUP_PLAYER, LAI_GROUP_ENEMY);
	LAi_group_FightGroups("CanibEnemyFight3", LAI_GROUP_PLAYER, true);
	LAi_group_SetCheck("CanibEnemyFight3", "");
	LAi_SetFightMode(pchar, true);
	pchar.quest.GuberWife29.win_condition.l1 = "NPC_death";
	pchar.quest.GuberWife29.win_condition.l1.character = "RD_Ind2_1";
	pchar.quest.GuberWife29.win_condition.l2 = "NPC_death";
	pchar.quest.GuberWife29.win_condition.l2.character = "RD_Ind2_2";
	pchar.quest.GuberWife29.win_condition.l3 = "NPC_death";
	pchar.quest.GuberWife29.win_condition.l3.character = "RD_Ind2_3";
	pchar.quest.GuberWife29.win_condition.l4 = "NPC_death";
	pchar.quest.GuberWife29.win_condition.l4.character = "RD_Ind2_4";
	pchar.quest.GuberWife29.win_condition.l3 = "NPC_death";
	pchar.quest.GuberWife29.win_condition.l3.character = "RD_Ind2_5";
	pchar.quest.GuberWife29.win_condition.l4 = "NPC_death";
	pchar.quest.GuberWife29.win_condition.l4.character = "RD_Ind2_6";
	pchar.quest.GuberWife29.win_condition.l1 = "NPC_death";
	pchar.quest.GuberWife29.win_condition.l1.character = "RD_Ind2_11";
	pchar.quest.GuberWife29.win_condition.l2 = "NPC_death";
	pchar.quest.GuberWife29.win_condition.l2.character = "RD_Ind2_12";
	pchar.quest.GuberWife29.win_condition.l3 = "NPC_death";
	pchar.quest.GuberWife29.win_condition.l3.character = "RD_Ind2_13";
	pchar.quest.GuberWife29.win_condition.l4 = "NPC_death";
	pchar.quest.GuberWife29.win_condition.l4.character = "RD_Ind2_14";
	pchar.quest.GuberWife29.win_condition.l3 = "NPC_death";
	pchar.quest.GuberWife29.win_condition.l3.character = "RD_Ind2_15";
	pchar.quest.GuberWife29.win_condition.l4 = "NPC_death";
	pchar.quest.GuberWife29.win_condition.l4.character = "RD_Ind2_16";
	pchar.quest.GuberWife29.win_condition.l1 = "NPC_death";
	pchar.quest.GuberWife29.win_condition.l1.character = "RD_Ind2_21";
	pchar.quest.GuberWife29.win_condition.l2 = "NPC_death";
	pchar.quest.GuberWife29.win_condition.l2.character = "RD_Ind2_22";
	pchar.quest.GuberWife29.win_condition.l3 = "NPC_death";
	pchar.quest.GuberWife29.win_condition.l3.character = "RD_Ind2_23";
	pchar.quest.GuberWife29.win_condition.l4 = "NPC_death";
	pchar.quest.GuberWife29.win_condition.l4.character = "RD_Ind2_24";
	pchar.quest.GuberWife29.win_condition.l3 = "NPC_death";
	pchar.quest.GuberWife29.win_condition.l3.character = "RD_Ind2_25";
	pchar.quest.GuberWife29.win_condition.l4 = "NPC_death";
	pchar.quest.GuberWife29.win_condition.l4.character = "RD_Ind2_26";
	pchar.quest.GuberWife29.win_condition.l1 = "NPC_death";
	pchar.quest.GuberWife29.win_condition.l1.character = "RD_Ind2_31";
	pchar.quest.GuberWife29.win_condition.l2 = "NPC_death";
	pchar.quest.GuberWife29.win_condition.l2.character = "RD_Ind2_32";
	pchar.quest.GuberWife29.win_condition.l3 = "NPC_death";
	pchar.quest.GuberWife29.win_condition.l3.character = "RD_Ind2_33";
	pchar.quest.GuberWife29.win_condition.l4 = "NPC_death";
	pchar.quest.GuberWife29.win_condition.l4.character = "RD_Ind2_34";
	pchar.quest.GuberWife29.win_condition.l3 = "NPC_death";
	pchar.quest.GuberWife29.win_condition.l3.character = "RD_Ind2_35";
	pchar.quest.GuberWife29.win_condition.l4 = "NPC_death";
	pchar.quest.GuberWife29.win_condition.l4.character = "RD_Ind2_36";
	pchar.quest.GuberWife29.win_condition.l1 = "NPC_death";
	pchar.quest.GuberWife29.win_condition.l1.character = "RD_Ind2_41";
	pchar.quest.GuberWife29.win_condition.l2 = "NPC_death";
	pchar.quest.GuberWife29.win_condition.l2.character = "RD_Ind2_42";
	pchar.quest.GuberWife29.win_condition.l3 = "NPC_death";
	pchar.quest.GuberWife29.win_condition.l3.character = "RD_Ind2_43";
	pchar.quest.GuberWife29.win_condition.l4 = "NPC_death";
	pchar.quest.GuberWife29.win_condition.l4.character = "RD_Ind2_44";
	pchar.quest.GuberWife29.win_condition.l3 = "NPC_death";
	pchar.quest.GuberWife29.win_condition.l3.character = "RD_Ind2_45";
	pchar.quest.GuberWife29.win_condition.l4 = "NPC_death";
	pchar.quest.GuberWife29.win_condition.l4.character = "RD_Ind2_46";
	pchar.quest.GuberWife29.win_condition = "GuberWife_33";
	DoQuestCheckDelay("GuberWife_30", 30.0);
	break;


	case "GuberWife_30":
    DeleteAttribute(pchar,"PostEventQuest.questDelay.GuberWife_30");
	iRank = MOD_SKILL_ENEMY_RATE;
	//третья группа канибалов
	for (i=1; i<=6; i++)
	{
		sld = characterFromID("RD_Ind2_2"+i);
		SetFantomParamFromRank(sld, iRank, true);
		GiveItem2Character(sld, "slave_02");
		EquipCharacterbyItem(sld, "slave_02");
		RemoveCharacterEquip(sld, GUN_ITEM_TYPE);
	...
	DoQuestCheckDelay("GuberWife_31", 30.0);
	break;


	case "GuberWife_31":
    DeleteAttribute(pchar,"PostEventQuest.questDelay.GuberWife_31");
	iRank = MOD_SKILL_ENEMY_RATE;
	//четвёртая группа канибалов
	for (i=1; i<=6; i++)
	{
		sld = characterFromID("RD_Ind2_3"+i);
		SetFantomParamFromRank(sld, iRank, true);
		GiveItem2Character(sld, "slave_02");
		EquipCharacterbyItem(sld, "slave_02");
		RemoveCharacterEquip(sld, GUN_ITEM_TYPE);
	...
	DoQuestCheckDelay("GuberWife_32", 30.0);
	break;


	case "GuberWife_32":
    DeleteAttribute(pchar,"PostEventQuest.questDelay.GuberWife_32");
	iRank = MOD_SKILL_ENEMY_RATE;
	//пятая группа канибалов
	for (i=1; i<=6; i++)
	{
		sld = characterFromID("RD_Ind2_4"+i);
		SetFantomParamFromRank(sld, iRank, true);
		GiveItem2Character(sld, "slave_02");
		EquipCharacterbyItem(sld, "slave_02");
		RemoveCharacterEquip(sld, GUN_ITEM_TYPE);
	...
	//губернатор
	sld = characterFromID("DuParke");
	LAi_SetImmortal(sld, true);    // бессмертие 
	ChangeCharacterAddressGroup(sld, "Martinique_jungle_02", "officers", "Reload2_3");
	Lai_SetWarriorType(sld);
	LAi_group_MoveCharacter(sld, LAI_GROUP_PLAYER); //относим в группу героя
	// солдаты с губернатором первая группа
	for (i=1; i<+7; i++)
	{
		sld = GetCharacter(NPC_GenerateCharacter("DuParkeSenPierMen_"+i, "sold_fra_"+i, "man", "man", 2, PIRATE, -1, true, "quest"));
	    ChangeCharacterAddressGroup(sld, "Martinique_jungle_02", "reload", "Reload2_back");
	    Lai_SetWarriorType(sld);
		LAi_group_MoveCharacter(sld, LAI_GROUP_PLAYER); //относим в группу героя
        
	}
	// солдаты с губернатором вторая группа
	for (i=1; i<+7; i++)
	{
		sld = GetCharacter(NPC_GenerateCharacter("DuParkeSenPierMen_1"+i, "sold_fra_"+i, "man", "man", 2, PIRATE, -1, true, "quest"));
	    ChangeCharacterAddressGroup(sld, "Martinique_jungle_02", "officers", "Reload2_1");
	    Lai_SetWarriorType(sld);
		LAi_group_MoveCharacter(sld, LAI_GROUP_PLAYER); //относим в группу героя
	...
	case "GuberWife_33":
    DeleteAttribute(pchar,"PostEventQuest.questDelay.GuberWife_33");
	AddComplexSelfExpToScill(50, 50, 50, 50);
	AddCharacterExpToSkill(pchar, GetEquipedBladeType(pchar), 50);
	sld = characterFromID("AnnettduParke");
	Lai_SetActorType(sld);
	LAi_ActorFollow(sld, characterFromId("DuParke"), "", -1);
	sld = characterFromID("DuParke");
	Lai_SetActorType(sld);
	LAi_ActorFollow(sld, characterFromId("BLAZE"), "GuberWife_34", -1);
	sld = characterFromID("KatrinduParke");
	Lai_SetActorType(sld);
	LAi_ActorFollow(sld, characterFromId("AnnettduParke"), "", -1);
	sld = characterFromID("Valinie");
	Lai_SetActorType(sld);
	LAi_ActorFollow(sld, characterFromId("BLAZE"), "", -1);
	break;
	...
	case "GuberWife_34":
	DeleteAttribute(pchar,"PostEventQuest.questDelay.GuberWife_34");
	sld = characterFromID("AnnettduParke");
	sld.dialog.currentnode = "AnnettAfterFight_1";
	Lai_SetActorType(sld);
	LAi_ActorDialog(sld, pchar, "", -1, 0);
	break;
	...
	case "GuberWife_35":
	DeleteAttribute(pchar,"PostEventQuest.questDelay.GuberWife_35");
	sld = characterFromID("DuParke");
	sld.dialog.currentnode = "DuParke_5";
	Lai_SetActorType(sld);
	LAi_ActorDialog(sld, pchar, "", -1, 0);
	break;
	...
	case "GuberWife_36":
	DeleteAttribute(pchar,"PostEventQuest.questDelay.GuberWife_36");
	sld = characterFromID("DuParke");
	sld.dialog.currentnode = "DuParke_7";
	Lai_SetActorType(sld);
	LAi_ActorDialog(sld, pchar, "", -1, 0);
	break;
	...
	case "GuberWife_37":
	DeleteAttribute(pchar,"PostEventQuest.questDelay.GuberWife_37");
	AddQuestRecord("Sharlie", "5-21");
	sld = characterFromID("AnnettduParke");
	Lai_SetActorType(sld);
	Lai_ActorRunToLocation(sld, "reload", "reload1_back", "none", "", "", "", -1);
	sld = characterFromID("DuParke");
	...
	for (i=1; i<+7; i++)
	  ...
	  DoQuestCheckDelay("GuberWife_38", 10.0);
	break;


	case "GuberWife_38":
	DeleteAttribute(pchar,"PostEventQuest.questDelay.GuberWife_38");
	sld = characterFromID("Valinie");
	sld.dialog.currentnode = "SharlieGuberWife_10";
	Lai_SetActorType(sld);
	LAi_ActorDialog(sld, pchar, "", -1, 0);
	break;
	...
	case "GuberWife_39":
	DeleteAttribute(pchar,"PostEventQuest.questDelay.GuberWife_39");
	sld = characterFromID("Valinie");
	Lai_SetActorType(sld);
	Lai_ActorRunToLocation(sld, "reload", "reload2_back", "none", "", "", "", -1);
	DoQuestCheckDelay("GuberWife_40", 5.0);
	break;


	case "GuberWife_40":
	DeleteAttribute(pchar,"PostEventQuest.questDelay.GuberWife_40");
	AddQuestRecord("Sharlie", "5-22");
	Lai_SetActorType(pchar);
	Lai_ActorRunToLocation(pchar, "reload", "reload1_back", "none", "", "", "GuberWife_41", -1);
	break;


	case "GuberWife_41":
	DeleteAttribute(pchar,"PostEventQuest.questDelay.GuberWife_41");
	WaitDate("", 0, 0, 0, 24, 0);    // Кручу до 12 дня
	SetCurrentTime(12, 00);
	RecalculateJumpTable();
	SetLaunchFrameFormParam("На следующий день"+ NewStr() +"после похорон Сержа Куражо", "", 0, 6);
	LaunchFrameForm();
	DoQuestCheckDelay("GuberWife_42", 5.0);
	break;


	case "GuberWife_42":
    DeleteAttribute(pchar,"PostEventQuest.questDelay.GuberWife_42");
	DoQuestReloadToLocation("fortFrance_town", "goto", "goto7", "GuberWife_42a");
	Lai_SetPlayerType(pchar);
	chrDisableReloadToLocation = false; // открыть локацию
	break;
	...
	case "GuberWife_42a":
    DeleteAttribute(pchar,"PostEventQuest.questDelay.GuberWife_42a");
	// Паскаль Жаке
	sld = GetCharacter(NPC_GenerateCharacter("PaskalJake", "paladin_leitinat", "man", "man2", 2, PIRATE, -1, true, "quest"));
	sld.name = "Паскаль";
	sld.lastname = "Жаке";
	sld.dialog.filename = "NewPapka\Memories\PaskalJake.c";
	SetSelfSkill(sld, 20, 10, 10, 10, 10);
    SetShipSkill(sld, 25, 10, 30, 27, 28, 30, 12, 15, 20);
	ChangeCharacterAddressGroup(sld, "fortFrance_town", "goto", "goto6");
	Lai_SetActorType(sld);
	LAi_ActorFollow(sld, characterFromId("BLAZE"), "GuberWife_43", -1);
	break;


	case "GuberWife_43":
    DeleteAttribute(pchar,"PostEventQuest.questDelay.GuberWife_43");
	sld = characterFromID("PaskalJake");
	sld.dialog.currentnode = "PaskalJakeSharlieGuberWife_1";
	Lai_SetActorType(sld);
	LAi_ActorDialog(sld, pchar, "", -1, 0);
	break;
	...
	case "GuberWife_44":
    DeleteAttribute(pchar,"PostEventQuest.questDelay.GuberWife_44");
	AddQuestRecord("Sharlie", "5-23");
	sld = characterFromID("PaskalJake");
	Lai_SetActorType(sld);
	Lai_ActorRunToLocation(sld, "reload", "reload4_back", "none", "", "", "", -1);
	Lai_SetActorType(pchar);
	DoQuestCheckDelay("GuberWife_45", 1.0);
	break;


	case "GuberWife_45":
	DeleteAttribute(pchar,"PostEventQuest.questDelay.GuberWife_45");
	Lai_SetActorType(pchar);
	Lai_ActorRunToLocation(pchar, "reload", "reload5_back", "none", "", "", "", -1);
	DoQuestCheckDelay("GuberWife_46", 4.0);
	break;


	case "GuberWife_46":
    DeleteAttribute(pchar,"PostEventQuest.questDelay.GuberWife_46");
	DoQuestReloadToLocation("fortFrance_shipyard", "goto", "goto2", "");
	Lai_SetPlayerType(pchar);
	sld = characterFromID("PaskalJake");
	ChangeCharacterAddressGroup(sld, "fortFrance_tavern", "goto", "goto3");
	//усадим матроса
	...
	pchar.quest.GuberWife46.win_condition.l1 = "location";
	pchar.quest.GuberWife46.win_condition.l1.location = "fortFrance_tavern";
	pchar.quest.GuberWife46.win_condition = "GuberWife_47";
	break;


	case "GuberWife_47":
    DeleteAttribute(pchar,"PostEventQuest.questDelay.GuberWife_47");
	sld = characterFromID("PaskalJake");
	sld.dialog.currentnode = "PaskalJakeSharlieGuberWife_5";
	Lai_SetActorType(sld);
	LAi_ActorDialog(sld, pchar, "", -1, 0);
	break;
	...
	case "GuberWife_48":
    DeleteAttribute(pchar,"PostEventQuest.questDelay.GuberWife_48");
	AddQuestRecord("Sharlie", "5-25");
	sld = characterFromID("PaskalJake");
	Lai_SetActorType(sld);
	Lai_ActorRunToLocation(sld, "reload", "reload1", "none", "", "", "", -1);
	break;
    ...
    case "GuberWife_49":
    DeleteAttribute(pchar,"PostEventQuest.questDelay.GuberWife_49");
	sld = characterFromID("PaskalJake");
	sld.greeting = "Gr_officer";
	sld.dialog.FileName = "Enc_officer_dialog.c";
	sld.dialog.CurrentNode = "hired";
	...
	////////////////////////////////////////////Отплытие с Мартиники////////////////////////////////////////////////////

    
	case "FirstOut_1":
    DeleteAttribute(pchar,"PostEventQuest.questDelay.FirstOut_1");
	AddCharacterExpToSkill(Pchar, "Leadership", 100);
	// Матрос после побега Франка Дюгари
	sld = GetCharacter(NPC_GenerateCharacter("DugariSailor", "Citiz_37", "man", "man", 15, FRANCE, -1, true, "quest"));
	sld.Dialog.Filename = "Quest\Sharlie\OtherNPC.c";
	ChangeCharacterAddressGroup(sld, "fortFrance_town", "reload", "basement1");
	Lai_SetActorType(sld);
	LAi_ActorFollow(sld, characterFromId("BLAZE"), "FirstOut_2", -1);
	break;


	case "FirstOut_2":
    DeleteAttribute(pchar,"PostEventQuest.questDelay.FirstOut_2");
	sld = characterFromID("DugariSailor");
	sld.dialog.currentnode = "DugariSail_1";
	Lai_SetActorType(sld);
	LAi_ActorDialog(sld, pchar, "", -1, 0);
	break;
	...
	case "FirstOut_3":
    DeleteAttribute(pchar,"PostEventQuest.questDelay.FirstOut_3");
	sld = characterFromID("DugariSailor");
	Lai_SetActorType(sld);
	Lai_ActorRunToLocation(sld, "reload", "basement1", "none", "", "", "", -1);
	Lai_SetActorType(pchar);
	Lai_ActorRunToLocation(pchar, "reload", "basement1", "none", "", "", "", -1);
	DoQuestCheckDelay("FirstOut_4", 4.0);
	break;


	case "FirstOut_4":
    DeleteAttribute(pchar,"PostEventQuest.questDelay.FirstOut_4");
	WaitDate("", 0, 0, 0, 2, 0);    // Кручу время
	RecalculateJumpTable();
	SetLaunchFrameFormParam("Через два часа поисков", "", 0, 6);
	LaunchFrameForm();
	DoQuestCheckDelay("FirstOut_5", 5.0);
	break;


	case "FirstOut_5":
    DeleteAttribute(pchar,"PostEventQuest.questDelay.FirstOut_5");
	AddQuestRecord("Sharlie", "5-34");
	AddCharacterExpToSkill(Pchar, "Sneak", 100);
	DoQuestReloadToLocation("fortFrance_town", "reload", "basement1", "");
	Lai_SetPlayerType(pchar);
	chrDisableReloadToLocation = false; // открыть локацию
	break;
	...
	case "FirstOut_6":
    DeleteAttribute(pchar,"PostEventQuest.questDelay.FirstOut_6");
	pchar.quest.FirstOut6.win_condition.l1 = "location";
	pchar.quest.FirstOut6.win_condition.l1.location = "fortFrance_town";
	pchar.quest.FirstOut6.win_condition.l2 = "Timer";
	pchar.quest.FirstOut6.win_condition.l2.date.day = GetAddingDataDay(0, 0, 2);
	pchar.quest.FirstOut6.win_condition.l2.date.month = GetAddingDataMonth(0, 0, 2);
	pchar.quest.FirstOut6.win_condition.l2.date.year = GetAddingDataYear(0, 0, 2);
	pchar.quest.FirstOut6.win_condition.l2.date.hour = rand(23);
	pchar.quest.FirstOut6.function = "SharlieSeabattle_agent";
	break;


	case "FirstOut_7":
    DeleteAttribute(pchar,"PostEventQuest.questDelay.FirstOut_7");
	pchar.quest.FirstOut7.win_condition.l1 = "location";
	pchar.quest.FirstOut7.win_condition.l1.location = "fortFrance_town";
	pchar.quest.FirstOut7.win_condition.l2 = "Timer";
	pchar.quest.FirstOut7.win_condition.l2.date.day = GetAddingDataDay(0, 0, 2);
	pchar.quest.FirstOut7.win_condition.l2.date.month = GetAddingDataMonth(0, 0, 2);
	pchar.quest.FirstOut7.win_condition.l2.date.year = GetAddingDataYear(0, 0, 2);
	pchar.quest.FirstOut7.win_condition.l2.date.hour = rand(23);
	pchar.quest.FirstOut7.function = "SharlieSeabattle_agent1";
	break;


	case "FirstOut_8":
    DeleteAttribute(pchar,"PostEventQuest.questDelay.FirstOut_8");
	//Посыльный ростовщика
	sld = GetCharacter(NPC_GenerateCharacter("UsurerMan", "usurer_3", "man", "man", 20, PIRATE, -1, true, ""));
	sld.Dialog.Filename = "Quest\Sharlie\OtherNPC.c";
	ChangeCharacterAddressGroup(sld, "fortFrance_town", "reload", "reload8_back");
	Lai_SetActorType(sld);
	LAi_ActorFollow(sld, characterFromId("BLAZE"), "FirstOut_9", -1);
	break;


	case "FirstOut_9":
    DeleteAttribute(pchar,"PostEventQuest.questDelay.FirstOut_9");
	sld = characterFromID("UsurerMan");
	sld.dialog.currentnode = "UsurerMan_1";
	Lai_SetActorType(sld);
	LAi_ActorDialog(sld, pchar, "", -1, 0);
	break;

	case "FirstOut_10":
    DeleteAttribute(pchar,"PostEventQuest.questDelay.FirstOut_10");
	sld = characterFromID("UsurerMan");
	Lai_SetActorType(sld);
	Lai_ActorRunToLocation(sld, "reload", "reload8_back", "none", "", "", "", -1);
	sld.lifeday = 0;
	sld = characterFromID("Seabattle_pirate");
	sld.lifeday = 0;
	Group_FindOrCreateGroup("DM_Group");
	sld = characterFromID("DiegoEnemy");
	sld.ship.type = GenerateShipExt(SHIP_LUGGER, true, sld);
	sld.ship.name = "Незаметный";
	SetBaseShipData(sld);
	sld.Ship.Mode = "pirate";
	sld.DontRansackCaptain = true;
	sld.AnalizeShips = true;
	sld.AlwaysFriend = true;
	Group_AddCharacter("DM_Group", "DiegoEnemy");
	Group_SetGroupCommander("DM_Group", "DiegoEnemy");
	Group_SetAddress("DM_Group", "Martinique", "quest_ships", "quest_ship_1");
	Group_LockTask("DM_Group")
	DoQuestCheckDelay("FirstOut_11", 5.0);
	break;


	case "FirstOut_10a":
    DeleteAttribute(pchar,"PostEventQuest.questDelay.FirstOut_10a");
	sld = characterFromID("UsurerMan");
	Lai_SetActorType(sld);
	Lai_ActorRunToLocation(sld, "reload", "reload8_back", "none", "", "", "", -1);
	sld.lifeday = 0;
	...
	case "FirstOut_11":
	DeleteAttribute(pchar,"PostEventQuest.questDelay.FirstOut_11");
	WaitDate("", 0, 0, 0, 2, 0);    // Кручу до 12 дня
	//SetCurrentTime(12, 00);
	RecalculateJumpTable();
	SetLaunchFrameFormParam("через два часа", "", 0, 6);
	LaunchFrameForm();
	DoQuestCheckDelay("FirstOut_12", 5.0);
	break;


	case "FirstOut_12":
	DeleteAttribute(pchar,"PostEventQuest.questDelay.FirstOut_12");
	pchar = GetMainCharacter(); //меняем ГГ
	SetMainCharacterIndex(GetCharacterIndex("DiegoEnemy"));
	Lai_SetPlayerType(pchar);
	LAi_SetImmortal(sld, true);    // бессмертие 
	//DoReloadCharacterToLocation("shore39", "goto", "goto3");
	DoQuestReloadToLocation("shore39", "goto", "goto3", "FirstOut_13");
	setCharacterShipLocation(pchar, "shore39");
	setWDMPointXZ("shore39");   // Корабль в бухту
	chrDisableReloadToLocation = true; // закрыть докацию
	bDisableCharacterMenu = true;   // запретить F2
	//бандиты третья группа
	for (i=1; i<+7; i++)
	  {
		sld = characterFromID("GuberWifeBandit2"+i);
		ChangeCharacterAddressGroup(sld, "shore39", "goto", "goto1");
		
	  }
	sld = GetCharacter(NPC_GenerateCharacter("FirstOutBandit", "Citiz_58", "man", "man", 1, PIRATE, -1, true, "quest"));
	sld.Dialog.Filename = "Quest\Sharlie\OtherNPC.c";
	ChangeCharacterAddressGroup(sld, "shore39", "goto", "goto2");
	sld = GetCharacter(NPC_GenerateCharacter("FirstOutBandit1", "Citiz_58", "man", "man", 1, PIRATE, -1, true, "quest"));
	sld.Dialog.Filename = "Quest\Sharlie\OtherNPC.c";
	ChangeCharacterAddressGroup(sld, "shore39", "reload", "sea");
	
	break;


	case "FirstOut_13":
	DeleteAttribute(pchar,"PostEventQuest.questDelay.FirstOut_13");
	sld = characterFromID("FirstOutBandit1");
	Lai_SetActorType(sld);
	LAi_ActorFollow(sld, characterFromId("DiegoEnemy"), "FirstOut_14", -1);
	break;


	case "FirstOut_14":
	DeleteAttribute(pchar,"PostEventQuest.questDelay.FirstOut_14");
	sld = characterFromID("FirstOutBandit1");
	sld.dialog.currentnode = "FirstOutBandit1_1";
	Lai_SetActorType(sld);
	LAi_ActorDialog(sld, pchar, "", -1, 0);
	break;
	...
	case "FirstOut_15":
	DeleteAttribute(pchar,"PostEventQuest.questDelay.FirstOut_15");
	sld = characterFromID("FirstOutBandit");
	Lai_SetActorType(sld);
	LAi_ActorFollow(sld, characterFromId("DiegoEnemy"), "FirstOut_16", -1);
	pchar.Ship.Type = SHIP_NOTUSED;
	break;


	case "FirstOut_16":
	DeleteAttribute(pchar,"PostEventQuest.questDelay.FirstOut_16");
	sld = characterFromID("FirstOutBandit");
	sld.dialog.currentnode = "FirstOutBandit_1";
	Lai_SetActorType(sld);
	LAi_ActorDialog(sld, pchar, "", -1, 0);
	break;
	...
	case "FirstOut_17":
	DeleteAttribute(pchar,"PostEventQuest.questDelay.FirstOut_17");
	pchar = GetMainCharacter(); //меняем ГГ
	SetMainCharacterIndex(GetCharacterIndex("BLAZE"));
	Lai_SetPlayerType(pchar);
	AddCharacterExpToSkill(Pchar, "Sneak", 100);
	AddCharacterExpToSkill(pchar, "Fortune", 100);
	DoQuestReloadToLocation("shore39", "goto", "goto2", "FirstOut_18");
	bDisableCharacterMenu = false;   // разрешить F2
	sld = characterFromID("FirstOutBandit");
	ChangeCharacterAddressGroup(sld, "shore39", "goto", "goto3");
	sld = characterFromID("FirstOutBandit1");
	ChangeCharacterAddressGroup(sld, "shore39", "goto", "goto3");
	break;
	...
	case "FirstOut_18":
	DeleteAttribute(pchar,"PostEventQuest.questDelay.FirstOut_18");
	//первая группа матросов
	for (i=1; i<+7; i++)
	{
		sld = GetCharacter(NPC_GenerateCharacter("SharlieshoreMen_"+i, "citiz_3"+i, "man", "man", 2, PIRATE, -1, true, "quest"));
		ChangeCharacterAddressGroup(sld, "shore39", "goto", "goto2");
	    Lai_SetActorType(sld);
	    LAi_ActorFollow(sld, characterFromId("BLAZE"), "", -1);
        
	}
	//вторая группа матросов
	for (i=1; i<+7; i++)
	{
		sld = GetCharacter(NPC_GenerateCharacter("SharlieshoreMen_1"+i, "citiz_3"+i, "man", "man", 2, PIRATE, -1, true, "quest"));
		ChangeCharacterAddressGroup(sld, "shore39", "goto", "goto4");
	    Lai_SetActorType(sld);
	    LAi_ActorFollow(sld, characterFromId("BLAZE"), "", -1);
        
	}
	sld = characterFromID("DiegoEnemy");
	sld.dialog.currentnode = "Sharlieshore_1";
	Lai_SetActorType(sld);
	LAi_ActorDialog(sld, pchar, "", -1, 0);
	//бандиты третья группа
	for (i=1; i<+7; i++)
	  {
		sld = characterFromID("GuberWifeBandit2"+i);
		Lai_SetActorType(sld);
	    LAi_ActorFollow(sld, characterFromId("DiegoEnemy"), "", -1);
	...
	case "FirstOut_19":
	DeleteAttribute(pchar,"PostEventQuest.questDelay.FirstOut_19");
	//первая группа матросов
	for (i=1; i<+7; i++)
	{
		sld = characterFromID("SharlieshoreMen_"+i);
		Lai_SetWarriorType(sld);
		LAi_group_MoveCharacter(sld, LAI_GROUP_PLAYER); //относим в группу героя
	...
	for (i=1; i<+7; i++)
	{
		sld = characterFromID("SharlieshoreMen_1"+i);
		Lai_SetWarriorType(sld);
		LAi_group_MoveCharacter(sld, LAI_GROUP_PLAYER); //относим в группу героя
	...
	LAi_SetWarriorType(sld);
	LAi_SetImmortal(sld, true); 
	LAi_group_MoveCharacter(sld, "DiegoEnemyshoreFight");
	//бандиты третья группа
	for (i=1; i<+7; i++)
	  {
		sld = characterFromID("GuberWifeBandit2"+i);
	...
	LAi_SetWarriorType(sld);
	LAi_group_MoveCharacter(sld, "DiegoEnemyshoreFight");
	LAi_group_SetRelation("DiegoEnemyshoreFight", LAI_GROUP_PLAYER, LAI_GROUP_ENEMY);
	LAi_group_FightGroups("DiegoEnemyshoreFight", LAI_GROUP_PLAYER, true);
	LAi_group_SetCheck("DiegoEnemyshoreFight", "");
	LAi_SetFightMode(pchar, true);
	LAi_SetImmortal(pchar, false);    // снятие бессмертие ГГ
	LAi_SetCheckMinHP(pchar, 5, true, "FirstOut_20");
	break;


	case "FirstOut_20":
	DeleteAttribute(pchar,"PostEventQuest.questDelay.FirstOut_20");
	//первая группа матросов
	for (i=1; i<+7; i++)
	{
		sld = characterFromID("SharlieshoreMen_"+i);
	...
	sld = characterFromID("DiegoEnemy");
	Lai_SetActorType(sld);
	LAi_ActorFollow(sld, characterFromId("BLAZE"), "FirstOut_21", -1);
	//бандиты третья группа
	for (i=1; i<+7; i++)
	  {
		sld = characterFromID("GuberWifeBandit2"+i);
	...
	case "FirstOut_21":
	DeleteAttribute(pchar,"PostEventQuest.questDelay.FirstOut_21");
	sld = characterFromID("DiegoEnemy");
	sld.dialog.currentnode = "Sharlieshore_3";
	Lai_SetActorType(sld);
	LAi_ActorDialog(sld, pchar, "", -1, 0);
	break;
	...
	case "FirstOut_22":
	DeleteAttribute(pchar,"PostEventQuest.questDelay.FirstOut_22");
	//первая группа матросов
	for (i=1; i<+7; i++)
	{
		sld = characterFromID("SharlieshoreMen_"+i);
	...
	sld = characterFromID("DiegoEnemy");
	Lai_SetActorType(sld);
	Lai_ActorRunToLocation(sld, "goto", "goto3", "none", "", "", "", -1);
	ChangeCharacterAddressGroup(sld, "", "", "");
	sld.lifeday = 0;
	Group_DeleteGroup("DM_Group");
	//бандиты третья группа
	for (i=1; i<+7; i++)
	  {
		sld = characterFromID("GuberWifeBandit2"+i);
	...
	Lai_ActorRunToLocation(sld, "reload", "sea", "none", "", "", "", -1);
	sld.lifeday = 0;
	DoQuestCheckDelay("FirstOut_23", 4.0);
	break;


	case "FirstOut_23":
	DeleteAttribute(pchar,"PostEventQuest.questDelay.FirstOut_23");
	WaitDate("", 0, 0, 7, 0, 0);    // Кручу до 12 дня
	SetCurrentTime(12, 00);
	RecalculateJumpTable();
	SetLaunchFrameFormParam("через неделю", "", 0, 6);
	LaunchFrameForm();
	DoQuestCheckDelay("FirstOut_24", 4.0);
	break;


	case "FirstOut_24":
	DeleteAttribute(pchar,"PostEventQuest.questDelay.FirstOut_24");
	Lai_SetPlayerType(pchar);
	LAi_SetCurHPMax(pchar);
	AddCharacterHealth(pchar, 36);
	LAi_SetImmortal(pchar, false);    // снятие бессмертия ГГ
	DoQuestReloadToLocation("fortfrance_tavern_upstairs", "goto", "goto1", "FirstOut_25");
	chrDisableReloadToLocation = false; // открыть докацию
	
	sld = GetCharacter(NPC_GenerateCharacter("SenPierDoctor", "Citiz_11", "man", "man", 1, PIRATE, -1, true, ""));
	sld.Dialog.Filename = "Quest\Sharlie\OtherNPC.c";
	ChangeCharacterAddressGroup(sld, "fortfrance_tavern_upstairs", "goto", "goto2");
	sld = GetCharacter(NPC_GenerateCharacter("Lucil", "women_24", "woman", "woman", 1, PIRATE, -1, true, "quest"));
	sld.name = "Люсиль";
	sld.lastname = "Монтань";
	sld.Dialog.Filename = "Quest\Sharlie\OtherNPC.c";
	ChangeCharacterAddressGroup(sld, "fortfrance_tavern_upstairs", "goto", "goto4");
	
	break;


	case "FirstOut_25":
	DeleteAttribute(pchar,"PostEventQuest.questDelay.FirstOut_25");
	sld = characterFromID("Lucil");
	Lai_SetActorType(sld);
	LAi_ActorTurnToCharacter(sld, characterFromID("BLAZE"));
	sld = characterFromID("SenPierDoctor");
	sld.dialog.currentnode = "SenPierDoctor_1";
	Lai_SetActorType(sld);
	LAi_ActorDialog(sld, pchar, "", -1, 0);
	break;
	...
	case "FirstOut_26":
	DeleteAttribute(pchar,"PostEventQuest.questDelay.FirstOut_26");
	sld = characterFromID("SenPierDoctor");
	Lai_SetActorType(sld);
	Lai_ActorRunToLocation(sld, "reload", "reload1_back", "none", "", "", "", -1);
	sld.lifeday = 0;
	sld = characterFromID("Lucil");
	sld.dialog.currentnode = "LucilDoctor_1";
	Lai_SetActorType(sld);
	LAi_ActorDialog(sld, pchar, "", -1, 0);
	break;
	...
	case "FirstOut_27":
	DeleteAttribute(pchar,"PostEventQuest.questDelay.FirstOut_27");
	AddQuestRecord("Sharlie", "5-42");
	pchar.questTemp.Sharlie = "usurerblackmail";
	sld = characterFromID("Lucil");
	Lai_SetActorType(sld);
	Lai_ActorRunToLocation(sld, "reload", "reload1_back", "none", "", "", "", -1);
	break;
...
////////////////////////////////////////////Случай в Бастере////////////////////////////////////////////////////
	  ...
	  case "BasterEvent_1":
	  sld = GetCharacter(NPC_GenerateCharacter("Francua_Sein", "citiz_8", "man", "man", 3, FRANCE, -1, true, ""));
	  sld.name = "Франсуа";
	  sld.lastname = "Сейн";
	  sld.dialog.filename = "NewPapka\BasterEvent\FrancuaSein.c";
	  LAi_SetStayType(sld);
	  ChangeCharacterAddressGroup(sld, "", "", "");
	  // бандиты в Бастере
	  //1
	  sld = GetCharacter(NPC_GenerateCharacter("Jean_Taro", "pirate_6", "man", "man", 3, PIRATE, -1, true, "quest"));
	  sld.name = "Жан";
	  sld.lastname = "Таро";
	  sld.dialog.filename = "NewPapka\BasterEvent\JeanTaro.c";
	  LAi_SetStayType(sld);
	  ChangeCharacterAddressGroup(sld, "", "", "");
	  //2
	  sld = GetCharacter(NPC_GenerateCharacter("Klod_Taro", "Citiz_23", "man", "man", 3, PIRATE, -1, true, "quest"));
	  sld.name = "Клод";
	  sld.lastname = "Таро";
	  sld.dialog.filename = "NewPapka\BasterEvent\KlodTaro.c";
	  LAi_SetStayType(sld);
	  ChangeCharacterAddressGroup(sld, "", "", "");
	  //Андрэ Рэно
	  sld = GetCharacter(NPC_GenerateCharacter("Andre_Reno", "Banker_1_1", "man", "man", 20, PIRATE, -1, true, "quest"));
	  sld.name = "Андрэ";
	  sld.lastname = "Рэно";
	  sld.dialog.filename = "NewPapka\BasterEvent\AndreReno.c";
	  LAi_SetStayType(sld);
	  ChangeCharacterAddressGroup(sld, "", "", "");
	  // Телохранитель 1
	  sld = GetCharacter(NPC_GenerateCharacter("BodyG_First", "Citiz_58", "man", "man", 15, PIRATE, -1, true, "quest"));
	  sld.name = "Телохранитель";
	  sld.lastname = "Первый";
	  sld.dialog.filename = "NewPapka\BasterEvent\BG1.c";
	  LAi_SetStayType(sld);
	  ChangeCharacterAddressGroup(sld, "", "", "");
	  // Телохранитель 2
	  sld = GetCharacter(NPC_GenerateCharacter("BodyG_Second", "Citiz_58", "man", "man", 15, PIRATE, -1, true, "quest"));
	  sld.name = "Телохранитель";
	  sld.lastname = "Второй";
	  sld.dialog.filename = "NewPapka\BasterEvent\BG2.c";
	  LAi_SetStayType(sld);
	  ChangeCharacterAddressGroup(sld, "", "", "");

	  // Телохранитель Сейна 1
	  sld = GetCharacter(NPC_GenerateCharacter("BodyGSein_First", "quest_pirat_1", "man", "man", 5, PIRATE, -1, true, "quest"));
	  sld.name = "Жерар";
	  sld.lastname = "Ловье";
	  sld.dialog.filename = "NewPapka\BasterEvent\BGSein1.c";
	  LAi_SetStayType(sld);
	  ChangeCharacterAddressGroup(sld, "", "", "");
	  // Телохранитель Сейна 2
	  sld = GetCharacter(NPC_GenerateCharacter("BodyGSein_Second", "quest_pirat_2", "man", "man", 5, PIRATE, -1, true, "quest"));
	  sld.name = "Симон";
	  sld.lastname = "Постер";
	  sld.dialog.filename = "NewPapka\BasterEvent\BGSein2.c";
	  LAi_SetStayType(sld);
	  ChangeCharacterAddressGroup(sld, "", "", "");
	  
	  // Неизвестный
	  sld = GetCharacter(NPC_GenerateCharacter("Mask1", "Citiz_58", "man", "man", 3, PIRATE, -1, true, "quest"));
	  sld.name = "Маска";
	  sld.lastname = "";
	  sld.dialog.filename = "NewPapka\BasterEvent\BGSein2.c";
	  TakeNItems(sld, "potion2", 20);
	  ...
	  EquipCharacterbyItem(sld, "blade_03");
	  SetSPECIAL (sld, 7, 10, 10, 8, 7, 8, 7);
	  LAi_SetHP(sld, 120.0, 120.0);
      SetSelfSkill(sld, 50, 20, 20, 20, 10);
      SetShipSkill(sld, 10, 10, 10, 10, 9, 6, 8, 9, 5);
	
	  pchar.quest.BasterEvent1.win_condition.l1 = "location";
	  pchar.quest.BasterEvent1.win_condition.l1.location = "Baster_town";
	  pchar.quest.BasterEvent1.win_condition = "BasterEvent_2";
	  break;
	  ...
	  bQuestDisableMapEnter = true;  // закрыть карту
	  chrDisableReloadToLocation = true; // закрыть локацию
	  //LAi_SetImmortal(pchar, true);    // бессмертие ГГ
	  sld = characterFromID("Francua_Sein");
	  LAi_SetImmortal(sld, true);    // бессмертие Сейна
	  ChangeCharacterAddressGroup(sld, "baster_town", "goto", "goto11");
	  Lai_SetActorType(sld);
	  LAi_ActorFollow(sld, characterFromId("BLAZE"), "BasterEvent_3", 1);
	  break;
	  ...
	  sld.dialog.currentnode = "First Time";
	  LAi_ActorDialog(sld, pchar, "", -1, 0);
	  sld = characterFromID("Jean_Taro");
	  ChangeCharacterAddressGroup(sld, "baster_town", "goto", "goto1");
	  Lai_SetActorType(sld);
	  LAi_ActorFollow(sld, characterFromId("BLAZE"), "", -1);
	  for (i=1; i<+5; i++)
	  {
		sld = GetCharacter(NPC_GenerateCharacter("BSTPirates"+i, "pirate_"+i, "man", "man", 3, PIRATE, -1, true, "quest"));
		ChangeCharacterAddressGroup(sld, "baster_town", "goto", "goto10");
		Lai_SetActorType(sld);
	    LAi_ActorFollow(sld, characterFromId("BLAZE"), "", -1);
	  }
	  break;
	  ...
	  case "BasterEvent_4":   // отказ от квеста
	  sld = characterFromID("Francua_Sein");
	  Lai_ActorRunToLocation(sld, "reload", "reload4_back", "none", "", "", "", -1);
	  ...
	  case "BasterEvent_5": 
	  AddQuestRecord("BasterEvent", "1");
	  sld = characterFromID("Jean_Taro");
	  Lai_ActorRunToLocation(sld, "reload", "reload4_back", "none", "", "", "", -1);
	  for (i=1; i<+5; i++)
	  {
		sld = GetCharacter(NPC_GenerateCharacter("BSTPirates"+i, "pirate_"+i, "man", "man", 3, PIRATE, -1, true, "quest"));
		Lai_ActorRunToLocation(sld, "reload", "reload4_back", "none", "", "", "BasterEvent_6", -1);
	  }
	  break;

	  case "BasterEvent_6":      // завершение отказа от квеста
	  for (i=1; i<+5; i++)
	  {
		sld = GetCharacter(NPC_GenerateCharacter("BSTPirates"+i, "pirate_"+i, "man", "man", 3, PIRATE, -1, true, "quest"));
		ChangeCharacterAddressGroup(sld, "", "", "");
	  ...
	  case "BasterEvent_7":     // продолжение квеста
	  sld = characterFromID("Francua_Sein");
	  LAi_ActorRunToLocator(sld, "reload", "reload1_back", "", -1);
	  sld = characterFromID("Jean_Taro");
	  sld.dialog.currentnode = "fight";
	  Lai_SetActorType(sld);
	  LAi_ActorDialog(sld, pchar, "", 1, 0);
	  break;
	  ...
	  sld = characterFromID("Jean_Taro");
	  LAi_SetWarriorType(sld);
	  LAi_group_MoveCharacter(sld, "BasterFight");
	  LAi_SetCheckMinHP(sld, 25, true, "BasterEvent_81");
	  for (i=1; i<+5; i++)
	  {
		sld = GetCharacter(NPC_GenerateCharacter("BSTPirates"+i, "pirate_"+i, "man", "man", 3, PIRATE, -1, true, "quest"));
		LAi_group_MoveCharacter(sld, "BasterFight");
	  }
	  LAi_group_SetRelation("BasterFight", LAI_GROUP_PLAYER, LAI_GROUP_ENEMY);
	  LAi_group_FightGroups("BasterFight", LAI_GROUP_PLAYER, true);
	  LAi_SetFightMode(pchar, true);
	  LAi_group_SetCheck("BasterFight", "BasterEvent_9");
	  break;

	  case "BasterEvent_81":
	  log_info("Ты за это заплатишь, урод!");
	  sld = characterFromID("Jean_Taro");
	  Lai_SetActorType(sld);
	  Lai_ActorRunToLocation(sld, "quest", "quest1", "none", "", "", "BasterEvent_9", -1);
	  break;
	  ...
	  AddCharacterExpToSkill(Pchar, "Leadership", 100);
	  sld = characterFromID("Francua_Sein");
	  sld.dialog.currentnode = "AfterVictory_1";
	  LAi_ActorDialog(sld, pchar, "", -1, 0);
	  break;
	  ...
	  case "BasterEvent_10":
	  chrDisableReloadToLocation = false; // открыть локацию
	  AddQuestRecord("BasterEvent", "3");
	  sld = characterFromID("Francua_Sein");
	  LAi_SetCitizenType(sld);
	  //Lai_SetActorType(pchar);
	  //pchar.Dialog.CurrentNode = "demor_basterdream";
	  //SelfDialog(pchar);
	  sld = characterFromID("BasTer_tavernkeeper");
	  sld.quest.BasterEvent = true;
	  LocatorReloadEnterDisable("baster_town", "HouseSP1", true); //закрыть дом Фадея
	  break;


	  case "BasterEvent_101":     // отказ от предложения
	  AddQuestRecord("BasterEvent", "2");
	  sld = characterFromID("Francua_Sein");
	  LAi_SetCitizenType(sld);
	  sld.lifeday = 0;
	  chrDisableReloadToLocation = false; // открыть локацию
	  ...
	  case "BasterEvent_11"://не требуется без разговора с собой
	  Lai_SetPlayerType(pchar);
	  pchar.Dialog.CurrentNode = "First Time";
	  DoReloadCharacterToLocation("baster_tavern", "reload", "reload1_back");
	  SetQuestHeader("BasterEvent");
	  LocatorReloadEnterDisable("baster_town", "HouseSP1", true); //закрыть дом Фадея
	  break;
	  ...
	  case "BasterEvent_12":
	  sld = characterFromID("Jean_Taro");
	  ChangeCharacterAddressGroup(sld, "baster_tavern", "goto", "goto1");
	  Lai_SetActorType(sld);
	  LAi_ActorFollow(sld, characterFromId("BLAZE"), "BasterEvent_13", -1);
	  for (i=1; i<+5; i++)
	  {
		sld = GetCharacter(NPC_GenerateCharacter("BSTPirates"+i, "pirate_"+i, "man", "man", 3, PIRATE, -1, true, "quest"));
		ChangeCharacterAddressGroup(sld, "baster_tavern", "goto", "goto2");
		Lai_SetActorType(sld);
	    LAi_ActorFollow(sld, characterFromId("BLAZE"), "", -1);
	  }
	  break;
	  ...
	  case "BasterEvent_13":
	  sld = characterFromID("Jean_Taro");
	  sld.dialog.currentnode = "fight2";
	  Lai_SetActorType(sld);
	  LAi_ActorDialog(sld, pchar, "", 1, 0);
	  sld = characterFromID("Baster_Waitress");
	  Lai_SetActorType(sld);
	  Lai_ActorRunToLocator(sld, "tables", "stay3", "BasterEvent_13_Waitress", -1);
	  break;


	  case "BasterEvent_13_Waitress":
	  sld = characterFromID("Baster_Waitress");
	  Lai_SetStunnedTypeNoGroup(sld);
	  break;
	  ...
	  LAi_LocationFightDisable(&Locations[FindLocation(pchar.location)], false);  // разрешить драться
	  sld = characterFromID("Jean_Taro");
	  LAi_SetImmortal(sld, false);    // нет бессмертия
	  LAi_SetWarriorType(sld);
	  LAi_group_MoveCharacter(sld, "BasterFight1");
	  for (i=1; i<+5; i++)
	  {
		sld = GetCharacter(NPC_GenerateCharacter("BSTPirates"+i, "pirate_"+i, "man", "man", 3, PIRATE, -1, true, "quest"));
		LAi_group_MoveCharacter(sld, "BasterFight1");
	  }
	  LAi_group_SetRelation("BasterFight1", LAI_GROUP_PLAYER, LAI_GROUP_ENEMY);
	  LAi_group_FightGroups("BasterFight1", LAI_GROUP_PLAYER, true);
	  LAi_SetFightMode(pchar, true);
	  LAi_group_SetCheck("BasterFight1", "BasterEvent_14a");
	  break;


	  case "BasterEvent_14a":
	  LAi_LocationFightDisable(&Locations[FindLocation(pchar.location)], true);  // запретить драться
	  LAi_grp_alarmactive = false;
	  DoQuestCheckDelay("BasterEvent_15", 2.0);
	  break;


	  case "BasterEvent_15":
	  LAi_LocationFightDisable(&Locations[FindLocation(pchar.location)], true);  // запретить драться
	  pchar.quest.main_line = "BasterEvent1";
	  LAi_grp_alarmactive = false;
	  SetLaunchFrameFormParam("вы укрылись в случайном доме....", "", 5, 8);
	  LaunchFrameForm();
	  WaitDate("", 0, 0, 0, 0, 30); // Крутану время для снятия тревоги
      RecalculateJumpTable();
	  DoQuestCheckDelay("BasterEvent_16", 7.0);
	  break;
	  ...
	  sld = characterFromID("Baster_Waitress");
	  LAi_SetWaitressType(sld);
	  DoQuestReloadToLocation("Baster_houseF1", "goto", "goto1", "");
	  AddCharacterExpToSkill(pchar, "Fortune", 100);
	  // Аморе
	  sld = GetCharacter(NPC_GenerateCharacter("Amore", "off_fra_4", "man", "man", 3, PIRATE, -1, true, "quest"));
	  sld.name = "Жан-Люк";
	  sld.lastname = "Аморе";
	  sld.dialog.filename = "NewPapka\BasterEvent\Amore.c";
	  TakeNItems(sld, "potion2", 20);
	  GiveItem2Character(sld, "pistol1");
	  GiveItem2Character(sld, "blade_03");
	  EquipCharacterbyItem(sld, "pistol1");
      ...
      SetSelfSkill(sld, 50, 20, 20, 20, 10);
      SetShipSkill(sld, 10, 10, 10, 10, 9, 6, 8, 9, 5);
	  ChangeCharacterAddressGroup(sld, "Baster_houseF1", "goto", "goto3");
	  sld.dialog.currentnode = "First Time";
	  Lai_SetActorType(sld);
	  LAi_ActorDialog(sld, pchar, "", 1, 0);
	  chrDisableReloadToLocation = false; // открыть локацию
	  ...
	  sld.dialog.currentnode = "House_dialog";
	  ...
	  SetLaunchFrameFormParam("Наступает ночь....", "", 0, 6);
	  LaunchFrameForm();
	  DoQuestCheckDelay("BasterEvent_19", 5.0);
	  break;


	  case "BasterEvent_19":
	  sld = characterFromID("Amore");
	  sld.dialog.currentnode = "House_dialog1";
	  Lai_SetActorType(sld);
	  LAi_ActorDialog(sld, pchar, "", 1, 0);
	  break;
	  ...
	  case "BasterEvent_20":
	  SetLaunchFrameFormParam("через несколько минут у ворот....", "", 5, 8);
	  LaunchFrameForm();
	  WaitDate("", 0, 0, 0, 0, 30); // Крутану несколько минут
      RecalculateJumpTable();
	  DoQuestCheckDelay("BasterEvent_21", 7.0);
	  break;


	  case "BasterEvent_21":
	  DoReloadCharacterToLocation("baster_ExitTown", "reload", "reload4");
	  sld = characterFromID("Amore");
	  ChangeCharacterAddressGroup(sld, "baster_ExitTown", "goto", "goto3");
	  Lai_SetActorType(sld);
	  LAi_ActorFollow(sld, characterFromId("BLAZE"), "BasterEvent_22", -1);
	  
	  for (i=1; i<=7; i++)
	  {
		sld = GetCharacter(NPC_GenerateCharacter("BSTPirates"+i, "pirate_"+i, "man", "man", 3, PIRATE, -1, true, "quest"));
		ChangeCharacterAddressGroup(sld, "baster_ExitTown", "goto", "goto6");
		Lai_SetActorType(sld);
	    LAi_ActorFollow(sld, characterFromId("BLAZE"), "", -1);
	  }
	  break;
	  ...
	  case "BasterEvent_22":
	  sld = characterFromID("Amore");
	  sld.dialog.currentnode = "Gate_Fight";
	  Lai_SetActorType(sld);
	  LAi_ActorDialog(sld, pchar, "", -1, 0);
	  break;
	  ...
	  case "BasterEvent_23":
	  sld = characterFromID("Amore");
	  LAi_SetImmortal(sld, true);    // бессмертие Аморе
	  LAi_SetWarriorType(sld);
	  LAi_group_MoveCharacter(sld, LAI_GROUP_PLAYER); //относим в группу героя
	  //LAi_SetCheckMinHP(sld, 25, true, "BasterEvent_24");
	  
	  for (i=1; i<=7; i++)
	  {
		sld = GetCharacter(NPC_GenerateCharacter("BSTPirates"+i, "pirate_"+i, "man", "man", 3, PIRATE, -1, true, "quest"));
		LAi_group_MoveCharacter(sld, "BastJungle");
	  }
	  LAi_group_SetRelation("BastJungle", LAI_GROUP_PLAYER, LAI_GROUP_ENEMY);
	  LAi_group_FightGroups("BastJungle", LAI_GROUP_PLAYER, true);
	  
	  LAi_SetFightMode(pchar, true);
	  LAi_group_SetCheck("BastJungle", "BasterEvent_24");
	  break;
	  ...
	  AddComplexSelfExpToScill(50, 50, 50, 50);
	  AddCharacterExpToSkill(pchar, GetEquipedBladeType(pchar), 50);
	  DoQuestCheckDelay("BasterEvent_25", 2.0);
	  break;


	  case "BasterEvent_24a":
	  log_info("Я ранен. Надо отступать!");
	  sld = characterFromID("Amore");
	  Lai_SetActorType(sld);
	  ...
	  case "BasterEvent_25":
	  SetLaunchFrameFormParam("через несколько часов....", "", 5, 8);
	  LaunchFrameForm();
	  WaitDate("", 0, 0, 0, 7, 0); // Крутану несколько часов
      RecalculateJumpTable();
	  DoQuestCheckDelay("BasterEvent_26", 7.0);
	  break;



	  case "BasterEvent_26":
	  DoReloadCharacterToLocation("Baster_houseF1", "goto", "goto1");
	  sld = characterFromID("Amore");
	  ChangeCharacterAddressGroup(sld, "Baster_houseF1", "goto", "goto2");
	  sld.dialog.currentnode = "AfterGate_Fight";
	  Lai_SetActorType(sld);
	  LAi_ActorDialog(sld, pchar, "", 1, 0);
	  pchar.quest.main_line = "BasterEvent2";
	  break;


	  case "BasterEvent_27":
	  Group_FindOrCreateGroup("KT_Group");
	  sld = characterFromID("Klod_Taro");
	  sld.DeckDialogNode = "Klod_Deck";
	  sld.ship.type = GenerateShipExt(SHIP_LUGGER, true, sld);
	  sld.ship.name = "Фартовый";
	  SetBaseShipData(sld);
	  sld.Ship.Mode = "pirate";
	  sld.DontRansackCaptain = true;
	  sld.AnalizeShips = true;
	  sld.AlwaysFriend = true;
	  Group_AddCharacter("KT_Group", "Klod_Taro");
	  Group_SetGroupCommander("KT_Group", "Klod_Taro");
	  Group_SetTaskRunAway("KT_Group", PLAYER_GROUP); //пусть погоняется
	  Group_SetAddress("KT_Group", "Guadeloupe", "quest_ships", "quest_ship_3");
	  Group_LockTask("KT_Group")
	  break;
	  ...
	  LAi_LocationFightDisable(&Locations[FindLocation(pchar.location)], false);  // разрешить драться
	  sld = characterFromID("Klod_Taro");
	  LAi_SetImmortal(sld, true);    // бессмертие Клода Таро
	  LAi_group_MoveCharacter(sld, "BastDeck");
	  sld = characterFromID("saylor_01");
	  LAi_group_MoveCharacter(sld, "BastDeck");
	  sld = characterFromID("saylor_02");
	  LAi_group_MoveCharacter(sld, "BastDeck");
	  sld = characterFromID("saylor_03");
	  LAi_group_MoveCharacter(sld, "BastDeck");
	  sld = characterFromID("saylor_04");
	  LAi_group_MoveCharacter(sld, "BastDeck");
	  LAi_group_SetRelation("BastDeck", LAI_GROUP_PLAYER, LAI_GROUP_ENEMY);
	  LAi_group_FightGroups("BastDeck", LAI_GROUP_PLAYER, true);
	  LAi_SetFightMode(pchar, true);
	  pchar.quest.BasterEvent28.win_condition.l1 = "NPC_death";
	  pchar.quest.BasterEvent28.win_condition.l1.character = "saylor_01";
	  pchar.quest.BasterEvent28.win_condition.l2 = "NPC_death";
	  pchar.quest.BasterEvent28.win_condition.l2.character = "saylor_02";
	  pchar.quest.BasterEvent28.win_condition.l3 = "NPC_death";
	  pchar.quest.BasterEvent28.win_condition.l3.character = "saylor_03";
	  pchar.quest.BasterEvent28.win_condition.l4 = "NPC_death";
	  pchar.quest.BasterEvent28.win_condition.l4.character = "saylor_04";
	  pchar.quest.BasterEvent28.win_condition = "BasterEvent_29";
	  break;


	  case "BasterEvent_29":
	  sld = characterFromID("Klod_Taro");
	  LAi_SetImmortal(sld, false);    // отключение бессмертия Клода Таро
	  LAi_SetCheckMinHP(sld, 25, true, "BasterEvent_30");
	  break;
	  ...
	  LAi_SetFightMode(pchar, false);
	  sld = characterFromID("Klod_Taro");
	  sld.dialog.currentnode = "After_FightDeck";
	  Lai_SetActorType(sld);
	  LAi_ActorDialog(sld, pchar, "", -1, 0);
	  break;
	  ...
	  case "BasterEvent_31":
	  AddQuestRecord("BasterEvent", "9");
	  Island_SetReloadEnableGlobal("Guadeloupe", false);  // нельзя высаживаться на остров
	  sld = characterFromID("Klod_Taro");
	  LAi_SetImmortal(sld, false);    // снятие бессмертия Клода Таро
	  Lai_ActorRunToLocation(sld, "reload", "reload1", "none", "", "", "", -1);
	  Group_FindOrCreateGroup("KT_Group");
	  sld.AlwaysFriend = false;
	  sld.ship.mode = "war";
	  sld.AlwaysEnemy = true;
	  Group_SetType("KT_Group", "war");
	  LAi_group_SetRelation("KT_Group", LAI_GROUP_PLAYER, LAI_GROUP_ENEMY);
	  LAi_group_FightGroups("KT_Group", LAI_GROUP_PLAYER, true);
	  Group_SetTaskAttack("KT_Group", PLAYER_GROUP);
	  Group_LockTask("KT_Group");
	  pchar.quest.BasterEvent31.win_condition.l1 = "NPC_death";
	  pchar.quest.BasterEvent31.win_condition.l1.character = "Klod_Taro";
	  pchar.quest.BasterEvent31.win_condition = "BasterEvent_32";
	  break;


	  case "BasterEvent_32":
	  AddQuestRecord("BasterEvent", "10");
	  AddCharacterExpToSkill(Pchar, "Leadership", 100);
	  Island_SetReloadEnableGlobal("Guadeloupe", true);  // можно высаживаться на остров
	  pchar.quest.BasterEvent32.win_condition.l1 = "location";
	  pchar.quest.BasterEvent32.win_condition.l1.location = "Baster_town";
	  pchar.quest.BasterEvent32.win_condition = "BasterEvent_33";
	  break;
	  ...
	  ChangeCharacterAddressGroup(sld, "Baster_town", "goto", "goto10");
	  Lai_SetActorType(sld);
	  LAi_ActorFollow(sld, characterFromId("BLAZE"), "BasterEvent_34", -1);
	  break;


	  case "BasterEvent_34":
	  sld = characterFromID("Amore");
	  sld.dialog.currentnode = "AfterSea_Fight";
	  Lai_SetActorType(sld);
	  LAi_ActorDialog(sld, pchar, "", -1, 0);
	  break;
	  ...
	  case "BasterEvent_35":
	  AddQuestRecord("BasterEvent", "11");
	  sld = characterFromID("Amore");
	  Lai_SetActorType(sld);
	  Lai_ActorRunToLocation(sld, "reload", "reload6_back", "none", "", "", "BasterEvent_36", -1);
	  break;

	  case "BasterEvent_36":
	  SetLaunchFrameFormParam("Вы поднялись по лестнице в кабинет", "", 5, 8);
	  LaunchFrameForm();
	  WaitDate("", 0, 0, 0, 0, 30); // Крутану несколько минут
      RecalculateJumpTable();
	  DoQuestCheckDelay("BasterEvent_37", 7.0);
	  break;


	  case "BasterEvent_37":
	  DoReloadCharacterToLocation("commonPirateResidence", "goto", "goto1");
	  AddCharacterExpToSkill(Pchar, "Sneak", 200);
	  sld = characterFromID("Amore");
	  ChangeCharacterAddressGroup(sld, "commonPirateResidence", "goto", "goto1");
	  LAi_SetWarriorType(sld);
	  LAi_group_MoveCharacter(sld, LAI_GROUP_PLAYER); //относим в группу героя
	  sld = characterFromID("Andre_Reno");
	  ChangeCharacterAddressGroup(sld, "commonPirateResidence", "sit", "sit1");
	  GiveItem2Character(sld, "SeinDocument");
	  LAi_SetHuberType(sld);
	  sld = characterFromID("BodyG_First");
	  ChangeCharacterAddressGroup(sld, "commonPirateResidence", "goto", "goto2");
	  LAi_SetWarriorType(sld);
	  LAi_group_MoveCharacter(sld, "BodyG_GROUP");
	  sld = characterFromID("BodyG_Second");
	  ChangeCharacterAddressGroup(sld, "commonPirateResidence", "goto", "goto2");
	  LAi_SetWarriorType(sld);
	  LAi_group_MoveCharacter(sld, "BodyG_GROUP");
	  LAi_group_SetRelation("BodyG_GROUP", LAI_GROUP_PLAYER, LAI_GROUP_ENEMY);
	  LAi_group_FightGroups("BodyG_GROUP", LAI_GROUP_PLAYER, true);
	  
	  LAi_SetFightMode(pchar, true);
	  LAi_group_SetCheck("BodyG_GROUP", "BasterEvent_38");
	  pchar.quest.BasterEvent37.win_condition.l1 = "NPC_death";
	  pchar.quest.BasterEvent37.win_condition.l1.character = "BodyG_First";
	  pchar.quest.BasterEvent37.win_condition.l2 = "NPC_death";
	  pchar.quest.BasterEvent37.win_condition.l2.character = "BodyG_Second";
	  pchar.quest.BasterEvent37.win_condition = "BasterEvent_38";
	  break;
	  ...
	  sld = characterFromID("Amore");
	  Lai_SetActorType(sld);
      LAi_ActorTurnToCharacter(sld, characterFromID("Andre_Reno"));
	  break;
	  ...
	  Lai_SetPlayerType(pchar);
	  sld = characterFromID("Amore");
	  sld.dialog.currentnode = "AfterFightCabinet_1";
	  LAi_ActorDialog(sld, pchar, "", -1, 0);
	  ...
	  case "BasterEvent_40":
	  sld = characterFromID("Andre_Reno");
	  sld.dialog.currentnode = "Last Time";
	  Lai_SetActorType(pchar);
	  LAi_ActorDialogNow(pchar, sld, "", -1);
	  break;
	  ...
	  sld = characterFromID("Amore");
	  LAi_SetStayType(sld);
	  sld.dialog.currentnode = "AfterFightCabinet_2";
	  Lai_SetActorType(pchar);
	  LAi_ActorDialogNow(pchar, sld, "", -1);
	  break;
	  ...
	  ChangeCharacterAddressGroup(sld, "commonPirateResidence", "goto", "goto1");
	  LAi_SetWarriorType(sld);
	  LAi_group_MoveCharacter(sld, "Reno_GROUP");
	  LAi_group_SetRelation("Reno_GROUP", LAI_GROUP_PLAYER, LAI_GROUP_ENEMY);
	  LAi_group_FightGroups("Reno_GROUP", LAI_GROUP_PLAYER, true);
	  LAi_SetFightMode(pchar, true);
	  LAi_group_SetCheck("Reno_GROUP", "BasterEvent_43");
	  break;


	  case "BasterEvent_43":
	  sld = characterFromID("Amore");
	  sld.dialog.currentnode = "AfterFightCabinet_3";
	  Lai_SetActorType(sld);
	  LAi_ActorDialog(sld, pchar, "", -1, 0);
	  break;
	  ...
	  case "BasterEvent_44":
	  pchar.quest.BasterEvent44.win_condition.l1 = "locator";
	  pchar.quest.BasterEvent44.win_condition.l1.location = "commonPirateResidence";
	  pchar.quest.BasterEvent44.win_condition.l1.locator_group = "reload";
	  pchar.quest.BasterEvent44.win_condition.l1.locator = "reload2";
	  pchar.quest.BasterEvent44.win_condition = "BasterEvent_45";
	  break;


	  case "BasterEvent_45":
	  SetLaunchFrameFormParam("Вы спускаетесь по лестнице в город", "", 5, 8);
	  LaunchFrameForm();
	  WaitDate("", 0, 0, 0, 0, 20); // Крутану несколько минут
      RecalculateJumpTable();
	  DoQuestCheckDelay("BasterEvent_46", 3.0);
	  break;


	  case "BasterEvent_46":
	  DoReloadCharacterToLocation("Baster_town", "goto", "goto2");
	  sld = characterFromID("Amore");
	  ChangeCharacterAddressGroup(sld, "Baster_town", "goto", "goto2");
	  sld.dialog.currentnode = "AfterFightCabinet_4";
	  Lai_SetActorType(sld);
	  LAi_ActorDialog(sld, pchar, "", -1, 0);
	  break;
	  ...
	  case "BasterEvent_47":
	  AddQuestRecord("BasterEvent", "12");
	  sld = characterFromID("Francua_Sein");
	  sld.dialog.currentnode = "GetDocuments";
	  sld = characterFromID("Amore");
	  Lai_SetActorType(sld);
	  Lai_ActorRunToLocation(sld, "reload", "houseF1", "none", "", "", "BasterEvent_47Amore", -1);
	  break;


	  case "BasterEvent_47Amore":
	  sld = characterFromID("Amore");
	  ChangeCharacterAddressGroup(sld, "Baster_houseF1", "goto", "goto2");
	  sld.dialog.currentnode = "Second Time";
	  LAi_SetCitizenType(sld);
	  ...
	  case "BasterEvent_48":
	  AddQuestRecord("BasterEvent", "13");
	  sld = characterFromID("Francua_Sein");
	  Lai_SetActorType(sld);
	  Lai_ActorRunToLocation(sld, "reload", "gate_back", "none", "", "", "", -1);
	  pchar.quest.BasterEvent48.win_condition.l1 = "Timer";
	  pchar.quest.BasterEvent48.win_condition.l1.date.day = GetAddingDataDay(0, 0, 1);
	  pchar.quest.BasterEvent48.win_condition.l1.date.month = GetAddingDataMonth(0, 0, 1);
	  pchar.quest.BasterEvent48.win_condition.l1.date.year = GetAddingDataYear(0, 0, 1);
	  pchar.quest.BasterEvent48.win_condition.l1.date.hour = rand(23);
	  pchar.quest.BasterEvent48.win_condition = "BasterEvent_49";
	  break;


	  case "BasterEvent_49":
	  sld = characterFromID("Francua_Sein");
	  ChangeCharacterAddressGroup(sld, "mayak4", "goto", "goto18");
	  sld.dialog.currentnode = "GetDocuments_5";
	  Lai_SetStayType(sld);
	  break;


	  case "BasterEvent_50":
	  AddQuestRecord("BasterEvent", "14");
	  sld = characterFromID("Francua_Sein");
	  Lai_SetActorType(sld);
	  Lai_ActorRunToLocation(sld, "reload", "reload2", "none", "", "", "", -1);
      Lai_SetActorType(pchar);
	  Lai_ActorRunToLocation(pchar, "goto", "goto1", "none", "", "", "BasterEvent_51", -1);
	  setCharacterShipLocation(pchar, "Baster_town");
	  setWDMPointXZ("Baster_town");   // Корабль в бухту
	  break;


	  case "BasterEvent_51":
	  SetLaunchFrameFormParam("Спустя пару часов", "", 5, 8);
	  LaunchFrameForm();
	  WaitDate("", 0, 0, 0, 2, 0); // Крутану несколько минут
      RecalculateJumpTable();
	  DoQuestCheckDelay("BasterEvent_52", 3.0);
	  break;


	  case "BasterEvent_52":
	  pchar = GetMainCharacter(); //меняем ГГ
	  SetMainCharacterIndex(GetCharacterIndex("Mask1"));
	  Lai_SetPlayerType(pchar);
	  DoReloadCharacterToLocation("mayak4", "reload", "reload1");
	  chrDisableReloadToLocation = true; // закрыть докацию
	  //bDisableCharacterMenu = true;   // запретить F2
	  AddQuestRecord("BasterEventMask", "1");
	  sld = characterFromID("Francua_Sein");
	  ChangeCharacterAddressGroup(sld, "mayak4", "goto", "goto2");
	  LAi_SetImmortal(sld, false);    // отключаем бессмертие Сейна
	  sld.DontClearDead = true;    // чтоб не пропадал труп
	  sld.SaveItemsForDead = true;    // снимаем все предметы после смерти
	  GiveItem2Character(sld, "SeinDocument");
	  TakeNItems(sld, "potion2", 20);
	  GiveItem2Character(sld, "pistol1");
	  GiveItem2Character(sld, "blade_03");
	  EquipCharacterbyItem(sld, "pistol1");
	  EquipCharacterbyItem(sld, "blade_03");
	  sld.dialog.currentnode = "GetDocuments_10";
	  Lai_SetStayType(sld);
	  sld = characterFromID("BodyGSein_First");
	  ChangeCharacterAddressGroup(sld, "mayak4", "goto", "goto2");
	  sld.dialog.currentnode = "First Time";
	  Lai_SetStayType(sld);
	  sld = characterFromID("BodyGSein_Second");
	  ChangeCharacterAddressGroup(sld, "mayak4", "goto", "goto2");
	  sld.dialog.currentnode = "First Time";
	  Lai_SetStayType(sld);
	  break;
	  ...
	  case "BasterEvent_53":
	  sld = characterFromID("Francua_Sein");
	  LAi_group_MoveCharacter(sld, "Sein_GROUP");
	  sld = characterFromID("BodyGSein_First");
	  LAi_group_MoveCharacter(sld, "Sein_GROUP");
	  sld = characterFromID("BodyGSein_Second");
	  LAi_group_MoveCharacter(sld, "Sein_GROUP");
	  LAi_group_SetRelation("Sein_GROUP", LAI_GROUP_PLAYER, LAI_GROUP_ENEMY);
	  LAi_group_FightGroups("Sein_GROUP", LAI_GROUP_PLAYER, true);
	  LAi_SetFightMode(pchar, true);
	  LAi_group_SetCheck("Sein_GROUP", "");
	  pchar.quest.BasterEvent53.win_condition.l1 = "item";
	  pchar.quest.BasterEvent53.win_condition.l1.item = "SeinDocument";
	  pchar.quest.BasterEvent53.win_condition = "BasterEvent_54";
	  break;


	  case "BasterEvent_54":
	  AddQuestRecord("BasterEventMask", "2");
	  pchar.quest.BasterEvent44.win_condition.l1 = "locator";
	  pchar.quest.BasterEvent44.win_condition.l1.location = "mayak4";
	  pchar.quest.BasterEvent44.win_condition.l1.locator_group = "reload";
	  pchar.quest.BasterEvent44.win_condition.l1.locator = "reload1_back";
	  pchar.quest.BasterEvent44.win_condition = "BasterEvent_55";
	  break;


	  case "BasterEvent_55":
	  SetLaunchFrameFormParam("В то же время", "", 5, 8);
	  LaunchFrameForm();
	  WaitDate("", 0, 0, 0, 0, 10); // Крутану несколько минут
      RecalculateJumpTable();
	  DoQuestCheckDelay("BasterEvent_56", 3.0);
	  break;
	  ...
	  SetMainCharacterIndex(GetCharacterIndex("BLAZE"));
	  Lai_SetPlayerType(pchar);
	  DoReloadCharacterToLocation("Baster_tavern", "goto", "goto1");
	  sld = characterFromID("Mask1");
	  ChangeCharacterAddressGroup(sld, "Baster_town", "officers", "houseF1_1");  // убираем персонажа
	  Lai_SetActorType(sld);
	  Lai_ActorRunToLocation(sld, "reload", "houseF1", "none", "", "", "", -1);
	  chrDisableReloadToLocation = false; // открываем локацию
	  bDisableCharacterMenu = false;   // разрешить F2
	  LocatorReloadEnterDisable("baster_town", "HouseSP1", false); //открыть дом Фадея
	  break;
