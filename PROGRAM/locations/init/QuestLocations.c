...
int LocationInitQuestLocations(int n)
{
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "BanditHut";
	locations[n].filespath.models = "locations\inside\Hut";
	locations[n].id.label = "BanditHouse";
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "Bandit_Camp";
	locations[n].id.label = "Bandit_Camp";
	...
	//Reload map
	locations[n].reload.l1.name = "reload1";
	locations[n].reload.l1.go = "FortFrance_townhall";
