...
//==================PATENTS
	...
	makeref(itm,Items[n]);
	itm.id = "KabalJournal";//записи Кабаля
	itm.name = "itmname_KabalJournal";
	itm.describe = "itmdescr_KabalJournal";
	itm.model = "";
	itm.picIndex = 12;
	itm.picTexture = "ITEMS_22";
	itm.price = 10;
	...
	makeref(itm,Items[n]);
	itm.id = "SeinDocument";//документы Сейна
	itm.name = "itmname_SeinDocument";
	itm.describe = "itmdescr_SeinDocument";
	itm.model = "";
	itm.picIndex = 14;
	itm.picTexture = "ITEMS_22";
	itm.price = 0;
	...
	makeref(itm,Items[n]); //перстень Глонга
	itm.id = "Glong_ring";
	itm.name = "itmname_glong_ring";
	itm.describe = "itmdescr_glong_ring";
	itm.model = "";
	itm.picIndex = 1;
	itm.picTexture = "ITEMS_33";
	itm.price = 0;
	...
	makeref(itm,Items[n]); //письмо к маркизу де Ла Файету
	itm.id = "letter_Fayet";
	itm.name = "itmname_letter_Fayet";
	itm.describe = "itmdescr_letter_Fayet";
	itm.model = "";
	itm.picIndex = 5;
	itm.picTexture = "ITEMS_26";
	itm.price = 0;
	...
	makeref(itm,Items[n]); //письмо губернатору Жаку Дил ду Парке
	itm.id = "letter_DuParke";
	itm.name = "itmname_letter_DuParke";
	itm.describe = "itmdescr_letter_DuParke";
	itm.model = "";
	itm.picIndex = 5;
	itm.picTexture = "ITEMS_26";
	itm.price = 0;
