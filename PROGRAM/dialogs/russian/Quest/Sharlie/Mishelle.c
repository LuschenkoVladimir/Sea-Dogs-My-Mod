...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Mishelle_prisoner_2":
			...
			link.l1 = "И ты мне всё это говоришь после того, как меня здесь из-за тебя почти прибили и пару дней продержали в тюрьме?! Не хочешь сказать мне спасибо за твоё спасение от заговорщиков, которые чуть не захватили эту базу?";
			link.l1.go = "Mishelle_prisoner_3";
		break;
		
		case "Mishelle_prisoner_3":
			dialog.text = "Ладно, брат, обменялись колкостями, и - довольно. Я согласен с тем, что я не идеал, но и ты не ангел. Шарль, сейчас действительно не время для ссор. У нас теперь одна цель - спасти честь и достоинство фамилии де Монпе. И неважно, какими причинами мы руководствуемся. Брат, хоть раз в жизни сменим вражду на мир. Договорились? А теперь расскажи, что произошло. Мне, знаешь ли, теперь не докладывают, что происходит за пределами этих стен. Я слышал, что здесь шёл бой.";
			link.l1 = "(Шарль рассказывает о том, что случилось с ним в Сен-Пьере) А теперь ответь мне на мои вопросы. Ты можешь толком объяснить, кто были эти негодяи? И чего они от тебя хотели? И, наконец,  в чем тебя обвиняют?";
			link.l1.go = "Mishelle_prisoner_4";
		break;
		
		case "Mishelle_prisoner_4":
			dialog.text = "Насчёт этих заговорщиков понятия не имею. Думаю, они просто воспользовались твоим приездом для того чтобы захватить базу, а затем, возможно, и всю колонию. С чего ты вообще взял, что это имеет ко мне какое-то отношение? А что касается обвинений против меня, то... официально это звучит как растрата денежных средств Ордена. На самом деле всё гораздо глубже.";
			link.l1 = "Это не имеет значения, что считаю я. Важно, что считает де Пуанси. То, что случилось, не прибавило ни мне, ни тебе его доверия, и может ещё серьёзнее ударить по твоему положению. Хотя, как я полагаю, дела твои и так не блестящи. Тебя обвиняют в растрате и присвоении средств Ордена?";
		...
		case "Mishelle_prisoner_28":
			...
			//}
			AddDialogExitQuest("Guide_nextCondition");
