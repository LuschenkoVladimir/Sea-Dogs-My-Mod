...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "guide_0":
			dialog.text = "Месье де Мор? Я много наслышан о вас от Его Преосвященства! И смею заверить, что я в полном вашем распоряжении.";
			link.l1 = "Очень приятно, месье Валинье. Его Преосвященство и вам дал самые высокие рекомендации. Вы слышали о судьбе моего брата? И знаете, где он содержится?";
			link.l1.go = "guideNew_1";			
		break;


		case "guideNew_1":
			dialog.text = "Конечно. Мишель де Монпе содержится под стражей на подземной базе Мальтийского ордена здесь в Сен-Пьере по личному распоряжению шевалье де Пуанси.";
			link.l1 = "Что вы посоветуете мне предпринять прежде всего?";
			link.l1.go = "guideNew_2";			
		break;

		case "guideNew_2":
			dialog.text = "На вашем месте я бы поостерёгся напрямую идти к губернатору или на базу Ордена. Я знаю, что в Сен-Пьере сейчас царит настоящая шпиономания, и, увы, для этого есть определённые основания. Но об этом позже. Вас могут принять за испанского шпиона или.. сделать вид, что приняли за испанского шпиона.";
			link.l1 = "Что вы имеете в виду?";
			link.l1.go = "guideNew_3";			
		break;

		case "guideNew_3":
			dialog.text = "Здесь всё достаточно очевидно, дорогой месье де Мор. Вы - брат Мишеля де Монпе, а значит прибыли действовать в его интересах и оспаривать его арест, что, в свою очередь,  значит оспаривать решение де Пуанси. Не думаете же вы, что шевалье примет вас с распростёртыми объятиями при таких обстоятельствах?";
			link.l1 = "Но..";
			link.l1.go = "guideNew_4";			
		break;

		case "guideNew_4":
			dialog.text = "Самым разумным шагом с вашей стороны мне видится навестить местного аббата Бенуа. Он старый друг вашего брата и имеет связи в Ордене. Возможно, с его помощью вы могли бы попытаться неформально навестить Мишеля де Монпе и выяснить все необходимые обстоятельства из первых уст.";
			link.l1 = "Да, это вполне разумно, месье Валинье.";
			link.l1.go = "guide_1";			
		break;
		...
		case "guide_1":
			dialog.text = "Кроме того, я могу провести для вас небольшую экскурсию по местным заведениям.";
			link.l1 = "Я буду очень рад воспользоваться вашим предложением. Знания ещё никому не повредили.";
			link.l1.go = "guide_2";
			link.l2 = "Нет, спасибо, месье. Не буду терять время и немедленно отправлюсь к аббату.";
			link.l2.go = "guide_exit";	
		break;
		
		case "guide_exit":
			dialog.text = "И то верно,  месье де Мор. Я буду здесь в Сен-пьере, и, как уже сказал, в любое время весь в вашем распоряжении.";
			link.l1 = "Премного благодарен, а теперь разрешите откланяться.";
		...
		case "guide_12":
			dialog.text = "А вот перед нами дворец самого главного лица в колонии - губернатора. Знатные люди ходят сюда на вечерние балы и приёмы, а деловые люди и капитаны кораблей заглядывают для решения личных проблем. Быть в хороших отношениях с губернатором - большое дело, скажу я вам, потому что от него во многом зависит, как все колонисты той или иной нации будут относиться к вам\nМногие отчаянные каперы работают на губернатора - получают от него задания, успешное выполнение которых хорошо оплачивается. Также сюда приводят плененных в бою капитанов для получения за них выкупа от держав. Ну а если у вас хорошая репутация и карман раздувается от песо и дублонов, то Его Светлость может даже почтить вас игрой в кости или карты по солидным ставкам\nНо я смотрю, вы что-то переминаетсь с ноги на ногу, мой друг.";
			link.l1 = "Однако вы мне не советуете начать с визита губернатору?";
			link.l1.go = "guide_13";
		break;
		
		case "guide_13":
			dialog.text = "Нет, месье де Мор. Не в вашем случае. Как вы, наверное, уже знаете, здесь на островах по сути всем заправляет Мальтийский орден и его глава шевалье де Пуанси. Губернаторы сильно зависят от него и находятся в его подчинении. Вам нужно быть готовым к тому, что никакой поддержки в вашем деле вы от них не получите. Более того, вам даже могут чинить препятствия. И в этом смысле сразу идти к губернатору Сен-Пьера  Жаку Дил  Ду Парке я действительно считаю преждевременным.";
			link.l1 = "Но что же при таких условиях я смогу сделать для своего брата?";
			link.l1.go = "guide_14";
		break;
		
		case "guide_14":
			dialog.text = "Ну, во-первых, как я уже сказал, вам необходимо сначала с ним встретиться. Это самое меньшее, что вы можете сделать. И уже по итогам беседы принимать дальнейшие решения. Ну, и кроме того, не забывайте, что Его Преосвященство направил меня сюда именно для того, чтобы ваша миссия увенчалась успехом. Его Преосвященство полагал, что вам не следует раскрывать вашу связь с ним, а следует действовать в качестве частного лица.";
			link.l1 = "Я понимаю вас, месье Валинье. Тогда ещё немного осмотрюсь в Сен-Пьере и направлюсь к аббату Бенуа.";
			link.l1.go = "guide_15";
		break;
		
		case "guide_15":
			dialog.text = "Я буду здесь в Сен-пьере, и, как уже сказал, в любое время весь в вашем распоряжении.";
			link.l1 = "Премного благодарен, а теперь разрешите откланяться.";
			link.l1.go = "guide_16";
		break;
		...
		case "guide_16":
			...
			LAi_SetCitizenType(npchar);
			//Lai_SetActorType(npchar);
	        //Lai_ActorRunToLocation(npchar, "reload", "basement1", "none", "", "", "", -1);
		...
		case "guide_25":
			dialog.text = "Ну раз такого условие, то будем собирать эту сумму. Вернее, конечно, вы будете собирать, Шарль, но я вам помогу. Сначала, раз уж вам здесь неизбежно предстоит стать капитаном своего корабля, я расскажу вам основы, с которых вам следует начать. Следуйте за мной.";
			link.l1 = "";
			link.l1.go = "guide_26";
		break;
