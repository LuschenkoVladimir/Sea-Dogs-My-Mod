...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Benua_meeting_1":
			...
			link.l1 = "Я понимаю ваши сомнения, отче. У нас просто разные фамилии. Мой отец - Анри де Монпе. Вот, можете посмотреть мои рекомендации и письмо моего отца, в котором он просит заняться судьбой бедного брата.";
		...
		case "Benua_maltie":
			...
			link.l1.go = "exit";
			AddDialogExitQuest("DeMor_171");    // заново генерим мальтийца
