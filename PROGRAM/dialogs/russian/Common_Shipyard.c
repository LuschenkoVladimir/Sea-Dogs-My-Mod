...
//--> -------------------------------------------Бремя гасконца---------------------------------------------------
		...
		case "Sharlie_1":
			if (GetQuestPastDayParam("questTemp.Sharlie_ship") > 5)
			{
		...
		case "Sharlie_2":
			int iDay = 5-sti(GetQuestPastDayParam("questTemp.Sharlie_ship"));
		...
		case "Sharlie_3":
			...
			{	
				...
				{
					dialog.text = "Месье, я же предупреждал, что у вас всего пять дней. Они истекли, денег вы не принесли, договор утратил силу. Я продал корабль другому человеку, так что не обессудьте.";
					link.l1 = "Да, вот как неудачно-то вышло... А другого корабля у вас точно нет?";
					link.l1.go = "Sharlie_6";
				}
				else
