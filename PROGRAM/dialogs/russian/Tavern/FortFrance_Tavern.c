...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			{
				link.l1 = "Как идут дела в таверне,"+npchar.name+"? Я недавно прибыл в Сен-Пьер, поэтому только знакомлюсь с вашими местами.";
                link.l1.go = "Sharlie_rum_exit";
			}
		...
		case "Sharlie_rum_exit":
			dialog.text = "Жить можно, месье. Здесь всегда к вашим услугам чистая постель и кружка рома. (понижая тон) И хочу вас предупредить, что иногда за столиками встречаются шулеры и дебоширы, так что заведение не несёт ответственности за ваш кошелёк и ваше самочувствие.";
			link.l1 = "Спасибо за предупреждение. Всего доброго, "+npchar.name+".";
			link.l1.go = "exit";
