...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			{
				link.l1 = "Я по поводу бочонков с вином, которые ты собираешься доставить на Гваделупу...";
		...
		case "seabattle":
			dialog.text = "Так значит, вас заинтересовало моё предложение, месье? Но увы, должен вас огорчить, вас опередили буквально на пару часов. Капитан тартаны был весьма убедительным и предложил мне крайне выгодные условия фрахта. Он обосновал это тем, что всё равно должен увезти с острова несколько человек, поэтому моё предложение для него является лишь дополнительным заработком. Надеюсь, вы войдёте в моё положение, и не будете судить слишком строго за то, что заставил вас прибыть сюда впустую.";
			link.l1 = "Конечно, я весьма огорчён, Чезаре. В следующий раз тоже постараюсь ещё и набирать пассажиров, которые, наверное, весьма неплохо платят в такой ситуации. Насколько я понял, счастливчик ещё не успел далеко уплыть? Возможно, побеседую с ним и постараюсь узнать, где искать выгодных попутчиков.";
			link.l1.go = "seabattle_1";
			npchar.quest.seabattle = "true";
		break;
		
		case "seabattle_1":
			dialog.text = "Удачи, месье, и ещё раз приношу вам свои извинения.";
			link.l1 = "";
