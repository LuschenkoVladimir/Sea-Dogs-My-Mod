...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Puancie_Jail_2":
			dialog.text = "Так-то лучше. Что касается вашего вопроса, то ваш визит уже нанес существенный ущерб колонии и Мальтийскому ордену. Мы потеряли очень много наших рыцарей, и всё это благодаря тому, что вместо своевременного обращения с вашей просьбой к губернатору Жаку Дил ду Парке, вы тайно прибыли в Сен-Пьер и хотели нелегально проникнуть на базу Ордена с помощью аббата Бенуа. Позвольте спросить, как после этого я могу доверять вам?";
			link.l1 = "Мне жаль, Ваша Светлость, что события приобрели столь трагический оборот, но, видит Бог, я не стремился причинить ущерб вам или Ордену. Да, я собирался нанести визит аббату Бенуа как другу моего брата, но отнюдь не для действий против Вашей Светлости или властей Сен-Пьера. Я лишь хочу узнать о судьбе моего бедного брата, который содержится под арестом на базе Ордена.";
			link.l1.go = "Puancie_Jail_3";			
		break;
		
		case "Puancie_Jail_3":
			dialog.text = "Ваша неосведомлённость в данном вопросе не может служить вашим оправданием. Шевалье де Валинье имеет серьёзные полномочия от Его Преосвященства и готов поручиться за вас, поэтому я вынужден вас отпустить.";
			link.l1 = "И я смогу навестить моего брата?";
			link.l1.go = "Puancie_Jail_4";			
		break;
		
		case "Puancie_Jail_4":
			dialog.text = "Да, сможете, месье де Мор. Но я должен уведомить вас, что у него серьёзные неприятности. У меня есть все основания подозревать его в злоупотреблении служебным положением в личных целях, присвоении не принадлежащего ему имущества и клятвопреступлении. Однако вы действительно можете помочь вашему брату.";
		...
		case "Puancie_Jail_5":
			...
			link.l1 = "Я сделаю всё, что в моих силах для восстановления чести моей семьи и оправдания моего брата.";
			link.l1.go = "Puancie_Jail_6";			
		break;
		
		case "Puancie_Jail_6":
			dialog.text = "Это правильный настрой, юноша, достойный уважения. Я разрешаю вам неограниченное число раз посещать базу, и беседовать с вашим братом столько, сколько вы сами сочтёте нужным. Офицеры и солдаты Ордена ознакомлены с моим распоряжением и не будут чинить вам препятствий.";
			link.l1 = "Благодарю вас, Ваша Светлость, и хочу еще раз засвидетельствовать вам своё почтение.";
			link.l1.go = "Puancie_Jail_7";			
		break;
		
		case "Puancie_Jail_7":
			dialog.text = "Очень надеюсь, что следующая наша встреча пройдёт при совсем других обстоятельствах, когда вы докажете, что сможете быть полезны для наших общих усилий во благо Короля, Франции и католической веры. Сержант!";
