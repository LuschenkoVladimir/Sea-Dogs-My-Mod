...
void ProcessDialogEvent()
{
    ...
    //командировка в Сантьяго  Оглушили в Сантьяго
		case "Sharlie_Trip":
			dialog.text = "Месье! Подождите... вы, кажется, уронили...";
			link.l1 = "Что? А?!...";
			link.l1.go = "Sharlie_Trip_1";
		break;
		...
		case "Sharlie_Trip_1":
			...
			LaunchFrameForm();
			WaitDate("", 0, 0, 0, 2, 0); //крутим время
			RecalculateJumpTable();
			DoQuestCheckDelay("DeMor_14", 2.0);
		break;
		
		
		
	case "dialogValinie":
    dialog.text = "Что вам здесь надо? И как вы сюда попали?";
    link.l1 = "Боюсь, я пришёл за вашими жизнями, ублюдки!";
    link.l1.go = "dialogValinieexit";
    break;  		
		
		
	case "dialogValinieexit":
    AddDialogExitQuest("DeMor_26");
    dialogexit();
    break;  		
