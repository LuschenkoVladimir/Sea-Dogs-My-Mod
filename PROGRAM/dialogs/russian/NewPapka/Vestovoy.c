...
void ProcessDialogEvent()
{
	...
	case "Dungeondialog1":
    dialog.text = "Месье Де Мор? Сдайте оружие и следуйте за мной!";
    link.l1 = "В чём дело? Я только что сражался рядом с вашими товарищами и участвовал в подавлении заговора!";
    link.l1.go = "Dungeondialog2";
    break;  		
		
		
	case "Dungeondialog2":
    dialog.text = "Это приказ губернатора! Повторяю, немедленно сдайте оружие или солдаты гарнизона отберут у вас его силой!";
    link.l1 = "Ну, попробуйте, идиоты!";
    link.l1.go = "Dungeondialog_exit";
    break;  


    case "Dungeondialog_exit":
    AddDialogExitQuest("DeMor_54"); 
    dialogexit();
    break;
